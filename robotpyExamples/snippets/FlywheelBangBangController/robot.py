...
class MyRobot(wpilib.TimedRobot):
    ...
    def __init__(self) -> None:
        ...
        self.bangBangController = wpimath.BangBangController()
        ...
        wpilib.SmartDashboard.putData(self.bangBangController)
    ...
    def teleopPeriodic(self) -> None:
        ...
        bangOutput = (
            self.bangBangController.calculate(self.encoder.getRate(), setpoint) * 12.0
        )
