...
class AddressableLED {
 public:
   ...
   * be set for those.
   *
   * @param lowTime0 low time for 0 bit (default 400ns)
   * @param highTime0 high time for 0 bit (default 900ns)
   * @param lowTime1 low time for 1 bit (default 900ns)
   * @param highTime1 high time for 1 bit (default 600ns)
   */
