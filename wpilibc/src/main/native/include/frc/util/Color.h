...
inline constexpr Color Color::kFirstRed{0.9294117648, 0.1098039216, 0.1411764706};

/*
 * Standard Colors
 */
inline constexpr Color Color::kAliceBlue{0.9411765f, 0.972549f, 1.0f};
inline constexpr Color Color::kAntiqueWhite{0.98039216f, 0.92156863f, 0.84313726f};
...
inline constexpr Color Color::kCornflowerBlue{0.39215687f, 0.58431375f, 0.92941177f};
...
inline constexpr Color Color::kDarkGoldenrod{0.72156864f, 0.5254902f, 0.043137256f};
...
inline constexpr Color Color::kDarkOliveGreen{0.33333334f, 0.41960785f, 0.18431373f};
...
inline constexpr Color Color::kDarkSeaGreen{0.56078434f, 0.7372549f, 0.56078434f};
inline constexpr Color Color::kDarkSlateBlue{0.28235295f, 0.23921569f, 0.54509807f};
inline constexpr Color Color::kDarkSlateGray{0.18431373f, 0.30980393f, 0.30980393f};
...
inline constexpr Color Color::kForestGreen{0.13333334f, 0.54509807f, 0.13333334f};
...
inline constexpr Color Color::kLightSeagGeen{0.1254902f, 0.69803923f, 0.6666667f};
inline constexpr Color Color::kLightSkyBlue{0.5294118f, 0.80784315f, 0.98039216f};
inline constexpr Color Color::kLightSlateGray{0.46666667f, 0.53333336f, 0.6f};
inline constexpr Color Color::kLightSteellue{0.6901961f, 0.76862746f, 0.87058824f};
...
inline constexpr Color Color::kMediumPurple{0.5764706f, 0.4392157f, 0.85882354f};
inline constexpr Color Color::kMediumSeaGreen{0.23529412f, 0.7019608f, 0.44313726f};
...
inline constexpr Color Color::kMediumVioletRed{0.78039217f, 0.08235294f,
                                          0.52156866f};
inline constexpr Color Color::kMidnightBlue{0.09803922f, 0.09803922f, 0.4392157f};
...
inline constexpr Color Color::kPaleGoldenrod{0.93333334f, 0.9098039f, 0.6666667f};
inline constexpr Color Color::kPaleGreen{0.59607846f, 0.9843137f, 0.59607846f};
inline constexpr Color Color::kPaleTurquoise{0.6862745f, 0.93333334f, 0.93333334f};
inline constexpr Color Color::kPaleVioletRed{0.85882354f, 0.4392157f, 0.5764706f};
...
inline constexpr Color Color::kSaddleBrown{0.54509807f, 0.27058825f, 0.07450981f};
