 ...
 * arcadeDrive, methods should be called periodically to avoid Motor Safety
 * timeouts.
 *
...
class HDrive : public RobotDriveBase,
 ...
 public:
   ...
   */
  HDrive(MotorController& leftMotor, MotorController& rightMotor,
   ...
   * @param ySpeed The robot's speed along the robots lateral axis [-1.0..1.0].
   * Right is positive.
   * @param squareInputs If set, decreases the input sensitivity at low speeds.
   */
  void ArcadeDrive(double xSpeed, double zRotation, double ySpeed,
   ...
   * @param lateralSpeed The robot's speed along the Y axis [-1.0..1.0]. Right
   * is positive
   * @param squareInputs If set, decreases the input sensitivity at low speeds.
   */
  void TankDrive(double leftSpeed, double rightSpeed, double lateralSpeed,
                 bool squareInputs = true);
  ...
  static WheelSpeeds ArcadeDriveIK(double xSpeed, double zRotation,
                                   double ySpeed, bool squareInputs = true);
  ...
  static WheelSpeeds TankDriveIK(double leftSpeed, double rightSpeed,
                                 double lateralSpeed, bool squareInputs = true);
