...
class Tracer {
 public:
   ...
   * called by user code.
   * If a `Tracer.startTrace(string)` is not paired with a
   * `Tracer.endTrace()` there will be timing issues and dropped timing data.
   */
   ...
   * This will only need to be called if `Tracer.DisableTracingForCurrentThread()`
   * has been called.
   */
   ...
   * 
   * @deprecated This constructor is only for compatibility with the 2024 Tracer and will be removed in 2025. Use the static methods in Tracer instead.
   */
  [[deprecated("This constructor is only for compatibility with the 2024 Tracer and will be removed in 2025. Use the static methods in Tracer instead.")]]
  Tracer();
   ...
   * 
   * @deprecated This method is only for compatibility with the 2024 Tracer and will be removed in 2025. Use the static methods in Tracer instead.
   */
  [[deprecated("This method is only for compatibility with the 2024 Tracer and will be removed in 2025. Use the static methods in Tracer instead.")]]
  void ResetTimer();
