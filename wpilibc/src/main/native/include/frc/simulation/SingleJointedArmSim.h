...
class SingleJointedArmSim : public LinearSystemSim<2, 1, 2> {
 public:
   ...
   * @param minAngle           The minimum angle that the arm is capable of, with 0 being horizontal.
   * @param maxAngle           The maximum angle that the arm is capable of, with 0 being horizontal.
   * @param simulateGravity    Whether gravity should be simulated or not.
   * @param startingAngle      The initial position of the arm, with 0 being horizontal.
