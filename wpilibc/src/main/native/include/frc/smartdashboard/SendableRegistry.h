...
class SendableRegistry {
 public:
   ...
   */
  static void Add(Sendable* sendable, const wpi::Twine& name);
   ...
   */
  static void Add(Sendable* sendable, const wpi::Twine& moduleType,
                  int channel);
   ...
   * @param name component name
   */
  static void Add(Sendable* sendable, const wpi::Twine& subsystem,
   ...
   * @param name component name
   */
  static void AddLW(Sendable* sendable, const wpi::Twine& name);
   ...
   * @param channel      The channel number the device is plugged into
   */
  static void AddLW(Sendable* sendable, const wpi::Twine& moduleType,
                    int channel);
   ...
   * @param name component name
   */
  static void AddLW(Sendable* sendable, const wpi::Twine& subsystem,
                    const wpi::Twine& name);
   ...
   * @param name name
   */
  static void SetName(Sendable* sendable, const wpi::Twine& name);
   ...
   * @param channel    The channel number the device is plugged into
   */
  static void SetName(Sendable* sendable, const wpi::Twine& moduleType,
                      int channel);
   ...
   */
  static void SetName(Sendable* sendable, const wpi::Twine& subsystem,
                      const wpi::Twine& name);
   ...
   * @param subsystem subsystem name
   */
  static void SetSubsystem(Sendable* sendable, const wpi::Twine& subsystem);
   ...
   */
  static void Publish(UID sendableUid, std::shared_ptr<nt::NetworkTable> table);
