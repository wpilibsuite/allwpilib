...
class DriverStation {
 public:
   ...
   */
  static bool WaitForData(double timeout);
  ...
  static void InDisabled(bool entering) {
    GetInstance().m_userInDisabled = entering;
  }
  ...
  static void InAutonomous(bool entering) {
    GetInstance().m_userInAutonomous = entering;
  }
  ...
  static void InOperatorControl(bool entering) {
    GetInstance().m_userInTeleop = entering;
  }
   ...
   */
  static void InTest(bool entering) { GetInstance().m_userInTest = entering; }
 ...
 private:
   ...
   */
  static void ReportJoystickUnpluggedError(const wpi::Twine& message);
   ...
   * Throttles the errors so that they don't overwhelm the DS.
   */
  static void ReportJoystickUnpluggedWarning(const wpi::Twine& message);
