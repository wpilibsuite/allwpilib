...
class RamseteCommand : public CommandHelper<CommandBase, RamseteCommand> {
 ...
 public:
   ...
   *                                       drive.
   * @param ka                             Acceleration-proportional feedforward term for the robot
   *                                       drive.
   * @param kinematics                     The kinematics for the robot drivetrain.
   * @param leftSpeed                      A function that supplies the speed of the left side of
   *                                       the robot drive.
   * @param rightSpeed                     A function that supplies the speed of the right side of
   *                                       the robot drive.
