...
DSControlWord::RobotMode DriverStation::GetRobotMode() {
  HAL_ControlWord controlWord;
  HAL_GetControlWord(&controlWord);
  return static_cast<DSControlWord::RobotMode>(controlWord.robotMode);
}
...
static int64_t DoAddOpMode(DSControlWord::RobotMode mode, std::string_view name,
...
int64_t DriverStation::AddOpMode(DSControlWord::RobotMode mode,
