...
std::recursive_mutex MotorSafetyHelper::m_listMutex;
...
MotorSafetyHelper::MotorSafetyHelper(MotorSafety* safeObject)
  ...
  std::lock_guard<std::recursive_mutex> sync(m_listMutex);
...
void MotorSafetyHelper::Feed() {
  std::lock_guard<std::recursive_mutex> sync(m_syncMutex);
