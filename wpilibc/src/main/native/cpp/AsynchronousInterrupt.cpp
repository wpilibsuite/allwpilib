...
using namespace frc;
    ...
    AsynchronousInterrupt::AsynchronousInterrupt(DigitalSource& source, std::function<void(bool, bool)> callback)
    ...
    AsynchronousInterrupt::AsynchronousInterrupt(std::shared_ptr<DigitalSource> source, std::function<void(bool, bool)> callback)
    : m_interrupt{source}, m_callback{std::move(callback)} {
    }
...
void AsynchronousInterrupt::Disable() {
    ...
    void AsynchronousInterrupt::SetInterruptEdges(bool risingEdge, bool fallingEdge) {
