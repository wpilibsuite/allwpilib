...
TEST_CASE("DualSenseControllerTest wrapped HID",
  ...
  REQUIRE(controller.GetHID().GetButtonsAvailable() == 0x10FFFFULL);
...
DEADBAND_AXIS_TEST(DualSenseController, LeftX, 0.1)
DEADBAND_AXIS_TEST(DualSenseController, LeftY, 0.1)
DEADBAND_AXIS_TEST(DualSenseController, RightX, 0.1)
DEADBAND_AXIS_TEST(DualSenseController, RightY, 0.1)
DEADBAND_AXIS_TEST(DualSenseController, L2, 0.01)
DEADBAND_AXIS_TEST(DualSenseController, R2, 0.01)
