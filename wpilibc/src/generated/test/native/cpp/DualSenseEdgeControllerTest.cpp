...
DEADBAND_AXIS_TEST(DualSenseEdgeController, LeftX, 0.1)
DEADBAND_AXIS_TEST(DualSenseEdgeController, LeftY, 0.1)
DEADBAND_AXIS_TEST(DualSenseEdgeController, RightX, 0.1)
DEADBAND_AXIS_TEST(DualSenseEdgeController, RightY, 0.1)
DEADBAND_AXIS_TEST(DualSenseEdgeController, L2, 0.01)
DEADBAND_AXIS_TEST(DualSenseEdgeController, R2, 0.01)
