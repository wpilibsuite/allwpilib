...
TEST_CASE("SwitchProControllerTest wrapped HID",
  ...
  REQUIRE(controller.GetHID().GetButtonsAvailable() == 0xFFFFULL);
...
DEADBAND_AXIS_TEST(SwitchProController, LeftX, 0.1)
DEADBAND_AXIS_TEST(SwitchProController, LeftY, 0.1)
DEADBAND_AXIS_TEST(SwitchProController, RightX, 0.1)
DEADBAND_AXIS_TEST(SwitchProController, RightY, 0.1)
DEADBAND_AXIS_TEST(SwitchProController, ZL, 0.01)
DEADBAND_AXIS_TEST(SwitchProController, ZR, 0.01)
