 ...
 */
class DualSenseEdgeControllerSim : public GenericHIDSim {
 public:
  /**
   ...
   */
  explicit DualSenseEdgeControllerSim(const DualSenseEdgeController& joystick);
   ...
   */
  explicit DualSenseEdgeControllerSim(int port);
   ...
   * @param value the new value
   */
  void SetLeftFunctionButton(bool value);
   ...
   * @param value the new value
   */
  void SetRightFunctionButton(bool value);
};
