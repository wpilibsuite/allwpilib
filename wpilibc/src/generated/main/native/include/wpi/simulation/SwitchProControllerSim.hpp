 ...
 */
class SwitchProControllerSim : public GenericHIDSim {
 public:
  /**
   ...
   */
  explicit SwitchProControllerSim(const SwitchProController& joystick);
   ...
   */
  explicit SwitchProControllerSim(int port);
