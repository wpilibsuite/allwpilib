 ...
 */
class DualShock4ControllerSim : public GenericHIDSim {
 public:
  /**
   ...
   */
  explicit DualShock4ControllerSim(const DualShock4Controller& joystick);
   ...
   */
  explicit DualShock4ControllerSim(int port);
