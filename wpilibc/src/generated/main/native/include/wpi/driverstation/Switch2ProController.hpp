 ...
 *
 * This class handles Switch2Pro input that comes from the Driver Station.
 * Each time a value is requested the most recent value is returned.
 */
class Switch2ProController
    : public wpi::util::Sendable,
      public wpi::util::SendableHelper<Switch2ProController> {
 public:
   ...
   *             into.
   */
  explicit Switch2ProController(int port);

  ~Switch2ProController() override = default;
   ...
   * @return Whether the button was released since the last check.
   */
  bool GetGRButtonReleased();

  /**
   * Constructs an event instance around the GR button's
   * digital signal.
   *
   * @param loop the event loop instance to attach the event to.
   * @return an event instance representing the GR button's
   * digital signal attached to the given loop.
   */
  BooleanEvent GR(EventLoop* loop) const;
   ...
   * @return Whether the button was released since the last check.
   */
  bool GetGLButtonReleased();

  /**
   * Constructs an event instance around the GL button's
   * digital signal.
   *
   * @param loop the event loop instance to attach the event to.
   * @return an event instance representing the GL button's
   * digital signal attached to the given loop.
   */
  BooleanEvent GL(EventLoop* loop) const;
   ...
   * @return Whether the button was released since the last check.
   */
  bool GetCButtonReleased();

  /**
   * Constructs an event instance around the C button's
   * digital signal.
   *
   * @param loop the event loop instance to attach the event to.
   * @return an event instance representing the C button's
   * digital signal attached to the given loop.
   */
  BooleanEvent C(EventLoop* loop) const;
  ...
  struct Button {
    ...
    /// Minus button.
    static constexpr int kMinus = 4;
    /// Home button.
    static constexpr int kHome = 5;
    /// Plus button.
    static constexpr int kPlus = 6;
    /// Left Stick button.
    ...
    /// GR button.
    static constexpr int kGR = 16;
    /// GL button.
    static constexpr int kGL = 17;
    /// C button.
  ...
  struct Axis {
    ...
    /// ZL Axis.
    static constexpr int kZLAxis = 4;
    /// ZR Axis.
