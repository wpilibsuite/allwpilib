 ...
 */
class Switch2ProController : public HIDDevice, public wpi::telemetry::TelemetryLoggable {
 public:
   ...
   */
  explicit Switch2ProController(GenericHID& hid);
   ...
   * @param deadband The deadband to apply.
   */
  void SetZLDeadband(double deadband);
