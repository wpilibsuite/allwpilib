...
/**
 * Cross the Road Electronics (CTRE) Talon FX Motor Controller with PWMOutput control.
 *
 * Note that the Talon FX uses the following bounds for PWMOutput values. These
...
class PWMTalonFX : public PWMMotorController {
 public:
  /**
   * Constructor for a Talon FX connected via PWMOutput.
   *
   * @param channel The PWMOutput channel that the Talon FX is attached to. 0-9 are
