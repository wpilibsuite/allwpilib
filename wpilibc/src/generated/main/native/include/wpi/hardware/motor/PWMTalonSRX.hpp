...
/**
 * Cross the Road Electronics (CTRE) Talon SRX Motor Controller with PWMOutput control.
 *
 * Note that the Talon SRX uses the following bounds for PWMOutput values. These
...
class PWMTalonSRX : public PWMMotorController {
 public:
  /**
   * Constructor for a Talon SRX connected via PWMOutput.
   *
   * @param channel The PWMOutput channel that the Talon SRX is attached to. 0-9 are
