...
/**
 * REV Robotics SPARKMini Motor Controller with PWMOutput control.
 *
 * Note that the SPARKMini uses the following bounds for PWMOutput values. These
...
class SparkMini : public PWMMotorController {
 public:
  /**
   * Constructor for a SPARKMini connected via PWMOutput.
   *
   * @param channel The PWMOutput channel that the SPARKMini is attached to. 0-9 are
