...
/**
 * REV Robotics SPARK Flex Motor Controller with PWMOutput control.
 *
 * Note that the SPARK Flex uses the following bounds for PWMOutput values. These
...
class PWMSparkFlex : public PWMMotorController {
 public:
  /**
   * Constructor for a SPARK Flex connected via PWMOutput.
   *
   * @param channel The PWMOutput channel that the SPARK Flex is attached to. 0-9 are
