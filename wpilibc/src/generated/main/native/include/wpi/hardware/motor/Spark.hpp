...
/**
 * REV Robotics SPARK Motor Controller with PWMOutput control.
 *
 * Note that the SPARK uses the following bounds for PWMOutput values. These
...
class Spark : public PWMMotorController {
 public:
  /**
   * Constructor for a SPARK connected via PWMOutput.
   *
   * @param channel The PWMOutput channel that the SPARK is attached to. 0-9 are
