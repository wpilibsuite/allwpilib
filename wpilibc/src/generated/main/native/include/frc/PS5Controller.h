...
class PS5Controller : public GenericHID,
 ...
 public:
  ...
  struct Button {
    ...
    /// Cross button.
    static constexpr int CROSS = 2;
    /// Circle button.
    static constexpr int CIRCLE = 3;
    /// Triangle button.
    static constexpr int TRIANGLE = 4;
    /// Left trigger 1 button.
    static constexpr int L1 = 5;
    /// Right trigger 1 button.
    static constexpr int R1 = 6;
    /// Left trigger 2 button.
    static constexpr int L2 = 7;
    /// Right trigger 2 button.
    static constexpr int R2 = 8;
    /// Create button.
    static constexpr int CREATE = 9;
    /// Options button.
    static constexpr int OPTIONS = 10;
    /// L3 (left stick) button.
    static constexpr int L3 = 11;
    /// R3 (right stick) button.
    static constexpr int R3 = 12;
    /// PlayStation button.
    static constexpr int PS = 13;
    /// Touchpad button.
    static constexpr int TOUCHPAD = 14;
  };
