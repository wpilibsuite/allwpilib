...
class StadiaController : public GenericHID,
 ...
 public:
  ...
  struct Button {
    ...
    /// Ellipses button.
    static constexpr int ELLIPSES = 9;
    /// Hamburger button.
    static constexpr int HAMBURGER = 10;
    /// Stadia button.
    static constexpr int STADIA = 11;
    /// Right trigger button.
    static constexpr int RIGHT_TRIGGER = 12;
    /// Left trigger button.
    static constexpr int LEFT_TRIGGER = 13;
    /// Google button.
    static constexpr int GOOGLE = 14;
    /// Frame button.
    static constexpr int FRAME = 15;
  };
