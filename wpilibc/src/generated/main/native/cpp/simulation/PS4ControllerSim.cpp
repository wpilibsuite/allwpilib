...
PS4ControllerSim::PS4ControllerSim(const PS4Controller& joystick)
  ...
  SetSupportedOutputs(PS4Controller::kSupportedOutputs);
}
...
void PS4ControllerSim::SetL2Axis(double value) {
  SetRawAxis(PS4Controller::Axis::kL2Axis, value);
}

void PS4ControllerSim::SetR2Axis(double value) {
  SetRawAxis(PS4Controller::Axis::kR2Axis, value);
}
...
void PS4ControllerSim::SetDpadUpButton(bool value) {
  SetRawButton(PS4Controller::Button::kDpadUp, value);
}

void PS4ControllerSim::SetDpadDownButton(bool value) {
  SetRawButton(PS4Controller::Button::kDpadDown, value);
}

void PS4ControllerSim::SetDpadLeftButton(bool value) {
  SetRawButton(PS4Controller::Button::kDpadLeft, value);
}

void PS4ControllerSim::SetDpadRightButton(bool value) {
  SetRawButton(PS4Controller::Button::kDpadRight, value);
}
