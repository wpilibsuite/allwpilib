...
void DualSenseController::SetLeftXDeadband(double deadband) {
...
void DualSenseController::SetLeftYDeadband(double deadband) {
...
void DualSenseController::SetRightXDeadband(double deadband) {
...
void DualSenseController::SetRightYDeadband(double deadband) {
...
void DualSenseController::SetL2Deadband(double deadband) {
...
void DualSenseController::SetR2Deadband(double deadband) {
...
void DualSenseController::LogTo(wpi::telemetry::TelemetryTable& table) const {
