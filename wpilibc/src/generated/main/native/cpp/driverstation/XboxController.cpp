...
XboxController::XboxController(GenericHID& hid)
    : m_hid{&hid} {
  wpi::util::ReportUsage("HID", hid.GetPort(), "XboxController");
}
...
void XboxController::SetLeftXDeadband(double deadband) {
...
void XboxController::SetLeftYDeadband(double deadband) {
...
void XboxController::SetRightXDeadband(double deadband) {
...
void XboxController::SetRightYDeadband(double deadband) {
...
void XboxController::SetLeftTriggerDeadband(double deadband) {
...
void XboxController::SetRightTriggerDeadband(double deadband) {
