...
TEST(PS5ControllerTest, WrappedHID) {
  PS5Controller controller{2};
...
BUTTON_TEST(PS5Controller, DpadUpButton)
BUTTON_TEST(PS5Controller, DpadDownButton)
BUTTON_TEST(PS5Controller, DpadLeftButton)
BUTTON_TEST(PS5Controller, DpadRightButton)
BUTTON_TEST(PS5Controller, MicrophoneButton)
