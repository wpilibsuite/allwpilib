...
class MockRobot : public TimedRobot {
 public:
  ...
  MockRobot() : TimedRobot{PERIOD} { m_robotInitCount++; }
...
TEST_F(TimedRobotTest, AddPeriodicWithOffset) {
  ...
  frc::sim::StepTiming(PERIOD * 3.0 / 8.0);
