...
TEST(DoubleSolenoidTestREV, ValidInitialization) {
...
TEST(DoubleSolenoidTestREV, ThrowForwardPortAlreadyInitialized) {
...
TEST(DoubleSolenoidTestREV, ThrowReversePortAlreadyInitialized) {
  // Single solenoid that is reused for forward port
...
TEST(DoubleSolenoidTestREV, ThrowBothPortsAlreadyInitialized) {
...
TEST(DoubleSolenoidTestREV, Toggle) {
...
TEST(DoubleSolenoidTestREV, InvalidForwardPort) {
  EXPECT_THROW(DoubleSolenoid(0, frc::PneumaticsModuleType::CTREPCM, 100, 1),
               std::runtime_error);
}

TEST(DoubleSolenoidTestREV, InvalidReversePort) {
