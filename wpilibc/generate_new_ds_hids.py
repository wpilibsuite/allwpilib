...
def generate_new_ds_hids(
    ...
    template = env.get_template("new_ds_hid.hpp.jinja")
    ...
    template = env.get_template("new_ds_hid.cpp.jinja")
    for controller in controllers:
    ...
    template = env.get_template("new_ds_hidsim.hpp.jinja")
    for controller in controllers:
    ...
    template = env.get_template("new_ds_hidsim.cpp.jinja")
    for controller in controllers:
