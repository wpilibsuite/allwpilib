 ...
 *               set min to 0 and the max to 255 for 8-bit images and to the
 *               actual minimum value and maximum value of the image for all
 *               other image types.
 *    max -- Setting both min and max to 0 causes the function to set max to
 *           255 for 8-bit images and to the actual maximum value of the image
