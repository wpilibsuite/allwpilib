...
class Joystick : public GenericHID, public ErrorBase {
 public:
  static const uint8_t kDefaultXAxis = 0;
  static const uint8_t kDefaultYAxis = 1;
  static const uint8_t kDefaultZAxis = 2;
  static const uint8_t kDefaultTwistAxis = 2;
