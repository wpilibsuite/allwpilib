 ...
 * not turning. The algorithm for adding in the direction attempts to provide a
 * constant
 * turn radius for differing speeds.
 *
 * This function will most likely be used in an autonomous routine.
 *
 * @param outputMagnitude The forward component of the output magnitude to send
 * to the motors.
