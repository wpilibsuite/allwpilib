 ...
 *
 * @param[out] handle Event handle
 * @param[in] manualReset true for manual reset, false for automatic reset
 * @param[in] initialState true to make the handle initially in signaled state
 */
