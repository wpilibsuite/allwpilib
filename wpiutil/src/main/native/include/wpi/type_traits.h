...
struct is_trivially_copy_constructible
    : std::is_copy_constructible<
          ::wpi::detail::copy_construction_triviality_helper<T>> {};
template <typename T>
...
struct is_trivially_move_constructible
    : std::is_move_constructible<
          ::wpi::detail::move_construction_triviality_helper<T>> {};
template <typename T>
...
class is_trivially_copyable {
  ...
  static_assert(value == std::is_trivially_copyable<T>::value,
                "inconsistent behavior between wpi:: and std:: implementation of is_trivially_copyable");
#endif
};
template <typename T>
