...
enum WPI_TimestampSource {
  ...
  WPI_TIMESRC_FRAME_DEQUEUE, // wpi::Now when the new frame was dequeued by CSCore. Does not account for camera exposure time or V4L latency.
  WPI_TIMESRC_V4L_EOF,       // End of Frame. Same as V4L2_BUF_FLAG_TSTAMP_SRC_EOF, translated into wpi::Now's timebase.
  WPI_TIMESRC_V4L_SOE,       // Start of Exposure. Same as V4L2_BUF_FLAG_TSTAMP_SRC_SOE, translated into wpi::Now's timebase.
};
