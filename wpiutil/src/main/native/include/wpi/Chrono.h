...
struct format_provider<sys::TimePoint<>> {
  static void format(const sys::TimePoint<> &TP, wpi::raw_ostream &OS,
...
public:
  static void format(const Dur &D, wpi::raw_ostream &Stream, std::string_view Style) {
    InternalRep count;
