...
def main():
    ...
    if args.output_directory:
        ...
        output_directory = os.path.join(script_dir, "src", "generated")
    ...
    rootPath = f"{output_directory}/main/java/edu/wpi/first/math/numbers"
    ...
    rootPath = f"{output_directory}/main/java/edu/wpi/first/math"
