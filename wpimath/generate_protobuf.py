...
if __name__ == "__main__":
    ...
    for path in proto_files:
        ...
        subprocess.run(
            f"{sys.argv[1]} --cpp_out={os.path.abspath('./wpimath/src/generated/main/native/protobuf')} -I{absolute_dir} {absolute_filename}"
        )
    cpp_files = glob("wpimath/src/generated/main/native/protobuf/*.*")
    for cpp_file in cpp_files:
        with open(cpp_file) as file:
            content = file.read()
        with open(cpp_file, "tw") as file:
            file.write(
