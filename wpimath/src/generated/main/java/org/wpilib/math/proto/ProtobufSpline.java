...
public final class ProtobufSpline {
  private static final RepeatedByte descriptorData = ProtoUtil.decodeBase64(999,
    "ChVwcm90b2J1Zl9zcGxpbmUucHJvdG8SCXdwaS5wcm90byKIAQoaUHJvdG9idWZDdWJpY0hlcm1pdGVT" + 
    "cGxpbmUSGwoJeF9pbml0aWFsGAEgAygBUgh4SW5pdGlhbBIXCgd4X2ZpbmFsGAIgAygBUgZ4RmluYWwS" + 
    "GwoJeV9pbml0aWFsGAMgAygBUgh5SW5pdGlhbBIXCgd5X2ZpbmFsGAQgAygBUgZ5RmluYWwiigEKHFBy" + 
    "b3RvYnVmUXVpbnRpY0hlcm1pdGVTcGxpbmUSGwoJeF9pbml0aWFsGAEgAygBUgh4SW5pdGlhbBIXCgd4" + 
    "X2ZpbmFsGAIgAygBUgZ4RmluYWwSGwoJeV9pbml0aWFsGAMgAygBUgh5SW5pdGlhbBIXCgd5X2ZpbmFs" + 
    "GAQgAygBUgZ5RmluYWxCFwoVb3JnLndwaWxpYi5tYXRoLnByb3RvSokFCgYSBAAAEgEKCAoBDBIDAAAS" + 
    "CggKAQISAwIAEgoICgEIEgMEAC4KCQoCCAESAwQALgoKCgIEABIEBgALAQoKCgMEAAESAwYIIgoLCgQE" + 
    "AAIAEgMHAiAKDAoFBAACAAQSAwcCCgoMCgUEAAIABRIDBwsRCgwKBQQAAgABEgMHEhsKDAoFBAACAAMS" + 
    "AwceHwoLCgQEAAIBEgMIAh4KDAoFBAACAQQSAwgCCgoMCgUEAAIBBRIDCAsRCgwKBQQAAgEBEgMIEhkK" + 
    "DAoFBAACAQMSAwgcHQoLCgQEAAICEgMJAiAKDAoFBAACAgQSAwkCCgoMCgUEAAICBRIDCQsRCgwKBQQA" + 
    "AgIBEgMJEhsKDAoFBAACAgMSAwkeHwoLCgQEAAIDEgMKAh4KDAoFBAACAwQSAwoCCgoMCgUEAAIDBRID" + 
    "CgsRCgwKBQQAAgMBEgMKEhkKDAoFBAACAwMSAwocHQoKCgIEARIEDQASAQoKCgMEAQESAw0IJAoLCgQE" + 
    "AQIAEgMOAiAKDAoFBAECAAQSAw4CCgoMCgUEAQIABRIDDgsRCgwKBQQBAgABEgMOEhsKDAoFBAECAAMS" + 
    "Aw4eHwoLCgQEAQIBEgMPAh4KDAoFBAECAQQSAw8CCgoMCgUEAQIBBRIDDwsRCgwKBQQBAgEBEgMPEhkK" + 
    "DAoFBAECAQMSAw8cHQoLCgQEAQICEgMQAiAKDAoFBAECAgQSAxACCgoMCgUEAQICBRIDEAsRCgwKBQQB" + 
    "AgIBEgMQEhsKDAoFBAECAgMSAxAeHwoLCgQEAQIDEgMRAh4KDAoFBAECAwQSAxECCgoMCgUEAQIDBRID" + 
    "EQsRCgwKBQQBAgMBEgMREhkKDAoFBAECAwMSAxEcHWIGcHJvdG8z");

  static final Descriptors.FileDescriptor descriptor = Descriptors.FileDescriptor.internalBuildGeneratedFileFrom("protobuf_spline.proto", "wpi.proto", descriptorData);

  static final Descriptors.Descriptor wpi_proto_ProtobufCubicHermiteSpline_descriptor = descriptor.internalContainedType(37, 136, "ProtobufCubicHermiteSpline", "wpi.proto.ProtobufCubicHermiteSpline");

  static final Descriptors.Descriptor wpi_proto_ProtobufQuinticHermiteSpline_descriptor = descriptor.internalContainedType(176, 138, "ProtobufQuinticHermiteSpline", "wpi.proto.ProtobufQuinticHermiteSpline");
  ...
  public static final class ProtobufCubicHermiteSpline extends ProtoMessage<ProtobufCubicHermiteSpline> implements Cloneable {
    ...
    public static Descriptors.Descriptor getDescriptor() {
      return ProtobufSpline.wpi_proto_ProtobufCubicHermiteSpline_descriptor;
    }
  ...
  public static final class ProtobufQuinticHermiteSpline extends ProtoMessage<ProtobufQuinticHermiteSpline> implements Cloneable {
     ...
     */
    public static Descriptors.Descriptor getDescriptor() {
      return ProtobufSpline.wpi_proto_ProtobufQuinticHermiteSpline_descriptor;
    }
