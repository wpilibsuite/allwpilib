...
public final class ProtobufTrajectoryOuterClass {
  private static final RepeatedByte descriptorData = ProtoUtil.decodeBase64(824,
    "Chlwcm90b2J1Zl90cmFqZWN0b3J5LnByb3RvEgl3cGkucHJvdG8aGXByb3RvYnVmX2dlb21ldHJ5MmQu" + 
    "cHJvdG8iugEKF1Byb3RvYnVmVHJhamVjdG9yeVN0YXRlEhIKBHRpbWUYASABKAFSBHRpbWUSGgoIdmVs" + 
    "b2NpdHkYAiABKAFSCHZlbG9jaXR5EiIKDGFjY2VsZXJhdGlvbhgDIAEoAVIMYWNjZWxlcmF0aW9uEi0K" + 
    "BHBvc2UYBCABKAsyGS53cGkucHJvdG8uUHJvdG9idWZQb3NlMmRSBHBvc2USHAoJY3VydmF0dXJlGAUg" + 
    "ASgBUgljdXJ2YXR1cmUiUAoSUHJvdG9idWZUcmFqZWN0b3J5EjoKBnN0YXRlcxgCIAMoCzIiLndwaS5w" + 
    "cm90by5Qcm90b2J1ZlRyYWplY3RvcnlTdGF0ZVIGc3RhdGVzQhcKFW9yZy53cGlsaWIubWF0aC5wcm90" + 
    "b0rEAwoGEgQAABIBCggKAQwSAwAAEgoICgECEgMCABIKCQoCAwASAwQAIwoICgEIEgMGAC4KCQoCCAES" + 
    "AwYALgoKCgIEABIECAAOAQoKCgMEAAESAwgIHwoLCgQEAAIAEgMJAhIKDAoFBAACAAUSAwkCCAoMCgUE" + 
    "AAIAARIDCQkNCgwKBQQAAgADEgMJEBEKCwoEBAACARIDCgIWCgwKBQQAAgEFEgMKAggKDAoFBAACAQES" + 
    "AwoJEQoMCgUEAAIBAxIDChQVCgsKBAQAAgISAwsCGgoMCgUEAAICBRIDCwIICgwKBQQAAgIBEgMLCRUK" + 
    "DAoFBAACAgMSAwsYGQoLCgQEAAIDEgMMAhoKDAoFBAACAwYSAwwCEAoMCgUEAAIDARIDDBEVCgwKBQQA" + 
    "AgMDEgMMGBkKCwoEBAACBBIDDQIXCgwKBQQAAgQFEgMNAggKDAoFBAACBAESAw0JEgoMCgUEAAIEAxID" + 
    "DRUWCgoKAgQBEgQQABIBCgoKAwQBARIDEAgaCgsKBAQBAgASAxECLgoMCgUEAQIABBIDEQIKCgwKBQQB" + 
    "AgAGEgMRCyIKDAoFBAECAAESAxEjKQoMCgUEAQIAAxIDESwtYgZwcm90bzM=");

  static final Descriptors.FileDescriptor descriptor = Descriptors.FileDescriptor.internalBuildGeneratedFileFrom("protobuf_trajectory.proto", "wpi.proto", descriptorData, ProtobufGeometry2D.getDescriptor());

  static final Descriptors.Descriptor wpi_proto_ProtobufTrajectoryState_descriptor = descriptor.internalContainedType(68, 186, "ProtobufTrajectoryState", "wpi.proto.ProtobufTrajectoryState");

  static final Descriptors.Descriptor wpi_proto_ProtobufTrajectory_descriptor = descriptor.internalContainedType(256, 80, "ProtobufTrajectory", "wpi.proto.ProtobufTrajectory");
  ...
  public static final class ProtobufTrajectoryState extends ProtoMessage<ProtobufTrajectoryState> implements Cloneable {
     ...
     */
    private final ProtobufGeometry2D.ProtobufPose2d pose = ProtobufGeometry2D.ProtobufPose2d.newInstance();
     ...
     */
    public ProtobufGeometry2D.ProtobufPose2d getPose() {
      return pose;
    }
     ...
     */
    public ProtobufGeometry2D.ProtobufPose2d getMutablePose() {
      bitField0_ |= 0x00000010;
      return pose;
    }
     ...
     * @return this
     */
    public ProtobufTrajectoryState setPose(final ProtobufGeometry2D.ProtobufPose2d value) {
      bitField0_ |= 0x00000010;
      pose.copyFrom(value);
      return this;
    }
    ...
    public static Descriptors.Descriptor getDescriptor() {
      return ProtobufTrajectoryOuterClass.wpi_proto_ProtobufTrajectoryState_descriptor;
    }
  ...
  public static final class ProtobufTrajectory extends ProtoMessage<ProtobufTrajectory> implements Cloneable {
     ...
     */
    public static Descriptors.Descriptor getDescriptor() {
      return ProtobufTrajectoryOuterClass.wpi_proto_ProtobufTrajectory_descriptor;
    }
