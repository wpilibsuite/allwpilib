...
#ifndef PB_WPI_PROTO_CONTROLLER_NBP_H_INCLUDED
#define PB_WPI_PROTO_CONTROLLER_NBP_H_INCLUDED
#include <pb.h>
...
#define WPI_PROTO_CONTROLLER_NBP_H_MAX_SIZE      wpi_proto_ProtobufArmFeedforward_size
