...
#ifndef PB_WPI_PROTO_KINEMATICS_NBP_H_INCLUDED
#define PB_WPI_PROTO_KINEMATICS_NBP_H_INCLUDED
#include <pb.h>
#include "geometry2d.nbp.h"
...
typedef struct _wpi_proto_ProtobufMecanumDriveKinematics {
    bool has_front_left;
    wpi_proto_ProtobufTranslation2d front_left;
    bool has_front_right;
    wpi_proto_ProtobufTranslation2d front_right;
    bool has_rear_left;
    wpi_proto_ProtobufTranslation2d rear_left;
    bool has_rear_right;
    wpi_proto_ProtobufTranslation2d rear_right;
...
typedef struct _wpi_proto_ProtobufSwerveModulePosition {
    double distance;
    bool has_angle;
    wpi_proto_ProtobufRotation2d angle;
...
#define wpi_proto_ProtobufMecanumDriveKinematics_init_default {false, wpi_proto_ProtobufTranslation2d_init_default, false, wpi_proto_ProtobufTranslation2d_init_default, false, wpi_proto_ProtobufTranslation2d_init_default, false, wpi_proto_ProtobufTranslation2d_init_default}
...
#define wpi_proto_ProtobufSwerveModulePosition_init_default {0, false, wpi_proto_ProtobufRotation2d_init_default}
#define wpi_proto_ProtobufSwerveModuleState_init_default {0, false, wpi_proto_ProtobufRotation2d_init_default}
...
#define wpi_proto_ProtobufMecanumDriveKinematics_init_zero {false, wpi_proto_ProtobufTranslation2d_init_zero, false, wpi_proto_ProtobufTranslation2d_init_zero, false, wpi_proto_ProtobufTranslation2d_init_zero, false, wpi_proto_ProtobufTranslation2d_init_zero}
...
#define wpi_proto_ProtobufSwerveModulePosition_init_zero {0, false, wpi_proto_ProtobufRotation2d_init_zero}
#define wpi_proto_ProtobufSwerveModuleState_init_zero {0, false, wpi_proto_ProtobufRotation2d_init_zero}
...
X(a, STATIC,   OPTIONAL, MESSAGE,  front_left,        1) \
X(a, STATIC,   OPTIONAL, MESSAGE,  front_right,       2) \
X(a, STATIC,   OPTIONAL, MESSAGE,  rear_left,         3) \
X(a, STATIC,   OPTIONAL, MESSAGE,  rear_right,        4)
#define wpi_proto_ProtobufMecanumDriveKinematics_CALLBACK NULL
...
X(a, STATIC,   OPTIONAL, MESSAGE,  angle,             2)
#define wpi_proto_ProtobufSwerveModulePosition_CALLBACK NULL
...
X(a, STATIC,   OPTIONAL, MESSAGE,  angle,             2)
#define wpi_proto_ProtobufSwerveModuleState_CALLBACK NULL
...
#define WPI_PROTO_KINEMATICS_NBP_H_MAX_SIZE      wpi_proto_ProtobufMecanumDriveKinematics_size
...
#define wpi_proto_ProtobufMecanumDriveKinematics_size 80
...
#define wpi_proto_ProtobufSwerveModulePosition_size 20
#define wpi_proto_ProtobufSwerveModuleState_size 20
