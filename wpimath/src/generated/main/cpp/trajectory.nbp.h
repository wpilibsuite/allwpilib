...
#ifndef PB_WPI_PROTO_TRAJECTORY_NBP_H_INCLUDED
#define PB_WPI_PROTO_TRAJECTORY_NBP_H_INCLUDED
#include <pb.h>
...
#define wpi_proto_ProtobufTrajectoryState_init_default {0, 0, 0, false, wpi_proto_ProtobufPose2d_init_default, 0}
#define wpi_proto_ProtobufTrajectory_init_default {{{NULL}, NULL}}
#define wpi_proto_ProtobufTrajectoryState_init_zero {0, 0, 0, false, wpi_proto_ProtobufPose2d_init_zero, 0}
...
X(a, STATIC,   OPTIONAL, MESSAGE,  pose,              4) \
X(a, STATIC,   SINGULAR, DOUBLE,   curvature,         5)
#define wpi_proto_ProtobufTrajectoryState_CALLBACK NULL
...
#define WPI_PROTO_TRAJECTORY_NBP_H_MAX_SIZE      wpi_proto_ProtobufTrajectoryState_size
#define wpi_proto_ProtobufTrajectoryState_size   69
