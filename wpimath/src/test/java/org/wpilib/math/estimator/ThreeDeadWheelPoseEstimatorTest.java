...
class ThreeDeadWheelPoseEstimatorTest {
  ...
  void testSimultaneousVisionMeasurements() {
    ...
    var estimator =
        new ThreeDeadWheelPoseEstimator(
            1, -1, 1, Rotation2d.kZero, new ThreeDeadWheelPositions(), Pose2d.kZero);

    estimator.updateWithTime(0, Rotation2d.kZero, new ThreeDeadWheelPositions());
  ...
  void testDiscardsStaleVisionMeasurements() {
    ...
    for (; time < 4; time += 0.02) {
      estimator.updateWithTime(time, Rotation2d.kZero, new ThreeDeadWheelPositions());
    }
  ...
  void testSampleAt() {
    ...
    for (double time = 1; time <= 2 + 1e-9; time += 0.02) {
      estimator.updateWithTime(
          time, Rotation2d.kZero, new ThreeDeadWheelPositions(time, time, 0));
    }
  ...
  void testReset() {
    ...
    estimator.resetPosition(
        Rotation2d.kZero,
        new ThreeDeadWheelPositions(1, 1, 0),
    ...
    estimator.update(Rotation2d.kZero, new ThreeDeadWheelPositions(2, 2, 0));
    ...
    // Test orientation
    estimator.update(Rotation2d.kZero, new ThreeDeadWheelPositions(3, 3, 0));
