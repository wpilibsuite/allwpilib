...
class TwoDeadWheelPoseEstimator3dTest {
  ...
  void testSimultaneousVisionMeasurements() {
    ...
    estimator.updateWithTime(0, Rotation3d.kZero, new TwoDeadWheelPositions());
  ...
  void testDiscardsStaleVisionMeasurements() {
    ...
    for (; time < 4; time += 0.02) {
      estimator.updateWithTime(time, Rotation3d.kZero, new TwoDeadWheelPositions());
    }
  ...
  void testSampleAt() {
    ...
    for (double time = 1; time <= 2 + 1e-9; time += 0.02) {
      estimator.updateWithTime(time, Rotation3d.kZero, new TwoDeadWheelPositions(time, 0));
    }
  ...
  void testReset() {
    ...
    estimator.update(Rotation3d.kZero, new TwoDeadWheelPositions(2, 0));
    ...
    // Test orientation
    estimator.update(Rotation3d.kZero, new TwoDeadWheelPositions(3, 0));
