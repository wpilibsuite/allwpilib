...
class TwoDeadWheelPoseEstimatorTest {
  ...
  void testSimultaneousVisionMeasurements() {
    ...
    var estimator =
        new TwoDeadWheelPoseEstimator(
            1, 1, Rotation2d.kZero, new TwoDeadWheelPositions(), Pose2d.kZero);

    estimator.updateWithTime(0, Rotation2d.kZero, new TwoDeadWheelPositions());
  ...
  void testDiscardsStaleVisionMeasurements() {
    ...
    for (; time < 4; time += 0.02) {
      estimator.updateWithTime(time, Rotation2d.kZero, new TwoDeadWheelPositions());
    }
  ...
  void testSampleAt() {
    ...
    for (double time = 1; time <= 2 + 1e-9; time += 0.02) {
      estimator.updateWithTime(time, Rotation2d.kZero, new TwoDeadWheelPositions(time, 0));
    }
  ...
  void testReset() {
    ...
    estimator.resetPosition(
        Rotation2d.kZero, new TwoDeadWheelPositions(1, 0), new Pose2d(1, 0, Rotation2d.kZero));
    ...
    estimator.update(Rotation2d.kZero, new TwoDeadWheelPositions(2, 0));
    ...
    // Test orientation
    estimator.update(Rotation2d.kZero, new TwoDeadWheelPositions(3, 0));
