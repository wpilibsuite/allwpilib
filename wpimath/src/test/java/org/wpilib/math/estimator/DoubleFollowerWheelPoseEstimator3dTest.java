...
class DoubleFollowerWheelPoseEstimator3dTest {
  ...
  void testSimultaneousVisionMeasurements() {
    ...
    var estimator =
      new DoubleFollowerWheelPoseEstimator3d(
        1,1,
        Rotation3d.kZero,
    ...
    estimator.updateWithTime(0, Rotation3d.kZero, new DoubleFollowerWheelPositions());
  ...
  void testDiscardsStaleVisionMeasurements() {
    ...
    for (; time < 4; time += 0.02) {
      estimator.updateWithTime(time, Rotation3d.kZero, new DoubleFollowerWheelPositions());
    }
  ...
  void testSampleAt() {
    ...
    for (double time = 1; time <= 2 + 1e-9; time += 0.02) {
      estimator.updateWithTime(time, Rotation3d.kZero, new DoubleFollowerWheelPositions(time, 0));
    }
  ...
  void testReset() {
    ...
    // Test reset position
    estimator.resetPosition(Rotation3d.kZero, new DoubleFollowerWheelPositions(1,0), new Pose3d(1,
    ...
    estimator.update(Rotation3d.kZero, new DoubleFollowerWheelPositions(2,0));
    ...
    // Test orientation
    estimator.update(Rotation3d.kZero, new DoubleFollowerWheelPositions(3,0));
