...
class ThreeDeadWheelPoseEstimator3dTest {
  ...
  void testSimultaneousVisionMeasurements() {
    ...
    var estimator =
        new ThreeDeadWheelPoseEstimator3d(
            1,
            -1,
            1,
            Rotation3d.kZero,
    ...
    estimator.updateWithTime(0, Rotation3d.kZero, new ThreeDeadWheelPositions());
  ...
  void testDiscardsStaleVisionMeasurements() {
    ...
    for (; time < 4; time += 0.02) {
      estimator.updateWithTime(time, Rotation3d.kZero, new ThreeDeadWheelPositions());
    }
  ...
  void testSampleAt() {
    ...
    for (double time = 1; time <= 2 + 1e-9; time += 0.02) {
      estimator.updateWithTime(
          time, Rotation3d.kZero, new ThreeDeadWheelPositions(time, time, 0));
    }
  ...
  void testReset() {
    ...
    estimator.update(Rotation3d.kZero, new ThreeDeadWheelPositions(2, 2, 0));
    ...
    // Test orientation
    estimator.update(Rotation3d.kZero, new ThreeDeadWheelPositions(3, 3, 0));
