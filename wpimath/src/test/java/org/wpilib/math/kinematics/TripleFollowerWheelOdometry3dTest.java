...
class TripleFollowerWheelOdometry3dTest {
  ...
  void testTwoIterations() {
    ...
    m_odometry.resetPosition(Rotation3d.kZero, new TripleFollowerWheelPositions(), Pose3d.kZero);

    m_odometry.update(Rotation3d.kZero, new TripleFollowerWheelPositions());
