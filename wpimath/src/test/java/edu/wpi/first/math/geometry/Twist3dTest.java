...
class Twist3dTest {
  ...
  void testStraightX() {
    ...
    var straightPose = Pose3d.ZERO.exp(straight);

    var expected = new Pose3d(5.0, 0.0, 0.0, Rotation3d.ZERO);
  ...
  void testStraightY() {
    ...
    var expected = new Pose3d(0.0, 5.0, 0.0, Rotation3d.ZERO);
    assertEquals(expected, straightPose);
  }
  ...
  void testStraightZ() {
    ...
    var expected = new Pose3d(0.0, 0.0, 5.0, Rotation3d.ZERO);
    assertEquals(expected, straightPose);
  }
  ...
  void testQuarterCircle() {
    ...
    var quarterCirclePose = Pose3d.ZERO.exp(quarterCircle);
  ...
  void testDiagonalNoDtheta() {
    ...
    var diagonalPose = Pose3d.ZERO.exp(diagonal);

    var expected = new Pose3d(2.0, 2.0, 0.0, Rotation3d.ZERO);
