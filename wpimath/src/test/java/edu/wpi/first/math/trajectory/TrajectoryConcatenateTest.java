...
class TrajectoryConcatenateTest {
  @Test
  void testStates() {
    var t1 = TrajectoryGenerator.generateTrajectory(
        Pose2d.kZero, List.of(), new Pose2d(1, 1, Rotation2d.kZero), new TrajectoryConfig(2, 2));

    var t2 = TrajectoryGenerator.generateTrajectory(
