...
class MecanumDrivePoseEstimatorTest {
  ...
  void testFollowTrajectory3d(
    ...
    estimator.resetPosition(new Rotation3d(), wheelPositions, startingPose.plus(initialConditions));
    ...
    while (t <= trajectory.getTotalTimeSeconds()) {
      ...
      var xHat =
          estimator.updateWithTime(t, trajectoryRotation3d.plus(gaussianNoise), wheelPositions);
