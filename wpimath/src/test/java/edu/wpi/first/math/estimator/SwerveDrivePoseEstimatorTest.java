...
class SwerveDrivePoseEstimatorTest {
  ...
  void testDiscardsOldVisionMeasurements() {
    ...
    for (; time < 4; time += 0.02) {
      estimator.updateWithTime(time, Rotation2d.kZero, new SwerveModulePosition[] {
        new SwerveModulePosition(),
        new SwerveModulePosition(),
        new SwerveModulePosition(),
        new SwerveModulePosition()
  ...
  void testSampleAt() {
    ...
    for (double time = 1; time <= 2 + 1e-9; time += 0.02) {
      var wheelPositions = new SwerveModulePosition[] {
  ...
  void testReset() {
    ...
    // Test reset position
    {
      ...
      estimator.resetPosition(
          Rotation2d.kZero,
          new SwerveModulePosition[] {modulePosition, modulePosition, modulePosition, modulePosition
          },
    ...
    // Test orientation and wheel positions
    {
      ...
      estimator.update(Rotation2d.kZero, new SwerveModulePosition[] {
    ...
    assertAll(
        ...
        () -> assertEquals(0, estimator.getEstimatedPosition().getY(), kEpsilon),
        () -> assertEquals(
            Math.PI / 2, estimator.getEstimatedPosition().getRotation().getRadians(), kEpsilon));
