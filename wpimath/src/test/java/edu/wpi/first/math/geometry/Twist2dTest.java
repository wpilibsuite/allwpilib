...
class Twist2dTest {
  ...
  void testStraight() {
    ...
    var straightPose = Pose2d.ZERO.exp(straight);

    var expected = new Pose2d(5.0, 0.0, Rotation2d.ZERO);
  ...
  void testQuarterCircle() {
    ...
    var quarterCirclePose = Pose2d.ZERO.exp(quarterCircle);

    var expected = new Pose2d(5.0, 5.0, Rotation2d.CCW_PI_2);
  ...
  void testDiagonalNoDtheta() {
    ...
    var diagonalPose = Pose2d.ZERO.exp(diagonal);

    var expected = new Pose2d(2.0, 2.0, Rotation2d.ZERO);
  ...
  void testPose2dLog() {
    ...
    final var end = new Pose2d(5.0, 5.0, Rotation2d.CCW_PI_2);
