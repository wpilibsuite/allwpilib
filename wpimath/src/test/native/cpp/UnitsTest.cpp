...
TEST_CASE_METHOD(TypeTraits, "TypeTraits inverse", "[wpimath]") {
  ...
  CHECK(5.0 / 9.0 == Catch::Approx(test).margin(5.0e-5));

  test = convert<inverse<kelvin>, inverse<fahrenheit>>(6.0);
  CHECK(10.0 / 3.0 == Catch::Approx(test).margin(5.0e-5));
}
...
TEST_CASE_METHOD(UnitManipulators, "UnitManipulators squared", "[wpimath]") {
  ...
  CHECK(0.99999956944 == Catch::Approx(test).margin(5.0e-12));
...
TEST_CASE_METHOD(UnitManipulators, "UnitManipulators cubed", "[wpimath]") {
  ...
  CHECK(0.999998354619 == Catch::Approx(test).margin(5.0e-13));
}
...
TEST_CASE_METHOD(UnitManipulators, "UnitManipulators square root", "[wpimath]") {
  ...
  CHECK((traits::is_convertible_unit_v<
               ...
               kilometer>));
  CHECK(1000.0 == Catch::Approx(test).margin(5.0e-13));
}
...
TEST_CASE_METHOD(UnitContainer, "UnitContainer unitTypeAddition", "[wpimath]") {
  ...
  CHECK(1.0 == Catch::Approx(d).margin(5.0e-5));

  c_m = a_m + b_ft;
  CHECK(2.0 == Catch::Approx(c_m()).margin(5.0e-5));

  c_m = b_ft + meter_t(3);
  CHECK(4.0 == Catch::Approx(c_m()).margin(5.0e-5));

  auto e_ft = b_ft + meter_t(3);
  CHECK(13.12336 == Catch::Approx(e_ft()).margin(5.0e-6));

  // scalar
  scalar_t sresult = scalar_t(1.0) + scalar_t(1.0);
  CHECK(2.0 == Catch::Approx(sresult).margin(5.0e-6));
  ...
  CHECK(2.0 == Catch::Approx(d).margin(5.0e-6));
...
TEST_CASE_METHOD(UnitContainer, "UnitContainer unitTypeSubtraction", "[wpimath]") {
  ...
  c_m = a_m - b_ft;
  CHECK(0.0 == Catch::Approx(c_m()).margin(5.0e-5));

  c_m = b_ft - meter_t(1);
  CHECK(0.0 == Catch::Approx(c_m()).margin(5.0e-5));

  auto e_ft = b_ft - meter_t(1);
  CHECK(0.0 == Catch::Approx(e_ft()).margin(5.0e-6));

  scalar_t sresult = scalar_t(1.0) - scalar_t(1.0);
  CHECK(0.0 == Catch::Approx(sresult).margin(5.0e-6));
  ...
  CHECK(0.0 == Catch::Approx(d).margin(5.0e-6));
...
TEST_CASE_METHOD(UnitContainer, "UnitContainer unitTypeMultiplication", "[wpimath]") {
  ...
  auto c_m2 = a_m * b_m;
  CHECK(2.0 == Catch::Approx(c_m2()).margin(5.0e-5));

  c_m2 = b_m * meter_t(2);
  CHECK(4.0 == Catch::Approx(c_m2()).margin(5.0e-5));
  ...
  CHECK(3.14 == Catch::Approx(convert).margin(5.0e-5));

  scalar_t sresult = scalar_t(5.0) * scalar_t(4.0);
  CHECK(20.0 == Catch::Approx(sresult()).margin(5.0e-5));
  ...
  CHECK(20.0 == Catch::Approx(result).margin(5.0e-5));
...
TEST_CASE_METHOD(UnitContainer, "UnitContainer unitTypeMixedUnitMultiplication", "[wpimath]") {
  ...
  auto c_m2 = a_m * b_ft;
  CHECK(1.0 == Catch::Approx(c_m2()).margin(5.0e-5));

  auto c_ft2 = b_ft * a_m;
  CHECK(10.7639111056 == Catch::Approx(c_ft2()).margin(5.0e-7));

  // you can get whatever (compatible) type you want if you ask explicitly
  square_meter_t d_m2 = b_ft * a_m;
  CHECK(1.0 == Catch::Approx(d_m2()).margin(5.0e-5));

  // a unit times a sclar ends up with the same units.
  meter_t e_m = a_m * scalar_t(3.0);
  CHECK(3.0 == Catch::Approx(e_m()).margin(5.0e-5));

  e_m = scalar_t(4.0) * a_m;
  CHECK(4.0 == Catch::Approx(e_m()).margin(5.0e-5));

  // unit times its inverse results in a scalar
  scalar_t s = a_m * i_m;
  CHECK(2.0 == Catch::Approx(s).margin(5.0e-5));

  c_m2 = b_ft * meter_t(2);
  CHECK(2.0 == Catch::Approx(c_m2()).margin(5.0e-5));

  auto e_ft2 = b_ft * meter_t(3);
  CHECK(32.2917333168 == Catch::Approx(e_ft2()).margin(5.0e-6));
...
TEST_CASE_METHOD(UnitContainer, "UnitContainer unitTypeScalarMultiplication", "[wpimath]") {
  ...
  CHECK(3.0 == Catch::Approx(result_m()).margin(5.0e-5));

  result_m = a_m * scalar_t(4.0);
  CHECK(4.0 == Catch::Approx(result_m()).margin(5.0e-5));
...
TEST_CASE_METHOD(UnitContainer, "UnitContainer unitTypeDivision", "[wpimath]") {
  ...
  auto c = a_m / a_ft;
  CHECK(1.0 == Catch::Approx(c).margin(5.0e-5));
  isSame = std::is_same_v<decltype(c), scalar_t>;
  CHECK(isSame);

  c = a_m / b_m;
  CHECK(0.5 == Catch::Approx(c).margin(5.0e-5));
  isSame = std::is_same_v<decltype(c), scalar_t>;
  CHECK(isSame);
...
TEST_CASE_METHOD(UnitContainer, "UnitContainer scalarTypeImplicitConversion", "[wpimath]") {
  ...
  CHECK(3.0 == Catch::Approx(test));

  scalar_t testS = 3.0;
  CHECK(3.0 == Catch::Approx(testS));

  scalar_t test3(ppm_t(10));
  CHECK(0.00001 == Catch::Approx(test3));

  scalar_t test4;
  test4 = ppm_t(1);
  CHECK(0.000001 == Catch::Approx(test4));
}
...
TEST_CASE_METHOD(UnitContainer, "UnitContainer convertMethod", "[wpimath]") {
  ...
  CHECK(9.84252 == Catch::Approx(test).margin(5.0e-6));
}
...
TEST_CASE_METHOD(UnitContainer, "UnitContainer fmtlib", "[wpimath]") {
  CHECK(std::string_view{"349.87 deg"} ==
        std::string_view{fmt::format("{}", degree_t(349.87))});

  CHECK(std::string_view{"1 m"} ==
        std::string_view{fmt::format("{}", meter_t(1.0))});

  CHECK(std::string_view{"31 dB"} ==
        std::string_view{fmt::format("{}", dB_t(31.0))});

  CHECK(std::string_view{"21.79 V"} ==
        std::string_view{fmt::format("{}", volt_t(21.79))});

  CHECK(std::string_view{"12 dBW"} ==
        std::string_view{fmt::format("{}", dBW_t(12.0))});

  CHECK(std::string_view{"120 dBm"} ==
        std::string_view{fmt::format("{}", dBm_t(120.0))});

  CHECK(std::string_view{"72.1 mph"} ==
        std::string_view{fmt::format("{}", miles_per_hour_t(72.1))});
...
#if defined(_MSC_VER) && (_MSC_VER <= 1800)
  CHECK(std::string_view{"1.3806485e-023 m^2 kg s^-2 K^-1"} ==
        std::string_view{fmt::format("{:.8}", constants::k_B)});
#else
  CHECK(std::string_view{"1.3806485e-23 m^2 kg s^-2 K^-1"} ==
        std::string_view{fmt::format("{:.8}", constants::k_B)});
#endif
...
#if defined(_MSC_VER) && (_MSC_VER <= 1800)
  CHECK(std::string_view{"9.27400999e-024 m^2 A"} ==
        std::string_view{fmt::format("{:.9}", constants::mu_B)});
#else
  CHECK(std::string_view{"9.27400999e-24 m^2 A"} ==
        std::string_view{fmt::format("{:.9}", constants::mu_B)});
#endif
...
#if defined(_MSC_VER) && (_MSC_VER <= 1800)
  CHECK(std::string_view{"5.670367e-008 kg s^-3 K^-4"} ==
        std::string_view{fmt::format("{:.7}", constants::sigma)});
#else
  CHECK(std::string_view{"5.670367e-08 kg s^-3 K^-4"} ==
        std::string_view{fmt::format("{:.7}", constants::sigma)});
#endif
...
TEST_CASE_METHOD(UnitContainer, "UnitContainer negative", "[wpimath]") {
  meter_t a(5.3);
  meter_t b(-5.3);
  CHECK(a.value() == Catch::Approx(-b.value()).margin(5.0e-320));
  CHECK(b.value() == Catch::Approx(-a.value()).margin(5.0e-320));

  dB_t c(2.87);
  dB_t d(-2.87);
  CHECK(c.value() == Catch::Approx(-d.value()).margin(5.0e-320));
  CHECK(d.value() == Catch::Approx(-c.value()).margin(5.0e-320));

  ppm_t e = -1 * ppm_t(10);
  CHECK(e == -ppm_t(10));
  CHECK(-0.00001 == Catch::Approx(e).margin(5.0e-10));
}
...
TEST_CASE_METHOD(UnitContainer, "UnitContainer dBConversion", "[wpimath]") {
  ...
  CHECK(204.173794 == Catch::Approx(a_w()).margin(5.0e-7));
  CHECK(53.1 == Catch::Approx(a_dbm()).margin(5.0e-7));
  ...
  CHECK(100.0 == Catch::Approx(b_w()).margin(5.0e-7));
  CHECK(50.0 == Catch::Approx(b_dbm()).margin(5.0e-7));
  CHECK(20.0 == Catch::Approx(b_dbw()).margin(5.0e-7));
}
...
TEST_CASE_METHOD(UnitContainer, "UnitContainer dBSubtraction", "[wpimath]") {
  ...
  auto result_dbw = dBW_t(10.0) - dB_t(30.0);
  CHECK(-20.0 == Catch::Approx(result_dbw()).margin(5.0e-5));
  isSame = std::is_same_v<decltype(result_dbw), dBW_t>;
  CHECK(isSame);

  auto result_dbm = dBm_t(100.0) - dB_t(30.0);
  CHECK(70.0 == Catch::Approx(result_dbm()).margin(5.0e-5));
  isSame = std::is_same_v<decltype(result_dbm), dBm_t>;
  CHECK(isSame);

  auto result_db = dBW_t(100.0) - dBW_t(80.0);
  CHECK(20.0 == Catch::Approx(result_db()).margin(5.0e-5));
...
TEST_CASE_METHOD(UnitConversion, "UnitConversion length", "[wpimath]") {
  ...
  CHECK(1.0 == Catch::Approx(test).margin(5.0e-20));
  ...
  CHECK(1.0 == Catch::Approx(test).margin(5.0e7));

  test = convert<feet, feet>(6.3);
  CHECK(6.3 == Catch::Approx(test).margin(5.0e-5));
  test = convert<feet, inches>(6.0);
  CHECK(72.0 == Catch::Approx(test).margin(5.0e-5));
  test = convert<inches, feet>(6.0);
  CHECK(0.5 == Catch::Approx(test).margin(5.0e-5));
  test = convert<meter, feet>(1.0);
  CHECK(3.28084 == Catch::Approx(test).margin(5.0e-5));
  test = convert<miles, nauticalMiles>(6.3);
  CHECK(5.47455 == Catch::Approx(test).margin(5.0e-6));
  test = convert<miles, meters>(11.0);
  CHECK(17702.8 == Catch::Approx(test).margin(5.0e-2));
  test = convert<meters, chains>(1.0);
  CHECK(0.0497097 == Catch::Approx(test).margin(5.0e-7));
}
...
TEST_CASE_METHOD(UnitConversion, "UnitConversion mass", "[wpimath]") {
  ...
  CHECK(1.0 == Catch::Approx(test).margin(5.0e-6));
  ...
  CHECK(14.593903 == Catch::Approx(test).margin(5.0e-7));

  test = convert<pounds, carats>(6.3);
  CHECK(14288.2 == Catch::Approx(test).margin(5.0e-2));
}
...
TEST_CASE_METHOD(UnitConversion, "UnitConversion time", "[wpimath]") {
  ...
  result = 2 * daysPerYear * hoursPerDay * minsPerHour * secsPerMin *
           ...
           (1 / daysPerWeek);
  CHECK(104.286 == Catch::Approx(result).margin(5.0e-4));

  year_t twoYears(2.0);
  week_t twoYearsInWeeks = twoYears;
  CHECK(week_t(104.286).value() == Catch::Approx(twoYearsInWeeks.value()).margin(5.0e-4));
  ...
  CHECK(1.0 == Catch::Approx(test).margin(5.0e3));

  test = convert<years, weeks>(2.0);
  CHECK(104.2857142857143 == Catch::Approx(test).margin(5.0e-14));
  test = convert<hours, minutes>(4.0);
  CHECK(240.0 == Catch::Approx(test).margin(5.0e-14));
  test = convert<julian_years, days>(1.0);
  CHECK(365.25 == Catch::Approx(test).margin(5.0e-14));
  test = convert<gregorian_years, days>(1.0);
  CHECK(365.2425 == Catch::Approx(test).margin(5.0e-14));
}
...
TEST_CASE_METHOD(UnitConversion, "UnitConversion angle", "[wpimath]") {
  ...
  CHECK(angle::radian_t(constants::detail::PI_VAL / 2.0).value() == Catch::Approx(quarterCircleRad.value()).margin(5.0e-12));
  ...
  CHECK(1.0 == Catch::Approx(test).margin(5.0e-4));
  test = convert<angle::radians, angle::degrees>(0.0174533);
  CHECK(1.0 == Catch::Approx(test).margin(5.0e-7));
  test = convert<angle::radians, angle::arcminutes>(0.000290888);
  CHECK(0.99999928265913 == Catch::Approx(test).margin(5.0e-8));
  test = convert<angle::radians, angle::arcseconds>(4.8481e-6);
  CHECK(0.999992407 == Catch::Approx(test).margin(5.0e-10));
  ...
  CHECK(2.1 == Catch::Approx(test).margin(5.0e-6));
  test = convert<angle::arcseconds, angle::gradians>(2.1);
  CHECK(0.000648148 == Catch::Approx(test).margin(5.0e-6));
  test = convert<angle::radians, angle::degrees>(constants::detail::PI_VAL);
  CHECK(180.0 == Catch::Approx(test).margin(5.0e-6));
  test = convert<angle::degrees, angle::radians>(90.0);
  CHECK(constants::detail::PI_VAL / 2 == Catch::Approx(test).margin(5.0e-6));
}
...
TEST_CASE_METHOD(UnitConversion, "UnitConversion current", "[wpimath]") {
  ...
  CHECK(2100.0 == Catch::Approx(test).margin(5.0e-6));
}
...
TEST_CASE_METHOD(UnitConversion, "UnitConversion temperature", "[wpimath]") {
  ...
  CHECK(80.33 == Catch::Approx(test).margin(5.0e-5));
  test = convert<fahrenheit, kelvin>(451.0);
  CHECK(505.928 == Catch::Approx(test).margin(5.0e-4));
  test = convert<kelvin, celsius>(300.0);
  CHECK(26.85 == Catch::Approx(test).margin(5.0e-3));
  test = convert<celsius, kelvin>(451.0);
  CHECK(724.15 == Catch::Approx(test).margin(5.0e-3));
  test = convert<fahrenheit, celsius>(72.0);
  CHECK(22.2222 == Catch::Approx(test).margin(5.0e-5));
  test = convert<celsius, fahrenheit>(100.0);
  CHECK(212.0 == Catch::Approx(test).margin(5.0e-5));
  test = convert<fahrenheit, celsius>(32.0);
  CHECK(0.0 == Catch::Approx(test).margin(5.0e-5));
  test = convert<celsius, fahrenheit>(0.0);
  CHECK(32.0 == Catch::Approx(test).margin(5.0e-5));
  test = convert<rankine, kelvin>(100.0);
  CHECK(55.5556 == Catch::Approx(test).margin(5.0e-5));
  test = convert<kelvin, rankine>(100.0);
  CHECK(180.0 == Catch::Approx(test).margin(5.0e-5));
  test = convert<fahrenheit, rankine>(100.0);
  CHECK(559.67 == Catch::Approx(test).margin(5.0e-5));
  test = convert<rankine, fahrenheit>(72.0);
  CHECK(-387.67 == Catch::Approx(test).margin(5.0e-5));
  test = convert<reaumur, kelvin>(100.0);
  CHECK(398.0 == Catch::Approx(test).margin(5.0e-1));
  test = convert<reaumur, celsius>(80.0);
  CHECK(100.0 == Catch::Approx(test).margin(5.0e-5));
  test = convert<celsius, reaumur>(212.0);
  CHECK(169.6 == Catch::Approx(test).margin(5.0e-2));
  test = convert<reaumur, fahrenheit>(80.0);
  CHECK(212.0 == Catch::Approx(test).margin(5.0e-5));
  test = convert<fahrenheit, reaumur>(37.0);
  CHECK(2.222 == Catch::Approx(test).margin(5.0e-3));
}
...
TEST_CASE_METHOD(UnitConversion, "UnitConversion luminous intensity", "[wpimath]") {
  ...
  CHECK(72000.0 == Catch::Approx(test).margin(5.0e-5));
  test = convert<millicandela, candela>(376.0);
  CHECK(0.376 == Catch::Approx(test).margin(5.0e-5));
}
...
TEST_CASE_METHOD(UnitConversion, "UnitConversion solid angle", "[wpimath]") {
  ...
  CHECK(3282.8 == Catch::Approx(test).margin(5.0e-2));
  test = convert<steradians, spats>(8.0);
  CHECK(0.636619772367582 == Catch::Approx(test).margin(5.0e-14));
  test = convert<degrees_squared, steradians>(3282.8);
  CHECK(1.0 == Catch::Approx(test).margin(5.0e-5));
  test = convert<degrees_squared, degrees_squared>(72.0);
  CHECK(72.0 == Catch::Approx(test).margin(5.0e-5));
  test = convert<degrees_squared, spats>(3282.8);
  CHECK(1.0 / (4 * constants::detail::PI_VAL) == Catch::Approx(test).margin(5.0e-5));
  test = convert<spats, steradians>(1.0 / (4 * constants::detail::PI_VAL));
  CHECK(1.0 == Catch::Approx(test).margin(5.0e-14));
...
TEST_CASE_METHOD(UnitConversion, "UnitConversion frequency", "[wpimath]") {
  ...
  CHECK(63.0 == Catch::Approx(test).margin(5.0e-5));
  test = convert<hertz, hertz>(6.3);
  CHECK(6.3 == Catch::Approx(test).margin(5.0e-5));
  test = convert<kilohertz, hertz>(5.0);
  CHECK(5000.0 == Catch::Approx(test).margin(5.0e-5));
  test = convert<megahertz, hertz>(1.0);
  CHECK(1.0e6 == Catch::Approx(test).margin(5.0e-5));
}
...
TEST_CASE_METHOD(UnitConversion, "UnitConversion velocity", "[wpimath]") {
  ...
  CHECK(2796.17 == Catch::Approx(test).margin(5.0e-3));
  test = convert<feet_per_second, kilometers_per_hour>(2796.17);
  CHECK(3068.181418 == Catch::Approx(test).margin(5.0e-7));
  test = convert<knots, miles_per_hour>(600.0);
  CHECK(690.468 == Catch::Approx(test).margin(5.0e-4));
  test = convert<miles_per_hour, feet_per_second>(120.0);
  CHECK(176.0 == Catch::Approx(test).margin(5.0e-5));
  test = convert<feet_per_second, meters_per_second>(10.0);
  CHECK(3.048 == Catch::Approx(test).margin(5.0e-5));
}
...
TEST_CASE_METHOD(UnitConversion, "UnitConversion angular velocity", "[wpimath]") {
  ...
  CHECK(6.504e15 == Catch::Approx(test).margin(1.0e12));
  test = convert<degrees_per_second, radians_per_second>(1.0);
  CHECK(0.0174533 == Catch::Approx(test).margin(5.0e-8));
  test = convert<rpm, radians_per_second>(1.0);
  CHECK(0.10471975512 == Catch::Approx(test).margin(5.0e-13));
  test = convert<milliarcseconds_per_year, radians_per_second>(1.0);
  CHECK(1.537e-16 == Catch::Approx(test).margin(5.0e-20));
}
...
TEST_CASE_METHOD(UnitConversion, "UnitConversion angular jerk", "[wpimath]") {
  ...
  CHECK(6.283185307 == Catch::Approx(test).margin(5.0e-6));
}
...
TEST_CASE_METHOD(UnitConversion, "UnitConversion acceleration", "[wpimath]") {
  ...
  CHECK(9.80665 == Catch::Approx(test).margin(5.0e-10));
}
...
TEST_CASE_METHOD(UnitConversion, "UnitConversion area", "[wpimath]") {
  ...
  CHECK(15.5676 == Catch::Approx(test).margin(5.0e-5));
  test = convert<square_miles, square_kilometers>(10.0);
  CHECK(25.8999 == Catch::Approx(test).margin(5.0e-5));
  test = convert<square_inch, square_meter>(4.0);
  CHECK(0.00258064 == Catch::Approx(test).margin(5.0e-9));
  test = convert<acre, square_foot>(5.0);
  CHECK(217800.0 == Catch::Approx(test).margin(5.0e-5));
  test = convert<square_meter, square_foot>(1.0);
  CHECK(10.7639 == Catch::Approx(test).margin(5.0e-5));
}
...
TEST_CASE_METHOD(UnitConversion, "UnitConversion pressure", "[wpimath]") {
  ...
  CHECK(0.00750062 == Catch::Approx(test).margin(5.0e-5));
  test = convert<bar, psi>(2.2);
  CHECK(31.9083 == Catch::Approx(test).margin(5.0e-5));
  test = convert<atmospheres, bar>(4.0);
  CHECK(4.053 == Catch::Approx(test).margin(5.0e-5));
  test = convert<torr, pascals>(800.0);
  CHECK(106657.89474 == Catch::Approx(test).margin(5.0e-5));
  test = convert<psi, atmospheres>(38.0);
  CHECK(2.58575 == Catch::Approx(test).margin(5.0e-5));
  test = convert<psi, pascals>(1.0);
  CHECK(6894.76 == Catch::Approx(test).margin(5.0e-3));
  test = convert<pascals, bar>(0.25);
  CHECK(2.5e-6 == Catch::Approx(test).margin(5.0e-5));
  test = convert<torr, atmospheres>(9.0);
  CHECK(0.0118421 == Catch::Approx(test).margin(5.0e-8));
  test = convert<bar, torr>(12.0);
  CHECK(9000.74 == Catch::Approx(test).margin(5.0e-3));
  test = convert<atmospheres, psi>(1.0);
  CHECK(14.6959 == Catch::Approx(test).margin(5.0e-5));
}
...
TEST_CASE_METHOD(UnitConversion, "UnitConversion charge", "[wpimath]") {
  ...
  CHECK(0.00111111 == Catch::Approx(test).margin(5.0e-9));
  test = convert<ampere_hours, coulombs>(1.0);
  CHECK(3600.0 == Catch::Approx(test).margin(5.0e-6));
}
...
TEST_CASE_METHOD(UnitConversion, "UnitConversion energy", "[wpimath]") {
  ...
  CHECK(1912.046 == Catch::Approx(test).margin(5.0e-4));
  test = convert<therms, joules>(12.0);
  CHECK(1.266e+9 == Catch::Approx(test).margin(5.0e5));
  test = convert<megajoules, watt_hours>(100.0);
  CHECK(27777.778 == Catch::Approx(test).margin(5.0e-4));
  test = convert<kilocalories, megajoules>(56.0);
  CHECK(0.234304 == Catch::Approx(test).margin(5.0e-7));
  test = convert<kilojoules, therms>(56.0);
  CHECK(0.000530904 == Catch::Approx(test).margin(5.0e-5));
  test = convert<british_thermal_units, kilojoules>(18.56399995447);
  CHECK(19.5860568 == Catch::Approx(test).margin(5.0e-5));
  test = convert<calories, energy::foot_pounds>(18.56399995447);
  CHECK(57.28776190423856 == Catch::Approx(test).margin(5.0e-5));
  test = convert<megajoules, calories>(1.0);
  CHECK(239006.0 == Catch::Approx(test).margin(5.0e-1));
  test = convert<kilocalories, kilowatt_hours>(2.0);
  CHECK(0.00232444 == Catch::Approx(test).margin(5.0e-9));
  test = convert<therms, kilocalories>(0.1);
  CHECK(2521.04 == Catch::Approx(test).margin(5.0e-3));
  test = convert<watt_hours, megajoules>(67.0);
  CHECK(0.2412 == Catch::Approx(test).margin(5.0e-5));
  test = convert<british_thermal_units, watt_hours>(100.0);
  CHECK(29.3071 == Catch::Approx(test).margin(5.0e-5));
  test = convert<calories, BTU>(100.0);
  CHECK(0.396567 == Catch::Approx(test).margin(5.0e-5));
}
...
TEST_CASE_METHOD(UnitConversion, "UnitConversion power", "[wpimath]") {
  ...
  test = convert<compound_unit<energy::foot_pounds, inverse<seconds>>, watts>(
      550.0);
  CHECK(745.7 == Catch::Approx(test).margin(5.0e-2));
  test = convert<watts, gigawatts>(1000000000.0);
  CHECK(1.0 == Catch::Approx(test).margin(5.0e-4));
  test = convert<microwatts, watts>(200000.0);
  CHECK(0.2 == Catch::Approx(test).margin(5.0e-4));
  test = convert<horsepower, watts>(100.0);
  CHECK(74570.0 == Catch::Approx(test).margin(5.0e-1));
  test = convert<horsepower, megawatts>(5.0);
  CHECK(0.0037284994 == Catch::Approx(test).margin(5.0e-7));
  test = convert<kilowatts, horsepower>(232.0);
  CHECK(311.117 == Catch::Approx(test).margin(5.0e-4));
  test = convert<milliwatts, horsepower>(1001.0);
  CHECK(0.001342363 == Catch::Approx(test).margin(5.0e-9));
}
...
TEST_CASE_METHOD(UnitConversion, "UnitConversion voltage", "[wpimath]") {
  ...
  CHECK(10000.0 == Catch::Approx(test).margin(5.0e-5));
  ...
  CHECK(299.792458 == Catch::Approx(test).margin(5.0e-5));
...
TEST_CASE_METHOD(UnitConversion, "UnitConversion illuminance", "[wpimath]") {
  ...
  CHECK(1.0 == Catch::Approx(test).margin(5.0e-13));
...
TEST_CASE_METHOD(UnitConversion, "UnitConversion torque", "[wpimath]") {
  ...
  CHECK(1.355817948 == Catch::Approx(test).margin(5.0e-5));
  test = convert<inch_pounds, newton_meter>(1.0);
  CHECK(0.112984829 == Catch::Approx(test).margin(5.0e-5));
  test = convert<foot_poundals, newton_meter>(1.0);
  CHECK(4.214011009e-2 == Catch::Approx(test).margin(5.0e-5));
  test = convert<meter_kilograms, newton_meter>(1.0);
  CHECK(9.80665 == Catch::Approx(test).margin(5.0e-5));
...
TEST_CASE_METHOD(UnitConversion, "UnitConversion volume", "[wpimath]") {
  ...
  CHECK(1.0e-9 == Catch::Approx(test).margin(5.0e-5));
  test = convert<cubic_kilometers, cubic_meter>(1.0);
  CHECK(1.0e9 == Catch::Approx(test).margin(5.0e-5));
  test = convert<liters, cubic_meter>(1.0);
  CHECK(0.001 == Catch::Approx(test).margin(5.0e-5));
  test = convert<milliliters, cubic_meter>(1.0);
  CHECK(1.0e-6 == Catch::Approx(test).margin(5.0e-5));
  test = convert<cubic_inches, cubic_meter>(1.0);
  CHECK(1.6387e-5 == Catch::Approx(test).margin(5.0e-10));
  test = convert<cubic_feet, cubic_meter>(1.0);
  CHECK(0.0283168 == Catch::Approx(test).margin(5.0e-8));
  test = convert<cubic_yards, cubic_meter>(1.0);
  CHECK(0.764555 == Catch::Approx(test).margin(5.0e-7));
  test = convert<cubic_miles, cubic_meter>(1.0);
  CHECK(4.168e+9 == Catch::Approx(test).margin(5.0e5));
  test = convert<gallons, cubic_meter>(1.0);
  CHECK(0.00378541 == Catch::Approx(test).margin(5.0e-8));
  test = convert<quarts, cubic_meter>(1.0);
  CHECK(0.000946353 == Catch::Approx(test).margin(5.0e-10));
  test = convert<pints, cubic_meter>(1.0);
  CHECK(0.000473176 == Catch::Approx(test).margin(5.0e-10));
  test = convert<cups, cubic_meter>(1.0);
  CHECK(0.00024 == Catch::Approx(test).margin(5.0e-6));
  test = convert<volume::fluid_ounces, cubic_meter>(1.0);
  CHECK(2.9574e-5 == Catch::Approx(test).margin(5.0e-5));
  test = convert<barrels, cubic_meter>(1.0);
  CHECK(0.158987294928 == Catch::Approx(test).margin(5.0e-13));
  test = convert<bushels, cubic_meter>(1.0);
  CHECK(0.0352391 == Catch::Approx(test).margin(5.0e-8));
  test = convert<cords, cubic_meter>(1.0);
  CHECK(3.62456 == Catch::Approx(test).margin(5.0e-6));
  test = convert<cubic_fathoms, cubic_meter>(1.0);
  CHECK(6.11644 == Catch::Approx(test).margin(5.0e-6));
  test = convert<tablespoons, cubic_meter>(1.0);
  CHECK(1.4787e-5 == Catch::Approx(test).margin(5.0e-10));
  test = convert<teaspoons, cubic_meter>(1.0);
  CHECK(4.9289e-6 == Catch::Approx(test).margin(5.0e-11));
  test = convert<pinches, cubic_meter>(1.0);
  CHECK(616.11519921875e-9 == Catch::Approx(test).margin(5.0e-20));
  test = convert<dashes, cubic_meter>(1.0);
  CHECK(308.057599609375e-9 == Catch::Approx(test).margin(5.0e-20));
  test = convert<drops, cubic_meter>(1.0);
  CHECK(82.14869322916e-9 == Catch::Approx(test).margin(5.0e-9));
  test = convert<fifths, cubic_meter>(1.0);
  CHECK(0.00075708236 == Catch::Approx(test).margin(5.0e-12));
  test = convert<drams, cubic_meter>(1.0);
  CHECK(3.69669e-6 == Catch::Approx(test).margin(5.0e-12));
  test = convert<gills, cubic_meter>(1.0);
  CHECK(0.000118294 == Catch::Approx(test).margin(5.0e-10));
  test = convert<pecks, cubic_meter>(1.0);
  CHECK(0.00880977 == Catch::Approx(test).margin(5.0e-9));
  test = convert<sacks, cubic_meter>(9.4591978);
  CHECK(1.0 == Catch::Approx(test).margin(5.0e-5));
  test = convert<shots, cubic_meter>(1.0);
  CHECK(4.43603e-5 == Catch::Approx(test).margin(5.0e-11));
  test = convert<strikes, cubic_meter>(1.0);
  CHECK(0.07047814033376 == Catch::Approx(test).margin(5.0e-5));
  test = convert<volume::fluid_ounces, milliliters>(1.0);
  CHECK(29.5735 == Catch::Approx(test).margin(5.0e-5));
}
...
TEST_CASE_METHOD(UnitConversion, "UnitConversion density", "[wpimath]") {
  ...
  CHECK(1000.0 == Catch::Approx(test).margin(5.0e-5));
...
TEST_CASE_METHOD(UnitConversion, "UnitConversion concentration", "[wpimath]") {
  ...
  test = ppm_t(1.0);
  CHECK(1.0e-6 == Catch::Approx(test).margin(5.0e-12));
  test = ppb_t(1.0);
  CHECK(1.0e-9 == Catch::Approx(test).margin(5.0e-12));
  test = ppt_t(1.0);
  CHECK(1.0e-12 == Catch::Approx(test).margin(5.0e-12));
  test = percent_t(18.0);
  CHECK(0.18 == Catch::Approx(test).margin(5.0e-12));
}
...
TEST_CASE_METHOD(UnitConversion, "UnitConversion data", "[wpimath]") {
  ...
  CHECK(percent_t(2.4) == Catch::Approx(kibibyte_t(1) / kilobyte_t(1) - 1).margin(0.005));
  CHECK(percent_t(4.9) == Catch::Approx(mebibyte_t(1) / megabyte_t(1) - 1).margin(0.005));
  CHECK(percent_t(7.4) == Catch::Approx(gibibyte_t(1) / gigabyte_t(1) - 1).margin(0.005));
  CHECK(percent_t(10.0) == Catch::Approx(tebibyte_t(1) / terabyte_t(1) - 1).margin(0.005));
  CHECK(percent_t(12.6) == Catch::Approx(pebibyte_t(1) / petabyte_t(1) - 1).margin(0.005));
  CHECK(percent_t(15.3) == Catch::Approx(exbibyte_t(1) / exabyte_t(1) - 1).margin(0.005));
}
...
TEST_CASE_METHOD(UnitConversion, "UnitConversion data transfer rate", "[wpimath]") {
  ...
  // Source: https://en.wikipedia.org/wiki/Binary_prefix
  CHECK(percent_t(2.4) == Catch::Approx(kibibytes_per_second_t(1) / kilobytes_per_second_t(1) - 1).margin(0.005));
  CHECK(percent_t(4.9) == Catch::Approx(mebibytes_per_second_t(1) / megabytes_per_second_t(1) - 1).margin(0.005));
  CHECK(percent_t(7.4) == Catch::Approx(gibibytes_per_second_t(1) / gigabytes_per_second_t(1) - 1).margin(0.005));
  CHECK(percent_t(10.0) == Catch::Approx(tebibytes_per_second_t(1) / terabytes_per_second_t(1) - 1).margin(0.005));
  CHECK(percent_t(12.6) == Catch::Approx(pebibytes_per_second_t(1) / petabytes_per_second_t(1) - 1).margin(0.005));
  CHECK(percent_t(15.3) == Catch::Approx(exbibytes_per_second_t(1) / exabytes_per_second_t(1) - 1).margin(0.005));
}
...
TEST_CASE_METHOD(UnitConversion, "UnitConversion pi", "[wpimath]") {
  ...
  CHECK(3.14159 == Catch::Approx(constants::pi).margin(5.0e-6));
  CHECK(6.28318531 == Catch::Approx((2 * constants::pi)).margin(5.0e-9));
  CHECK(6.28318531 == Catch::Approx((constants::pi + constants::pi)).margin(5.0e-9));
  CHECK(0.0 == Catch::Approx((constants::pi - constants::pi)).margin(5.0e-9));
  CHECK(31.00627668 == Catch::Approx(wpi::units::math::cpow<3>(constants::pi)).margin(5.0e-10));
  CHECK(0.0322515344 == Catch::Approx((1.0 / wpi::units::math::cpow<3>(constants::pi))).margin(5.0e-11));
  ...
  // explicit conversion
  CHECK(3.14159 == Catch::Approx(constants::pi.value()).margin(5.0e-6));

  // auto multiplication
  CHECK((std::is_same_v<meter_t, decltype(constants::pi * meter_t(1))>));
  CHECK((std::is_same_v<meter_t, decltype(meter_t(1) * constants::pi)>));

  CHECK(constants::detail::PI_VAL == Catch::Approx((constants::pi * meter_t(1)).value()).margin(5.0e-10));
  CHECK(constants::detail::PI_VAL == Catch::Approx((meter_t(1) * constants::pi).value()).margin(5.0e-10));

  // explicit multiplication
  meter_t a = constants::pi * meter_t(1);
  meter_t b = meter_t(1) * constants::pi;

  CHECK(constants::detail::PI_VAL == Catch::Approx(a.value()).margin(5.0e-10));
  CHECK(constants::detail::PI_VAL == Catch::Approx(b.value()).margin(5.0e-10));
  ...
  CHECK(constants::detail::PI_VAL == Catch::Approx((constants::pi / second_t(1)).value()).margin(5.0e-10));
  CHECK(1.0 / constants::detail::PI_VAL == Catch::Approx((second_t(1) / constants::pi).value()).margin(5.0e-10));

  // explicit
  hertz_t c = constants::pi / second_t(1);
  second_t d = second_t(1) / constants::pi;

  CHECK(constants::detail::PI_VAL == Catch::Approx(c.value()).margin(5.0e-10));
  CHECK(1.0 / constants::detail::PI_VAL == Catch::Approx(d.value()).margin(5.0e-10));
}

TEST_CASE_METHOD(UnitConversion, "UnitConversion constants", "[wpimath]") {
  // Source: NIST "2014 CODATA recommended values"
  CHECK(299792458 == Catch::Approx(constants::c()).margin(5.0e-9));
  CHECK(6.67408e-11 == Catch::Approx(constants::G()).margin(5.0e-17));
  CHECK(6.626070040e-34 == Catch::Approx(constants::h()).margin(5.0e-44));
  CHECK(1.2566370614e-6 == Catch::Approx(constants::mu0()).margin(5.0e-17));
  CHECK(8.854187817e-12 == Catch::Approx(constants::epsilon0()).margin(5.0e-21));
  CHECK(376.73031346177 == Catch::Approx(constants::Z0()).margin(5.0e-12));
  CHECK(8987551787.3681764 == Catch::Approx(constants::k_e()).margin(5.0e-6));
  CHECK(1.6021766208e-19 == Catch::Approx(constants::e()).margin(5.0e-29));
  CHECK(9.10938356e-31 == Catch::Approx(constants::m_e()).margin(5.0e-40));
  CHECK(1.672621898e-27 == Catch::Approx(constants::m_p()).margin(5.0e-37));
  CHECK(9.274009994e-24 == Catch::Approx(constants::mu_B()).margin(5.0e-32));
  CHECK(6.022140857e23 == Catch::Approx(constants::N_A()).margin(5.0e14));
  CHECK(8.3144598 == Catch::Approx(constants::R()).margin(5.0e-8));
  CHECK(1.38064852e-23 == Catch::Approx(constants::k_B()).margin(5.0e-31));
  CHECK(96485.33289 == Catch::Approx(constants::F()).margin(5.0e-5));
  CHECK(5.670367e-8 == Catch::Approx(constants::sigma()).margin(5.0e-14));
}
...
TEST_CASE_METHOD(UnitMath, "UnitMath cos", "[wpimath]") {
  ...
  CHECK(scalar_t(-0.41614683654) == Catch::Approx(cos(angle::radian_t(2))).margin(5.0e-11));
  CHECK(scalar_t(-0.70710678118) == Catch::Approx(cos(angle::degree_t(135))).margin(5.0e-11));
}
...
TEST_CASE_METHOD(UnitMath, "UnitMath sin", "[wpimath]") {
  ...
  CHECK(scalar_t(0.90929742682) == Catch::Approx(sin(angle::radian_t(2))).margin(5.0e-11));
  CHECK(scalar_t(0.70710678118) == Catch::Approx(sin(angle::degree_t(135))).margin(5.0e-11));
}
...
TEST_CASE_METHOD(UnitMath, "UnitMath tan", "[wpimath]") {
  ...
  CHECK(scalar_t(-2.18503986326) == Catch::Approx(tan(angle::radian_t(2))).margin(5.0e-11));
  CHECK(scalar_t(-1.0) == Catch::Approx(tan(angle::degree_t(135))).margin(5.0e-11));
}
...
TEST_CASE_METHOD(UnitMath, "UnitMath acos", "[wpimath]") {
  ...
  CHECK(angle::radian_t(2).value() == Catch::Approx(acos(scalar_t(-0.41614683654)).value()).margin(5.0e-11));
  CHECK(angle::degree_t(135).value() == Catch::Approx(angle::degree_t(acos(scalar_t(-0.70710678118654752440084436210485)))
          .value()).margin(5.0e-12));
}
...
TEST_CASE_METHOD(UnitMath, "UnitMath asin", "[wpimath]") {
  ...
  CHECK(angle::radian_t(1.14159265).value() == Catch::Approx(asin(scalar_t(0.90929742682)).value()).margin(5.0e-9));
  CHECK(angle::degree_t(45).value() == Catch::Approx(angle::degree_t(asin(scalar_t(0.70710678118654752440084436210485)))
          .value()).margin(5.0e-12));
}
...
TEST_CASE_METHOD(UnitMath, "UnitMath atan", "[wpimath]") {
  ...
  CHECK(angle::radian_t(-1.14159265).value() == Catch::Approx(atan(scalar_t(-2.18503986326)).value()).margin(5.0e-9));
  CHECK(angle::degree_t(-45).value() == Catch::Approx(angle::degree_t(atan(scalar_t(-1.0))).value()).margin(5.0e-12));
}
...
TEST_CASE_METHOD(UnitMath, "UnitMath atan2", "[wpimath]") {
  ...
  CHECK(angle::radian_t(constants::detail::PI_VAL / 4).value() == Catch::Approx(atan2(scalar_t(2), scalar_t(2)).value()).margin(5.0e-12));
  CHECK(angle::degree_t(45).value() == Catch::Approx(angle::degree_t(atan2(scalar_t(2), scalar_t(2))).value()).margin(5.0e-12));

  CHECK((std::is_same_v<typename std::decay_t<angle::radian_t>,
                            typename std::decay_t<decltype(atan2(
                                scalar_t(1), scalar_t(1)))>>));
  CHECK(angle::radian_t(constants::detail::PI_VAL / 6).value() == Catch::Approx(atan2(scalar_t(1), scalar_t(std::sqrt(3))).value()).margin(5.0e-12));
  CHECK(angle::degree_t(30).value() == Catch::Approx(angle::degree_t(atan2(scalar_t(1), scalar_t(std::sqrt(3))))
                  .value()).margin(5.0e-12));
}
...
TEST_CASE_METHOD(UnitMath, "UnitMath cosh", "[wpimath]") {
  ...
  CHECK(scalar_t(3.76219569108) == Catch::Approx(cosh(angle::radian_t(2))).margin(5.0e-11));
  CHECK(scalar_t(5.32275215) == Catch::Approx(cosh(angle::degree_t(135))).margin(5.0e-9));
}
...
TEST_CASE_METHOD(UnitMath, "UnitMath sinh", "[wpimath]") {
  ...
  CHECK(scalar_t(3.62686040785) == Catch::Approx(sinh(angle::radian_t(2))).margin(5.0e-11));
  CHECK(scalar_t(5.22797192) == Catch::Approx(sinh(angle::degree_t(135))).margin(5.0e-9));
}
...
TEST_CASE_METHOD(UnitMath, "UnitMath tanh", "[wpimath]") {
  ...
  CHECK(scalar_t(0.96402758007) == Catch::Approx(tanh(angle::radian_t(2))).margin(5.0e-11));
  CHECK(scalar_t(0.98219338) == Catch::Approx(tanh(angle::degree_t(135))).margin(5.0e-11));
}
...
TEST_CASE_METHOD(UnitMath, "UnitMath acosh", "[wpimath]") {
  CHECK((std::is_same_v<typename std::decay_t<angle::radian_t>,
                            typename std::decay_t<decltype(
                                acosh(scalar_t(0)))>>));
  CHECK(angle::radian_t(1.316957896924817).value() == Catch::Approx(acosh(scalar_t(2.0)).value()).margin(5.0e-11));
  CHECK(angle::degree_t(75.456129290216893).value() == Catch::Approx(angle::degree_t(acosh(scalar_t(2.0))).value()).margin(5.0e-12));
}
...
TEST_CASE_METHOD(UnitMath, "UnitMath asinh", "[wpimath]") {
  CHECK((std::is_same_v<typename std::decay_t<angle::radian_t>,
                            typename std::decay_t<decltype(
                                asinh(scalar_t(0)))>>));
  CHECK(angle::radian_t(1.443635475178810).value() == Catch::Approx(asinh(scalar_t(2)).value()).margin(5.0e-9));
  CHECK(angle::degree_t(82.714219883108939).value() == Catch::Approx(angle::degree_t(asinh(scalar_t(2))).value()).margin(5.0e-12));
}
...
TEST_CASE_METHOD(UnitMath, "UnitMath atanh", "[wpimath]") {
  CHECK((std::is_same_v<typename std::decay_t<angle::radian_t>,
                            typename std::decay_t<decltype(
                                atanh(scalar_t(0)))>>));
  CHECK(angle::radian_t(0.549306144334055).value() == Catch::Approx(atanh(scalar_t(0.5)).value()).margin(5.0e-9));
  CHECK(angle::degree_t(31.472923730945389).value() == Catch::Approx(angle::degree_t(atanh(scalar_t(0.5))).value()).margin(5.0e-12));
}
...
TEST_CASE_METHOD(UnitMath, "UnitMath sqrt", "[wpimath]") {
  CHECK((std::is_same_v<typename std::decay_t<meter_t>,
                            typename std::decay_t<decltype(sqrt(
                                square_meter_t(4.0)))>>));
  CHECK(meter_t(2.0).value() == Catch::Approx(sqrt(square_meter_t(4.0)).value()).margin(5.0e-9));

  CHECK((std::is_same_v<typename std::decay_t<angle::radian_t>,
                            typename std::decay_t<decltype(
                                sqrt(steradian_t(16.0)))>>));
  CHECK(angle::radian_t(4.0).value() == Catch::Approx(sqrt(steradian_t(16.0)).value()).margin(5.0e-9));
  ...
  CHECK(foot_t(3.16227766017).value() == Catch::Approx(sqrt(square_foot_t(10.0)).value()).margin(5.0e-9));
  CHECK(foot_t(3.16227766017).value() == Catch::Approx(resultFt.value()).margin(5.0e-9));
...
TEST_CASE_METHOD(UnitMath, "UnitMath hypot", "[wpimath]") {
  ...
  CHECK(meter_t(5.0).value() == Catch::Approx((hypot(meter_t(3.0), meter_t(4.0))).value()).margin(5.0e-9));

  CHECK((std::is_same_v<typename std::decay_t<foot_t>,
                            typename std::decay_t<decltype(hypot(
                                foot_t(3.0), meter_t(1.2192)))>>));
  CHECK(foot_t(5.0).value() == Catch::Approx((hypot(foot_t(3.0), meter_t(1.2192))).value()).margin(5.0e-9));
}
...
TEST_CASE_METHOD(UnitMath, "UnitMath fdim", "[wpimath]") {
  ...
  CHECK(meter_t(9.3904).value() == Catch::Approx(fdim(meter_t(10.0), foot_t(2.0)).value()).margin(5.0e-320));  // not sure why they aren't comparing exactly equal,
...
TEST_CASE_METHOD(CompileTimeArithmetic, "CompileTimeArithmetic unit value add", "[wpimath]") {
  ...
  CHECK(5.92125984 == Catch::Approx(sumf::value().value()).margin(5.0e-8));
  ...
  CHECK(2.11111111111 == Catch::Approx(sumc::value().value()).margin(5.0e-8));
  ...
  CHECK(1.05235988 == Catch::Approx(sumr::value().value()).margin(5.0e-8));
...
TEST_CASE_METHOD(CompileTimeArithmetic, "CompileTimeArithmetic unit value subtract", "[wpimath]") {
  ...
  CHECK(-3.92125984 == Catch::Approx(difff::value().value()).margin(5.0e-8));
  ...
  CHECK(-0.11111111111 == Catch::Approx(diffc::value().value()).margin(5.0e-8));
  CHECK((traits::is_unit_value_t_category_v<category::temperature_unit,
                                                diffc>));
  ...
  CHECK(0.947640122 == Catch::Approx(diffr::value().value()).margin(5.0e-8));
...
TEST_CASE_METHOD(CompileTimeArithmetic, "CompileTimeArithmetic unit value multiply", "[wpimath]") {
  ...
  CHECK(4.0 == Catch::Approx(productM::value().value()).margin(5.0e-7));
  ...
  CHECK(43.0556444224 == Catch::Approx(productF::value().value()).margin(5.0e-6));
  ...
  CHECK(43.0556444224 == Catch::Approx(productF2::value().value()).margin(5.0e-8));
  CHECK((
  ...
  CHECK((std::is_convertible_v<
               typename std::decay_t<torque::newton_meter_t>,
               typename std::decay_t<decltype(productN::value())>>));
  CHECK(32.8084 == Catch::Approx(productN::value().value()).margin(5.0e-8));
  CHECK(10.0 == Catch::Approx((productN::value().convert<newton_meter>().value())).margin(5.0e-7));
  ...
  CHECK(2.42 == Catch::Approx(productR::value().value()).margin(5.0e-8));
  CHECK(7944.39137 == Catch::Approx((productR::value().convert<degrees_squared>().value())).margin(5.0e-6));
...
TEST_CASE_METHOD(CompileTimeArithmetic, "CompileTimeArithmetic unit value divide", "[wpimath]") {
  ...
  CHECK((std::is_same_v<
               ...
               typename std::decay_t<decltype(productM::value())>>));
  CHECK(1 == Catch::Approx(productM::value().value()).margin(5.0e-7));
  ...
  CHECK((std::is_same_v<
               typename std::decay_t<scalar_t>,
               typename std::decay_t<decltype(productF::value())>>));
  CHECK(1.0 == Catch::Approx(productF::value().value()).margin(5.0e-6));
  CHECK((traits::is_unit_value_t_category_v<category::scalar_unit,
                                                productF>));
  ...
  CHECK((std::is_same_v<
          typename std::decay_t<scalar_t>,
          typename std::decay_t<decltype(productF2::value())>>));
  CHECK(1.0 == Catch::Approx(productF2::value().value()).margin(5.0e-8));
  CHECK((traits::is_unit_value_t_category_v<category::scalar_unit,
                                                productF2>));
  ...
  CHECK(0.2 == Catch::Approx(productMS::value().value()).margin(5.0e-8));
  ...
  CHECK(2 == Catch::Approx(productRS::value().value()).margin(5.0e-8));
  CHECK(114.592 == Catch::Approx((productRS::value().convert<degrees_per_second>().value())).margin(5.0e-4));
...
TEST_CASE_METHOD(CompileTimeArithmetic, "CompileTimeArithmetic unit value power", "[wpimath]") {
  ...
  CHECK(4 == Catch::Approx(sq::value().value()).margin(5.0e-8));
  ...
  CHECK(3.24 == Catch::Approx(sqr::value().value()).margin(5.0e-8));
  CHECK(10636.292574038049895092690529904 == Catch::Approx((sqr::value().convert<degrees_squared>().value())).margin(5.0e-10));
  CHECK((traits::is_unit_value_t_category_v<category::solid_angle_unit,
                                                sqr>));
}
...
TEST_CASE_METHOD(CompileTimeArithmetic, "CompileTimeArithmetic unit value sqrt", "[wpimath]") {
  ...
  CHECK(3.16227766017 == Catch::Approx(root::value().value()).margin(5.0e-9));
  ...
  CHECK(2.69920623253 == Catch::Approx(rooth::value().value()).margin(5.0e-8));
  CHECK(269.920623 == Catch::Approx(rooth::value().convert<meters>().value()).margin(5.0e-6));
  ...
  CHECK(1.3416407865 == Catch::Approx(rootr::value().value()).margin(5.0e-8));
  CHECK(76.870352574 == Catch::Approx(rootr::value().convert<angle::degrees>().value()).margin(5.0e-6));
...
TEST_CASE_METHOD(CaseStudies, "CaseStudies radarRangeEquation", "[wpimath]") {
  ...
  CHECK(1.535 == Catch::Approx(SNR()).margin(5.0e-4));
}
