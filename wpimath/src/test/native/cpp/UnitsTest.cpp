...
#ifdef UNIT_LIB_ENABLE_IOSTREAM
template <typename F>
std::string StreamOutput(F&& func) {
...
TEST_CASE_METHOD(TypeTraits, "TypeTraits ratio_sqrt", "[wpimath]") {
...
TEST_CASE_METHOD(TypeTraits, "TypeTraits is_unit_v", "[wpimath]") {
...
TEST_CASE_METHOD(TypeTraits, "TypeTraits is_unit_t", "[wpimath]") {
...
TEST_CASE_METHOD(TypeTraits, "TypeTraits unit_traits", "[wpimath]") {
...
TEST_CASE_METHOD(TypeTraits, "TypeTraits unit_t_traits", "[wpimath]") {
  CHECK((std::is_same_v<void,
...
TEST_CASE_METHOD(TypeTraits, "TypeTraits all_true", "[wpimath]") {
...
TEST_CASE_METHOD(TypeTraits, "TypeTraits is_convertible_unit", "[wpimath]") {
...
TEST_CASE_METHOD(TypeTraits, "TypeTraits base_unit_of", "[wpimath]") {
...
TEST_CASE_METHOD(TypeTraits, "TypeTraits has_linear_scale", "[wpimath]") {
...
TEST_CASE_METHOD(TypeTraits, "TypeTraits has_decibel_scale", "[wpimath]") {
...
TEST_CASE_METHOD(TypeTraits, "TypeTraits is_same_scale", "[wpimath]") {
...
TEST_CASE_METHOD(TypeTraits, "TypeTraits is_dimensionless_unit", "[wpimath]") {
...
TEST_CASE_METHOD(TypeTraits, "TypeTraits is_length_unit", "[wpimath]") {
...
TEST_CASE_METHOD(TypeTraits, "TypeTraits is_mass_unit", "[wpimath]") {
...
TEST_CASE_METHOD(TypeTraits, "TypeTraits is_time_unit", "[wpimath]") {
...
TEST_CASE_METHOD(TypeTraits, "TypeTraits is_angle_unit", "[wpimath]") {
...
TEST_CASE_METHOD(TypeTraits, "TypeTraits is_current_unit", "[wpimath]") {
...
TEST_CASE_METHOD(TypeTraits, "TypeTraits is_temperature_unit", "[wpimath]") {
...
TEST_CASE_METHOD(TypeTraits, "TypeTraits is_substance_unit", "[wpimath]") {
...
TEST_CASE_METHOD(TypeTraits, "TypeTraits is_luminous_intensity_unit", "[wpimath]") {
...
TEST_CASE_METHOD(TypeTraits, "TypeTraits is_solid_angle_unit", "[wpimath]") {
...
TEST_CASE_METHOD(TypeTraits, "TypeTraits is_frequency_unit", "[wpimath]") {
...
TEST_CASE_METHOD(TypeTraits, "TypeTraits is_velocity_unit", "[wpimath]") {
...
TEST_CASE_METHOD(TypeTraits, "TypeTraits is_acceleration_unit", "[wpimath]") {
...
TEST_CASE_METHOD(TypeTraits, "TypeTraits is_force_unit", "[wpimath]") {
...
TEST_CASE_METHOD(TypeTraits, "TypeTraits is_pressure_unit", "[wpimath]") {
...
TEST_CASE_METHOD(TypeTraits, "TypeTraits is_charge_unit", "[wpimath]") {
...
TEST_CASE_METHOD(TypeTraits, "TypeTraits is_energy_unit", "[wpimath]") {
...
TEST_CASE_METHOD(TypeTraits, "TypeTraits is_power_unit", "[wpimath]") {
...
TEST_CASE_METHOD(TypeTraits, "TypeTraits is_voltage_unit", "[wpimath]") {
...
TEST_CASE_METHOD(TypeTraits, "TypeTraits is_capacitance_unit", "[wpimath]") {
...
TEST_CASE_METHOD(TypeTraits, "TypeTraits is_impedance_unit", "[wpimath]") {
...
TEST_CASE_METHOD(TypeTraits, "TypeTraits is_conductance_unit", "[wpimath]") {
...
TEST_CASE_METHOD(TypeTraits, "TypeTraits is_magnetic_flux_unit", "[wpimath]") {
...
TEST_CASE_METHOD(TypeTraits, "TypeTraits is_magnetic_field_strength_unit", "[wpimath]") {
...
TEST_CASE_METHOD(TypeTraits, "TypeTraits is_inductance_unit", "[wpimath]") {
...
TEST_CASE_METHOD(TypeTraits, "TypeTraits is_luminous_flux_unit", "[wpimath]") {
...
TEST_CASE_METHOD(TypeTraits, "TypeTraits is_illuminance_unit", "[wpimath]") {
...
TEST_CASE_METHOD(TypeTraits, "TypeTraits is_radioactivity_unit", "[wpimath]") {
...
TEST_CASE_METHOD(TypeTraits, "TypeTraits is_torque_unit", "[wpimath]") {
...
TEST_CASE_METHOD(TypeTraits, "TypeTraits is_area_unit", "[wpimath]") {
...
TEST_CASE_METHOD(TypeTraits, "TypeTraits is_volume_unit", "[wpimath]") {
...
TEST_CASE_METHOD(TypeTraits, "TypeTraits is_density_unit", "[wpimath]") {
...
TEST_CASE_METHOD(TypeTraits, "TypeTraits is_data_unit", "[wpimath]") {
...
TEST_CASE_METHOD(TypeTraits, "TypeTraits is_data_transfer_rate_unit", "[wpimath]") {
  ...
  CHECK((traits::is_data_transfer_rate_unit_v<
...
TEST_CASE_METHOD(UnitManipulators, "UnitManipulators square_root", "[wpimath]") {
  double test;
...
TEST_CASE_METHOD(UnitManipulators, "UnitManipulators compound_unit", "[wpimath]") {
...
TEST_CASE_METHOD(UnitContainer, "UnitContainer has_value_member", "[wpimath]") {
  CHECK((traits::has_value_member_v<linear_scale<double>, double>));
  CHECK_FALSE((traits::has_value_member_v<meter, double>));
}

TEST_CASE_METHOD(UnitContainer, "UnitContainer make_unit", "[wpimath]") {
...
TEST_CASE_METHOD(UnitContainer, "UnitContainer cout", "[wpimath]") {
  std::string output =
      StreamOutput([](auto& os) { os << degree_t(349.87); });
  CHECK(std::strcmp("349.87 deg", output.c_str()) == 0);

  output = StreamOutput([](auto& os) { os << meter_t(1.0); });
  CHECK(std::strcmp("1 m", output.c_str()) == 0);

  output = StreamOutput([](auto& os) { os << dB_t(31.0); });
  CHECK(std::strcmp("31 dB", output.c_str()) == 0);

  output = StreamOutput([](auto& os) { os << volt_t(21.79); });
  CHECK(std::strcmp("21.79 V", output.c_str()) == 0);

  output = StreamOutput([](auto& os) { os << dBW_t(12.0); });
  CHECK(std::strcmp("12 dBW", output.c_str()) == 0);

  output = StreamOutput([](auto& os) { os << dBm_t(120.0); });
  CHECK(std::strcmp("120 dBm", output.c_str()) == 0);

  output = StreamOutput([](auto& os) { os << miles_per_hour_t(72.1); });
  CHECK(std::strcmp("72.1 mph", output.c_str()) == 0);

  // undefined unit
  output = StreamOutput(
      [](auto& os) { os << wpi::units::math::cpow<4>(meter_t(2)); });
  CHECK(std::strcmp("16 m^4", output.c_str()) == 0);

  output = StreamOutput(
      [](auto& os) { os << wpi::units::math::cpow<3>(foot_t(2)); });
  CHECK(std::strcmp("8 cu_ft", output.c_str()) == 0);

  output = StreamOutput([](auto& os) {
    os << std::setprecision(9) << wpi::units::math::cpow<4>(foot_t(2));
  });
  CHECK(std::strcmp("0.138095597 m^4", output.c_str()) == 0);

  // constants
  output = StreamOutput(
      [](auto& os) { os << std::setprecision(8) << constants::k_B; });
#if defined(_MSC_VER) && (_MSC_VER <= 1800)
  CHECK(std::strcmp("1.3806485e-023 m^2 kg s^-2 K^-1", output.c_str()) == 0);
#else
  CHECK(std::strcmp("1.3806485e-23 m^2 kg s^-2 K^-1", output.c_str()) == 0);
#endif

  output = StreamOutput(
      [](auto& os) { os << std::setprecision(9) << constants::mu_B; });
#if defined(_MSC_VER) && (_MSC_VER <= 1800)
  CHECK(std::strcmp("9.27400999e-024 m^2 A", output.c_str()) == 0);
#else
  CHECK(std::strcmp("9.27400999e-24 m^2 A", output.c_str()) == 0);
#endif

  output = StreamOutput(
      [](auto& os) { os << std::setprecision(7) << constants::sigma; });
#if defined(_MSC_VER) && (_MSC_VER <= 1800)
  CHECK(std::strcmp("5.670367e-008 kg s^-3 K^-4", output.c_str()) == 0);
#else
  CHECK(std::strcmp("5.670367e-08 kg s^-3 K^-4", output.c_str()) == 0);
#endif
}
#endif

#if __has_include(<format>) && !defined(UNIT_LIB_DISABLE_FMT)
TEST_CASE_METHOD(UnitContainer, "UnitContainer format", "[wpimath]") {
  std::string output = std::format("{}", degree_t(349.87));
  CHECK(std::strcmp("349.87 deg", output.c_str()) == 0);

  output = std::format("{}", meter_t(1.0));
  CHECK(std::strcmp("1 m", output.c_str()) == 0);

  output = std::format("{}", dB_t(31.0));
  CHECK(std::strcmp("31 dB", output.c_str()) == 0);

  output = std::format("{}", volt_t(21.79));
  CHECK(std::strcmp("21.79 V", output.c_str()) == 0);

  output = std::format("{}", dBW_t(12.0));
  CHECK(std::strcmp("12 dBW", output.c_str()) == 0);

  output = std::format("{}", dBm_t(120.0));
  CHECK(std::strcmp("120 dBm", output.c_str()) == 0);

  output = std::format("{}", miles_per_hour_t(72.1));
  CHECK(std::strcmp("72.1 mph", output.c_str()) == 0);

  // undefined unit
  output = std::format("{}", wpi::units::math::cpow<4>(meter_t(2)));
  CHECK(std::strcmp("16 m^4", output.c_str()) == 0);

  output = std::format("{}", wpi::units::math::cpow<3>(foot_t(2)));
  CHECK(std::strcmp("8 cu_ft", output.c_str()) == 0);

  output = std::format("{:.9}", wpi::units::math::cpow<4>(foot_t(2)));
  CHECK(std::strcmp("0.138095597 m^4", output.c_str()) == 0);

  // constants
  output = std::format("{:.8}", constants::k_B);
#if defined(_MSC_VER) && (_MSC_VER <= 1800)
  CHECK(std::strcmp("1.3806485e-023 m^2 kg s^-2 K^-1", output.c_str()) == 0);
#else
  CHECK(std::strcmp("1.3806485e-23 m^2 kg s^-2 K^-1", output.c_str()) == 0);
  ...
  output = std::format("{:.9}", constants::mu_B);
#if defined(_MSC_VER) && (_MSC_VER <= 1800)
  CHECK(std::strcmp("9.27400999e-024 m^2 A", output.c_str()) == 0);
#else
  CHECK(std::strcmp("9.27400999e-24 m^2 A", output.c_str()) == 0);
  ...
  output = std::format("{:.7}", constants::sigma);
#if defined(_MSC_VER) && (_MSC_VER <= 1800)
  CHECK(std::strcmp("5.670367e-008 kg s^-3 K^-4", output.c_str()) == 0);
#else
  CHECK(std::strcmp("5.670367e-08 kg s^-3 K^-4", output.c_str()) == 0);
...
TEST_CASE_METHOD(UnitContainer, "UnitContainer to_string", "[wpimath]") {
  foot_t a(3.5);
  CHECK(std::strcmp("3.5 ft", wpi::units::length::to_string(a).c_str()) == 0);

  meter_t b(8);
  CHECK(std::strcmp("8 m", wpi::units::length::to_string(b).c_str()) == 0);
}

TEST_CASE_METHOD(UnitContainer, "UnitContainer DISABLED_to_string_locale", "[wpimath][.]") {
  struct lconv* lc;
...
#else
  CHECK(std::strcmp("de_DE.utf8", setlocale(LC_ALL, "de_DE.utf8")) == 0);
#endif
  ...
  kilometer_t de = 2_km;
  CHECK(std::strcmp("2 km", wpi::units::length::to_string(de).c_str()) == 0);

  de = 2.5_km;
  CHECK(std::strcmp("2,5 km", wpi::units::length::to_string(de).c_str()) == 0);

  // US locale
#if defined(_MSC_VER)
  setlocale(LC_ALL, "en-US");
#else
  CHECK(std::strcmp("en_US.utf8", setlocale(LC_ALL, "en_US.utf8")) == 0);
#endif
  ...
  mile_t us = 2_mi;
  CHECK(std::strcmp("2 mi", wpi::units::length::to_string(us).c_str()) == 0);

  us = 2.5_mi;
  CHECK(std::strcmp("2.5 mi", wpi::units::length::to_string(us).c_str()) == 0);
}

TEST_CASE_METHOD(UnitContainer, "UnitContainer nameAndAbbreviation", "[wpimath]") {
  foot_t a(3.5);
  CHECK(std::strcmp("ft", wpi::units::abbreviation(a)) == 0);
  CHECK(std::strcmp("ft", a.abbreviation()) == 0);
  CHECK(std::strcmp("foot", a.name()) == 0);

  meter_t b(8);
  CHECK(std::strcmp("m", wpi::units::abbreviation(b)) == 0);
  CHECK(std::strcmp("m", b.abbreviation()) == 0);
  CHECK(std::strcmp("meter", b.name()) == 0);
}
...
TEST_CASE_METHOD(UnitContainer, "UnitContainer unit_cast", "[wpimath]") {
  meter_t test1(5.7);
  hectare_t test2(16);
...
TEST_CASE_METHOD(UnitConversion, "UnitConversion luminous_intensity", "[wpimath]") {
  double test;
...
TEST_CASE_METHOD(UnitConversion, "UnitConversion solid_angle", "[wpimath]") {
  double test;
  bool same;
...
TEST_CASE_METHOD(UnitConversion, "UnitConversion angular_velocity", "[wpimath]") {
  double test;
  bool same;
...
TEST_CASE_METHOD(UnitConversion, "UnitConversion angular_jerk", "[wpimath]") {
  double test;
  bool same;
...
TEST_CASE_METHOD(UnitConversion, "UnitConversion magnetic_flux", "[wpimath]") {
  double test;
...
TEST_CASE_METHOD(UnitConversion, "UnitConversion magnetic_field_strength", "[wpimath]") {
  double test;
...
TEST_CASE_METHOD(UnitConversion, "UnitConversion luminous_flux", "[wpimath]") {
  double test;
...
TEST_CASE_METHOD(UnitConversion, "UnitConversion data_transfer_rate", "[wpimath]") {
...
TEST_CASE_METHOD(UnitConversion, "UnitConversion std_chrono", "[wpimath]") {
...
TEST_CASE_METHOD(CompileTimeArithmetic, "CompileTimeArithmetic unit_value_t", "[wpimath]") {
  using mRatio = unit_value_t<meters, 3, 2>;
  CHECK(meter_t(1.5) == mRatio::value());
}

TEST_CASE_METHOD(CompileTimeArithmetic, "CompileTimeArithmetic is_unit_value_t", "[wpimath]") {
  using mRatio = unit_value_t<meters, 3, 2>;
...
TEST_CASE_METHOD(CompileTimeArithmetic, "CompileTimeArithmetic is_unit_value_t_category", "[wpimath]") {
...
TEST_CASE_METHOD(CompileTimeArithmetic, "CompileTimeArithmetic unit_value_add", "[wpimath]") {
  using mRatio = unit_value_t<meters, 3, 2>;
...
TEST_CASE_METHOD(CompileTimeArithmetic, "CompileTimeArithmetic unit_value_subtract", "[wpimath]") {
  using mRatio = unit_value_t<meters, 3, 2>;
...
TEST_CASE_METHOD(CompileTimeArithmetic, "CompileTimeArithmetic unit_value_multiply", "[wpimath]") {
...
TEST_CASE_METHOD(CompileTimeArithmetic, "CompileTimeArithmetic unit_value_divide", "[wpimath]") {
  using mRatio = unit_value_t<meters, 2>;
  using ftRatio = unit_value_t<feet, 656168, 100000>;  // 2 meter
...
TEST_CASE_METHOD(CompileTimeArithmetic, "CompileTimeArithmetic unit_value_power", "[wpimath]") {
  using mRatio = unit_value_t<meters, 2>;
...
TEST_CASE_METHOD(CompileTimeArithmetic, "CompileTimeArithmetic unit_value_sqrt", "[wpimath]") {
