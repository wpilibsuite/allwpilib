...
TEST_CASE_METHOD(MecanumDriveOdometry3dTest,
  ...
  CHECK(pose.X().value() == Catch::Approx(1).margin(1e-9));
  CHECK(pose.Y().value() == Catch::Approx(2).margin(1e-9));
  CHECK(pose.Z().value() == Catch::Approx(0).margin(1e-9));
  CHECK(pose.Rotation().ToRotation2d().Degrees().value() ==
        Catch::Approx(45).margin(1e-9));
}
...
TEST_CASE_METHOD(MecanumDriveOdometry3dTest,
  ...
  CHECK(secondPose.Z().value() == Catch::Approx(0.0).margin(0.01));
  CHECK(secondPose.Rotation().ToRotation2d().Radians().value() ==
...
TEST_CASE_METHOD(MecanumDriveOdometry3dTest,
  ...
  CHECK(pose.Z().value() == Catch::Approx(0.0).margin(0.01));
  CHECK(pose.Rotation().ToRotation2d().Radians().value() ==
        Catch::Approx(0.0).margin(0.01));
}
...
TEST_CASE_METHOD(MecanumDriveOdometry3dTest,
  ...
  CHECK(pose.Z().value() == Catch::Approx(0).margin(0.01));
  CHECK(pose.Rotation().ToRotation2d().Degrees().value() ==
        Catch::Approx(90.0).margin(0.01));
}
...
TEST_CASE_METHOD(MecanumDriveOdometry3dTest,
  ...
  CHECK(pose.X().value() == Catch::Approx(0.0).margin(1e-9));
  CHECK(pose.Y().value() == Catch::Approx(0.0).margin(1e-9));
  CHECK(pose.Z().value() == Catch::Approx(0.0).margin(1e-9));
