...
#include "wpi/math/kinematics/TripleFollowerWheelOdometry3d.hpp"
...
void ConstructInvalidTripleFollowerWheelOdometry3d() {
  wpi::math::TripleFollowerWheelOdometry3d{
      0_m, 0_m, 1_m, wpi::math::Rotation3d{},
      wpi::math::TripleFollowerWheelPositions{}, wpi::math::Pose3d{}};
}

}  // namespace

class TripleFollowerWheelOdometry3dTest : public ::testing::Test {
 protected:
...
TEST_F(TripleFollowerWheelOdometry3dTest, ThrowOnInvalidXWheelSetup) {
  EXPECT_THROW(ConstructInvalidTripleFollowerWheelOdometry3d(),
               std::domain_error);
}
...
TEST_F(TripleFollowerWheelOdometry3dTest, GyroAngleReset) {
...
TEST_F(TripleFollowerWheelOdometry3dTest, StraightForwardsForwardKinematics) {
...
TEST_F(TripleFollowerWheelOdometry3dTest, StraightLeftForwardKinematics) {
...
TEST_F(TripleFollowerWheelOdometry3dTest, SpinInPlaceForwardKinematics) {
...
TEST_F(TripleFollowerWheelOdometry3dTest, MixedMotionForwardKinematics) {
