...
TEST(SwerveModuleAccelerationsTest, ParameterizedConstructor) {
  SwerveModuleAccelerations moduleAccelerations{2.5_mps_sq, Rotation2d{1.5_rad}};
...
TEST(SwerveModuleAccelerationsTest, Equals) {
  SwerveModuleAccelerations moduleAccelerations1{2.0_mps_sq, Rotation2d{1.5_rad}};
  SwerveModuleAccelerations moduleAccelerations2{2.0_mps_sq, Rotation2d{1.5_rad}};
