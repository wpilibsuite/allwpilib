...
TEST(MathUtilTest, ApplyDeadband2dArbitraryScale) {
  ...
  EXPECT_EQ(
      ...
      frc::ApplyDeadband2d(frc::Translation2d(2.5_m, cwPiOver2), 0.02, 2.5));
  EXPECT_EQ(
      frc::Translation2d(2.5_m, ccwPiOver2),
      frc::ApplyDeadband2d(frc::Translation2d(2.5_m, ccwPiOver2), 0.02, 2.5));
  EXPECT_EQ(frc::Translation2d(2.5_m, pi),
            frc::ApplyDeadband2d(frc::Translation2d(2.5_m, pi), 0.02, 2.5));

  // == 0
  EXPECT_EQ(zeroVec, frc::ApplyDeadband2d(zeroVec, 0.02, 2.5));

  // > 0
  EXPECT_EQ(zeroVec,
            frc::ApplyDeadband2d(frc::Translation2d(0.01_m, zero), 0.02, 2.5));
  EXPECT_EQ(zeroVec,
            frc::ApplyDeadband2d(frc::Translation2d(0.02_m, zero), 0.02, 2.5));
  EXPECT_EQ(frc::Translation2d(2.5_m, zero),
            frc::ApplyDeadband2d(frc::Translation2d(2.5_m, zero), 0.02, 2.5));
}

TEST(MathUtilTest, ApplyDeadband2dLargeMaxMagnitude) {
  const frc::Rotation2d zero = frc::Rotation2d(0_deg);

  EXPECT_EQ(frc::Translation2d(90_m, zero),
            frc::ApplyDeadband2d(frc::Translation2d(100_m, zero), 20.0,
...
TEST(MathUtilTest, CopySignPow2d) {
  ...
  EXPECT_EQ(frc::Translation2d(0.5_m, zero),
            frc::CopySignPow2d(frc::Translation2d(0.5_m, zero), 1.0));
  ...
  EXPECT_EQ(frc::Translation2d(units::meter_t{std::sqrt(0.5)}, zero),
            frc::CopySignPow2d(frc::Translation2d(0.5_m, zero), 0.5));
  EXPECT_EQ(frc::Translation2d(units::meter_t{std::sqrt(0.5)}, pi),
            frc::CopySignPow2d(frc::Translation2d(0.5_m, pi), 0.5));

  EXPECT_EQ(frc::Translation2d(),
            frc::CopySignPow2d(frc::Translation2d(), 2.0));
  EXPECT_EQ(frc::Translation2d(1_m, zero),
            frc::CopySignPow2d(frc::Translation2d(1_m, zero), 2.0));
  EXPECT_EQ(frc::Translation2d(1_m, pi),
            frc::CopySignPow2d(frc::Translation2d(1_m, pi), 2.0));
...
TEST(MathUtilTest, CopySignPow2dMaxDistance) {
  ...
  EXPECT_EQ(frc::Translation2d(5_m, zero),
            frc::CopySignPow2d(frc::Translation2d(5_m, zero), 1.0, 10.0));
  EXPECT_EQ(frc::Translation2d(5_m, pi),
            frc::CopySignPow2d(frc::Translation2d(5_m, pi), 1.0, 10.0));

  EXPECT_EQ(frc::Translation2d((0.5 * 0.5 * 10.0) _m, zero),
            frc::CopySignPow2d(frc::Translation2d(5_m, zero), 2.0, 10.0));
  EXPECT_EQ(frc::Translation2d((0.5 * 0.5 * 10.0) _m, pi),
            frc::CopySignPow2d(frc::Translation2d(5_m, pi), 2.0, 10.0));

  EXPECT_EQ(frc::Translation2d(units::meter_t{std::sqrt(0.5) * 10.0}, zero),
            frc::CopySignPow2d(frc::Translation2d(5_m, zero), 0.5, 10.0));
  EXPECT_EQ(frc::Translation2d(units::meter_t{std::sqrt(0.5) * 10.0}, pi),
            frc::CopySignPow2d(frc::Translation2d(5_m, pi), 0.5, 10.0));

  EXPECT_EQ(frc::Translation2d(),
            frc::CopySignPow2d(frc::Translation2d(), 2.0, 5.0));
  EXPECT_EQ(frc::Translation2d(5_m, zero),
            frc::CopySignPow2d(frc::Translation2d(5_m, zero), 2.0, 5.0));
  EXPECT_EQ(frc::Translation2d(5_m, pi),
            frc::CopySignPow2d(frc::Translation2d(5_m, pi), 2.0, 5.0));

  EXPECT_EQ(frc::Translation2d(units::meter_t{std::pow(0.8, 0.3) * 100.0},
                               frc::Rotation2d(-90_deg)),
            frc::CopySignPow2d(frc::Translation2d(
                80_m, frc::Rotation2d(-90_deg), 0.3, 100.0)));
  EXPECT_EQ(frc::Translation2d(units::meter_t{std::pow(0.8, 0.3) * 100.0},
                               frc::Rotation2d(90_deg)),
            frc::CopySignPow2d(
                frc::Translation2d(80_m, frc::Rotation2d(90_deg), 0.3, 100.0)));
}
