...
TEST(MathUtilTest, Translation2dSlewRateLimit) {
  ...
  const frc::Translation2d expected2{units::meter_t{1.0 + 0.5 * std::numbers::inv_sqrt2}, units::meter_t{1.0 + 0.5 * std::numbers::inv_sqrt2}, units::meter_t{1.0 + 0.5 * std::numbers::inv_sqrt2}};
