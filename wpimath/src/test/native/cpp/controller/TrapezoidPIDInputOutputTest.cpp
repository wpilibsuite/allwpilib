...
TEST(TrapezoidPIDInputOutputTest, ContinuousInput1) {
  frc::TrapezoidPIDController<units::degree> controller{
...
TEST(TrapezoidPIDInputOutputTest, ContinuousInput2) {
  frc::TrapezoidPIDController<units::degree> controller{
      0.0, 0.0, 0.0, {360_deg_per_s, 180_deg_per_s_sq}};
...
TEST(TrapezoidPIDInputOutputTest, ContinuousInput3) {
  frc::TrapezoidPIDController<units::degree> controller{
      0.0, 0.0, 0.0, {360_deg_per_s, 180_deg_per_s_sq}};
...
TEST(TrapezoidPIDInputOutputTest, ContinuousInput4) {
  frc::TrapezoidPIDController<units::degree> controller{
      0.0, 0.0, 0.0, {360_deg_per_s, 180_deg_per_s_sq}};
...
TEST(TrapezoidPIDInputOutputTest, ProportionalGainOutput) {
  frc::TrapezoidPIDController<units::degree> controller{
      0.0, 0.0, 0.0, {360_deg_per_s, 180_deg_per_s_sq}};
...
TEST(TrapezoidPIDInputOutputTest, IntegralGainOutput) {
  frc::TrapezoidPIDController<units::degree> controller{
      0.0, 0.0, 0.0, {360_deg_per_s, 180_deg_per_s_sq}};
...
TEST(TrapezoidPIDInputOutputTest, DerivativeGainOutput) {
  frc::TrapezoidPIDController<units::degree> controller{
      0.0, 0.0, 0.0, {360_deg_per_s, 180_deg_per_s_sq}};
