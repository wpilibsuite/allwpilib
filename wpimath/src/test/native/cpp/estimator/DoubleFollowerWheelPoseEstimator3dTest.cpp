...
TEST(DoubleFollowerWheelPoseEstimator3dTest,
  ...
  wpi::math::DoubleFollowerWheelPoseEstimator3d estimator{
      1_m,
      1_m,
      wpi::math::Rotation3d{},
      wpi::math::DoubleFollowerWheelPositions{},
...
TEST(DoubleFollowerWheelPoseEstimator3dTest, DiscardsStaleVisionMeasurements) {
  wpi::math::DoubleFollowerWheelPoseEstimator3d estimator{
      1_m,
      1_m,
      wpi::math::Rotation3d{},
...
TEST(DoubleFollowerWheelPoseEstimator3dTest, SampleAt) {
  wpi::math::DoubleFollowerWheelPoseEstimator3d estimator{
      1_m,
      1_m,
      wpi::math::Rotation3d{},
...
TEST(DoubleFollowerWheelPoseEstimator3dTest, Reset) {
  wpi::math::DoubleFollowerWheelPoseEstimator3d estimator{
      1_m,
      1_m,
      wpi::math::Rotation3d{},
  ...
  // Test reset position
  estimator.ResetPosition(wpi::math::Rotation3d{},
                          wpi::math::DoubleFollowerWheelPositions{1_m, 0_m},
                          wpi::math::Pose3d{1_m, 0_m, 0_m,
                                            wpi::math::Rotation3d{}});
  ...
  estimator.Update(wpi::math::Rotation3d{},
                   wpi::math::DoubleFollowerWheelPositions{2_m, 0_m});
  ...
  // Test orientation
  estimator.Update(wpi::math::Rotation3d{},
                   wpi::math::DoubleFollowerWheelPositions{3_m, 0_m});
