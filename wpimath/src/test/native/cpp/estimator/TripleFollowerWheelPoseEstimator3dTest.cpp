...
#include "wpi/math/estimator/TripleFollowerWheelPoseEstimator3d.hpp"
...
TEST(TripleFollowerWheelPoseEstimator3dTest,
  ...
  wpi::math::TripleFollowerWheelPoseEstimator3d estimator{
      1_m,
      -1_m,
      1_m,
      wpi::math::Rotation3d{},
...
TEST(TripleFollowerWheelPoseEstimator3dTest, DiscardsStaleVisionMeasurements) {
  wpi::math::TripleFollowerWheelPoseEstimator3d estimator{
      1_m,
      -1_m,
      1_m,
...
TEST(TripleFollowerWheelPoseEstimator3dTest, SampleAt) {
  wpi::math::TripleFollowerWheelPoseEstimator3d estimator{
      1_m,
      -1_m,
      1_m,
...
TEST(TripleFollowerWheelPoseEstimator3dTest, Reset) {
  wpi::math::TripleFollowerWheelPoseEstimator3d estimator{
      1_m,
      -1_m,
      1_m,
  ...
  estimator.ResetPosition(
      wpi::math::Rotation3d{},
      wpi::math::TripleFollowerWheelPositions{1_m, 1_m, 0_m},
      wpi::math::Pose3d{1_m, 0_m, 0_m, wpi::math::Rotation3d{}});
  ...
  estimator.Update(wpi::math::Rotation3d{},
                   wpi::math::TripleFollowerWheelPositions{2_m, 2_m, 0_m});
  ...
  // Test orientation
  estimator.Update(wpi::math::Rotation3d{},
                   wpi::math::TripleFollowerWheelPositions{3_m, 3_m, 0_m});
