...
#include "wpi/math/estimator/TripleFollowerWheelPoseEstimator.hpp"
...
TEST(TripleFollowerWheelPoseEstimatorTest, SimultaneousVisionMeasurements) {
  ...
  wpi::math::TripleFollowerWheelPoseEstimator estimator{
      1_m,
      -1_m,
      1_m,
      wpi::math::Rotation2d{},
...
TEST(TripleFollowerWheelPoseEstimatorTest, DiscardsStaleVisionMeasurements) {
  wpi::math::TripleFollowerWheelPoseEstimator estimator{
      1_m,
      -1_m,
      1_m,
...
TEST(TripleFollowerWheelPoseEstimatorTest, SampleAt) {
  wpi::math::TripleFollowerWheelPoseEstimator estimator{
      1_m,
      -1_m,
      1_m,
...
TEST(TripleFollowerWheelPoseEstimatorTest, Reset) {
  wpi::math::TripleFollowerWheelPoseEstimator estimator{
      1_m,
      -1_m,
      1_m,
