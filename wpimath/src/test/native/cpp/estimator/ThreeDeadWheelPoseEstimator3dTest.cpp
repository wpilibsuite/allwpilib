...
TEST(ThreeDeadWheelPoseEstimator3dTest, SimultaneousVisionMeasurements) {
  ...
  wpi::math::ThreeDeadWheelPoseEstimator3d estimator{
      1_m,
      -1_m,
      1_m,
      wpi::math::Rotation3d{},
...
TEST(ThreeDeadWheelPoseEstimator3dTest, DiscardsStaleVisionMeasurements) {
  wpi::math::ThreeDeadWheelPoseEstimator3d estimator{
      1_m,
      -1_m,
      1_m,
...
TEST(ThreeDeadWheelPoseEstimator3dTest, SampleAt) {
  wpi::math::ThreeDeadWheelPoseEstimator3d estimator{
      1_m,
      -1_m,
      1_m,
...
TEST(ThreeDeadWheelPoseEstimator3dTest, Reset) {
  wpi::math::ThreeDeadWheelPoseEstimator3d estimator{
      1_m,
      -1_m,
      1_m,
