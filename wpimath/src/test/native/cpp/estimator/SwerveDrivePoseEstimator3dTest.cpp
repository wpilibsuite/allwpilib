...
#include "wpimath/estimator/SwerveDrivePoseEstimator3d.h"
...
void testFollowTrajectory(
    ...
    wpimath::SwerveDrivePoseEstimator3d<4>& estimator,
  ...
  estimator.ResetPosition(wpimath::Rotation3d{}, positions,
...
TEST(SwerveDrivePoseEstimator3dTest, AccuracyFacingTrajectory) {
  ...
  wpimath::SwerveDrivePoseEstimator3d<4> estimator{
      kinematics,        wpimath::Rotation3d{}, {fl, fr, bl, br},
      wpimath::Pose3d{}, {0.1, 0.1, 0.1, 0.1},  {0.45, 0.45, 0.45, 0.45}};
...
TEST(SwerveDrivePoseEstimator3dTest, BadInitialPose) {
  ...
  wpimath::SwerveDrivePoseEstimator3d<4> estimator{
      kinematics,        wpimath::Rotation3d{}, {fl, fr, bl, br},
      wpimath::Pose3d{}, {0.1, 0.1, 0.1, 0.1},  {0.9, 0.9, 0.9, 0.9}};
...
TEST(SwerveDrivePoseEstimator3dTest, SimultaneousVisionMeasurements) {
  ...
  estimator.UpdateWithTime(0_s, wpimath::Rotation3d{}, {fl, fr, bl, br});
...
TEST(SwerveDrivePoseEstimator3dTest, TestDiscardStaleVisionMeasurements) {
  ...
  for (auto time = 0_s; time < 4_s; time += 20_ms) {
    estimator.UpdateWithTime(time, wpimath::Rotation3d{}, {fl, fr, bl, br});
  }
...
TEST(SwerveDrivePoseEstimator3dTest, TestSampleAt) {
  wpimath::SwerveDriveKinematics<4> kinematics{
      wpimath::Translation2d{1_m, 1_m}, wpimath::Translation2d{1_m, -1_m},
      wpimath::Translation2d{-1_m, -1_m}, wpimath::Translation2d{-1_m, 1_m}};
  wpimath::SwerveDrivePoseEstimator3d estimator{
      kinematics,
      wpimath::Rotation3d{},
...
TEST(SwerveDrivePoseEstimator3dTest, TestReset) {
  ...
  // Test orientation and wheel positions
  {
    ...
    estimator.Update(wpimath::Rotation3d{}, {modulePosition, modulePosition,
