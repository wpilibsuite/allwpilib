...
void testFollowTrajectory(
    ...
    wpimath::MecanumDrivePoseEstimator3d& estimator,
  ...
  estimator.ResetPosition(wpimath::Rotation3d{}, wheelPositions,
...
TEST(MecanumDrivePoseEstimator3dTest, AccuracyFacingTrajectory) {
  ...
  wpimath::MecanumDrivePoseEstimator3d estimator{
      kinematics,        wpimath::Rotation3d{}, wheelPositions,
...
TEST(MecanumDrivePoseEstimator3dTest, BadInitialPose) {
  ...
  wpimath::MecanumDrivePoseEstimator3d estimator{
      kinematics,        wpimath::Rotation3d{}, wheelPositions,
      wpimath::Pose3d{}, {0.1, 0.1, 0.1, 0.1},  {0.45, 0.45, 0.45, 0.1}};
...
TEST(MecanumDrivePoseEstimator3dTest, SimultaneousVisionMeasurements) {
  ...
  estimator.UpdateWithTime(0_s, wpimath::Rotation3d{}, wheelPositions);
...
TEST(MecanumDrivePoseEstimator3dTest, TestDiscardStaleVisionMeasurements) {
  ...
  for (auto time = 0_s; time < 4_s; time += 20_ms) {
    estimator.UpdateWithTime(time, wpimath::Rotation3d{},
                             wpimath::MecanumDriveWheelPositions{});
  }
...
TEST(MecanumDrivePoseEstimator3dTest, TestReset) {
  ...
  estimator.ResetPosition(
      wpimath::Rotation3d{}, {1_m, 1_m, 1_m, 1_m},
  ...
  estimator.Update(wpimath::Rotation3d{}, {2_m, 2_m, 2_m, 2_m});
  ...
  // Test orientation
  estimator.Update(wpimath::Rotation3d{}, {3_m, 3_m, 3_m, 3_m});
