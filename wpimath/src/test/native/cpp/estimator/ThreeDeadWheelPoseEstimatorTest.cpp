...
#include "wpi/math/estimator/ThreeDeadWheelPoseEstimator.hpp"
...
TEST(ThreeDeadWheelPoseEstimatorTest, SimultaneousVisionMeasurements) {
  ...
  wpi::math::ThreeDeadWheelPoseEstimator estimator{
      1_m,
      -1_m,
      1_m,
      wpi::math::Rotation2d{},
...
TEST(ThreeDeadWheelPoseEstimatorTest, DiscardsStaleVisionMeasurements) {
  wpi::math::ThreeDeadWheelPoseEstimator estimator{
      1_m,
      -1_m,
      1_m,
...
TEST(ThreeDeadWheelPoseEstimatorTest, SampleAt) {
  wpi::math::ThreeDeadWheelPoseEstimator estimator{
      1_m,
      -1_m,
      1_m,
...
TEST(ThreeDeadWheelPoseEstimatorTest, Reset) {
  wpi::math::ThreeDeadWheelPoseEstimator estimator{
      1_m,
      -1_m,
      1_m,
  ...
  estimator.ResetPosition(
      wpi::math::Rotation2d{},
      wpi::math::ThreeDeadWheelPositions{1_m, 1_m, 0_m},
  ...
  estimator.Update(wpi::math::Rotation2d{},
                   wpi::math::ThreeDeadWheelPositions{2_m, 2_m, 0_m});
  ...
  // Test orientation
  estimator.Update(wpi::math::Rotation2d{},
                   wpi::math::ThreeDeadWheelPositions{3_m, 3_m, 0_m});
