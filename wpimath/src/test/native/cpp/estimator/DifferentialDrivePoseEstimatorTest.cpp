...
#include "wpimath/estimator/DifferentialDrivePoseEstimator.h"
...
void testFollowTrajectory(
    ...
    wpimath::DifferentialDrivePoseEstimator& estimator,
  ...
  estimator.ResetPosition(wpimath::Rotation2d{}, leftDistance, rightDistance,
                          startingPose);
...
TEST(DifferentialDrivePoseEstimatorTest, Accuracy) {
  ...
  wpimath::DifferentialDrivePoseEstimator estimator{
      kinematics,         wpimath::Rotation2d{}, 0_m, 0_m, wpimath::Pose2d{},
...
TEST(DifferentialDrivePoseEstimatorTest, SimultaneousVisionMeasurements) {
  ...
  wpimath::DifferentialDrivePoseEstimator estimator{
      ...
      0_m,
      0_m,
      wpimath::Pose2d{1_m, 2_m, wpimath::Rotation2d{270_deg}},
      {0.02, 0.02, 0.01},
      {0.1, 0.1, 0.1}};

  estimator.UpdateWithTime(0_s, wpimath::Rotation2d{}, 0_m, 0_m);
...
TEST(DifferentialDrivePoseEstimatorTest, TestDiscardStaleVisionMeasurements) {
  ...
  for (auto time = 0_s; time < 4_s; time += 20_ms) {
    estimator.UpdateWithTime(time, wpimath::Rotation2d{}, 0_m, 0_m);
  }
...
TEST(DifferentialDrivePoseEstimatorTest, TestReset) {
  ...
  // Test reset position
  estimator.ResetPosition(wpimath::Rotation2d{}, 1_m, 1_m,
  ...
  estimator.Update(wpimath::Rotation2d{}, 2_m, 2_m);
  ...
  // Test orientation
  estimator.Update(wpimath::Rotation2d{}, 3_m, 3_m);
