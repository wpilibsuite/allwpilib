...
#include "wpi/math/estimator/DoubleFollowerWheelPoseEstimator.hpp"
...
TEST(DoubleFollowerWheelPoseEstimatorTest, SimultaneousVisionMeasurements) {
  ...
  wpi::math::DoubleFollowerWheelPoseEstimator estimator{
      1_m,
      1_m,
      wpi::math::Rotation2d{},
...
TEST(DoubleFollowerWheelPoseEstimatorTest, DiscardsStaleVisionMeasurements) {
  wpi::math::DoubleFollowerWheelPoseEstimator estimator{
      1_m,
      1_m,
      wpi::math::Rotation2d{},
...
TEST(DoubleFollowerWheelPoseEstimatorTest, SampleAt) {
  wpi::math::DoubleFollowerWheelPoseEstimator estimator{
      1_m,
      1_m,
      wpi::math::Rotation2d{},
...
TEST(DoubleFollowerWheelPoseEstimatorTest, Reset) {
  wpi::math::DoubleFollowerWheelPoseEstimator estimator{
      1_m,
      1_m,
      wpi::math::Rotation2d{},
