...
TEST(Ellipse2dTest, FocalPoints) {
  constexpr wpimath::Pose2d center{1_m, 2_m, 0_deg};
  constexpr wpimath::Ellipse2d ellipse{center, 5_m, 4_m};

  const auto [a, b] = ellipse.FocalPoints();

  EXPECT_EQ(wpimath::Translation2d(-2_m, 2_m), a);
  EXPECT_EQ(wpimath::Translation2d(4_m, 2_m), b);
}

TEST(Ellipse2dTest, Intersects) {
  constexpr wpimath::Pose2d center{1_m, 2_m, 0_deg};
  constexpr wpimath::Ellipse2d ellipse{center, 2_m, 1_m};

  constexpr wpimath::Translation2d pointA{1_m, 3_m};
  constexpr wpimath::Translation2d pointB{0_m, 3_m};
...
TEST(Ellipse2dTest, Contains) {
  constexpr wpimath::Pose2d center{-1_m, -2_m, 45_deg};
  constexpr wpimath::Ellipse2d ellipse{center, 2_m, 1_m};

  constexpr wpimath::Translation2d pointA{0_m, -1_m};
  constexpr wpimath::Translation2d pointB{0.5_m, -2_m};
...
TEST(Ellipse2dTest, Distance) {
  ...
  constexpr wpimath::Ellipse2d ellipse{center, 1_m, 2_m};
...
TEST(Ellipse2dTest, Equals) {
  constexpr wpimath::Pose2d center1{1_m, 2_m, 90_deg};
  constexpr wpimath::Ellipse2d ellipse1{center1, 2_m, 3_m};

  constexpr wpimath::Pose2d center2{1_m, 2_m, 90_deg};
  constexpr wpimath::Ellipse2d ellipse2{center2, 2_m, 3_m};

  constexpr wpimath::Pose2d center3{1_m, 2_m, 90_deg};
  constexpr wpimath::Ellipse2d ellipse3{center3, 3_m, 2_m};
