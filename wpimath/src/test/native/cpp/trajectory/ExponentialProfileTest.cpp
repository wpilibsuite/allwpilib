...
TEST(ExponentialProfileTest, ReachesGoal) {
  frc::ExponentialProfile<units::meter, units::volt>::Constraints constraints{
      12_V, -kV / kA, 1 / kA};
  frc::ExponentialProfile<units::meter, units::volt> profile{constraints};
  frc::SimpleMotorFeedforward<units::meter, units::volt> feedforward{
      0_V, 2.5629_V / 1_mps, 0.43277_V / 1_mps_sq, kDt};
  frc::ExponentialProfile<units::meter, units::volt>::State goal{10_m, 0_mps};
  frc::ExponentialProfile<units::meter, units::volt>::State state{0_m, 0_mps};
...
TEST(ExponentialProfileTest, Backwards) {
  ...
  frc::SimpleMotorFeedforward<units::meter, units::volt> feedforward{
      0_V, 2.5629_V / 1_mps, 0.43277_V / 1_mps_sq, kDt};
  frc::ExponentialProfile<units::meter, units::volt>::State goal{-10_m, 0_mps};
  frc::ExponentialProfile<units::meter, units::volt>::State state;
...
TEST(ExponentialProfileTest, TopSpeed) {
  ...
  frc::SimpleMotorFeedforward<units::meter, units::volt> feedforward{
      0_V, 2.5629_V / 1_mps, 0.43277_V / 1_mps_sq, kDt};
  frc::ExponentialProfile<units::meter, units::volt>::State goal{40_m, 0_mps};
  frc::ExponentialProfile<units::meter, units::volt>::State state;
...
TEST(ExponentialProfileTest, HighInitialSpeed) {
  ...
  frc::SimpleMotorFeedforward<units::meter, units::volt> feedforward{
      0_V, 2.5629_V / 1_mps, 0.43277_V / 1_mps_sq, kDt};
  frc::ExponentialProfile<units::meter, units::volt>::State goal{40_m, 0_mps};
  frc::ExponentialProfile<units::meter, units::volt>::State state{0_m, 8_mps};
...
TEST(ExponentialProfileTest, TimingToCurrent) {
  ...
  frc::SimpleMotorFeedforward<units::meter, units::volt> feedforward{
      0_V, 2.5629_V / 1_mps, 0.43277_V / 1_mps_sq, kDt};
  frc::ExponentialProfile<units::meter, units::volt>::State goal{2_m, 0_mps};
  frc::ExponentialProfile<units::meter, units::volt>::State state{0_m, 0_mps};
