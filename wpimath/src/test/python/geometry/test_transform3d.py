...
def test_to_matrix():
    before = Transform3d(x=1, y=2, z=3, rotation=Rotation3d(math.radians(10), math.radians(20), math.radians(30)))
...
def test_composition():
    ...
    initial = Pose3d(x=1, y=2, z=3, rotation=Rotation3d(z_axis, math.radians(45)))
    transform1 = Transform3d(x=5, y=0, z=0, rotation=Rotation3d(z_axis, math.radians(5)))
    transform2 = Transform3d(x=0, y=2, z=0, rotation=Rotation3d(z_axis, math.radians(5)))
