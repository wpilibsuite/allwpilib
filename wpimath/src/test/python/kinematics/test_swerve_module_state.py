...
def test_optimize():
    ...
    ref_a = SwerveModuleState(meters_per_second(-2), Rotation2d.fromDegrees(180))
    ...
    ref_b = SwerveModuleState(meters_per_second(4.7), Rotation2d.fromDegrees(41))
...
def test_no_optimize():
    ...
    ref_a = SwerveModuleState(meters_per_second(2), Rotation2d.fromDegrees(89))
    ref_a.optimize(angle_a)
    ...
    ref_b = SwerveModuleState(meters_per_second(-2), Rotation2d.fromDegrees(-2))
    ref_b.optimize(angle_b)
...
def test_cosine_scaling():
    angle_a = Rotation2d.fromDegrees(0)
    ref_a = SwerveModuleState(meters_per_second(2), Rotation2d.fromDegrees(45))
    ...
    ref_b = SwerveModuleState(meters_per_second(2), Rotation2d.fromDegrees(45))
    ...
    ref_c = SwerveModuleState(meters_per_second(2), Rotation2d.fromDegrees(45))
    ...
    ref_d = SwerveModuleState(meters_per_second(2), Rotation2d.fromDegrees(45))
    ...
    ref_e = SwerveModuleState(meters_per_second(2), Rotation2d.fromDegrees(45))
    ...
    ref_f = SwerveModuleState(meters_per_second(2), Rotation2d.fromDegrees(45))
    ...
    ref_g = SwerveModuleState(meters_per_second(-2), Rotation2d.fromDegrees(45))
    ...
    ref_h = SwerveModuleState(meters_per_second(-2), Rotation2d.fromDegrees(45))
    ...
    ref_i = SwerveModuleState(meters_per_second(-2), Rotation2d.fromDegrees(45))
    ...
    ref_j = SwerveModuleState(meters_per_second(-2), Rotation2d.fromDegrees(45))
    ...
    ref_k = SwerveModuleState(meters_per_second(-2), Rotation2d.fromDegrees(45))
    ...
    ref_l = SwerveModuleState(meters_per_second(-2), Rotation2d.fromDegrees(45))
...
def test_equality():
    state1 = SwerveModuleState(meters_per_second(2), Rotation2d.fromDegrees(90))
    state2 = SwerveModuleState(meters_per_second(2), Rotation2d.fromDegrees(90))

    assert state1 == state2


def test_inequality():
    state1 = SwerveModuleState(meters_per_second(1), Rotation2d.fromDegrees(90))
    state2 = SwerveModuleState(meters_per_second(2), Rotation2d.fromDegrees(90))
    state3 = SwerveModuleState(meters_per_second(1), Rotation2d.fromDegrees(89))
