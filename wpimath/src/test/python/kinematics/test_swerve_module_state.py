...
def test_optimize():
    ...
    ref_b = SwerveModuleState(speed=4.7, angle=Rotation2d.fromDegrees(41))
...
def test_no_optimize():
    ...
    ref_a = SwerveModuleState(speed=2, angle=Rotation2d.fromDegrees(89))
    ref_a.optimize(angle_a)
    ...
    ref_b = SwerveModuleState(speed=-2, angle=Rotation2d.fromDegrees(-2))
    ref_b.optimize(angle_b)
...
def test_cosine_scaling():
    angle_a = Rotation2d.fromDegrees(0)
    ref_a = SwerveModuleState(speed=2, angle=Rotation2d.fromDegrees(45))
    ...
    ref_b = SwerveModuleState(speed=2, angle=Rotation2d.fromDegrees(45))
    ...
    ref_c = SwerveModuleState(speed=2, angle=Rotation2d.fromDegrees(45))
    ...
    ref_d = SwerveModuleState(speed=2, angle=Rotation2d.fromDegrees(45))
    ...
    ref_e = SwerveModuleState(speed=2, angle=Rotation2d.fromDegrees(45))
    ...
    ref_f = SwerveModuleState(speed=2, angle=Rotation2d.fromDegrees(45))
    ...
    ref_g = SwerveModuleState(speed=-2, angle=Rotation2d.fromDegrees(45))
    ...
    ref_h = SwerveModuleState(speed=-2, angle=Rotation2d.fromDegrees(45))
    ...
    ref_i = SwerveModuleState(speed=-2, angle=Rotation2d.fromDegrees(45))
    ...
    ref_j = SwerveModuleState(speed=-2, angle=Rotation2d.fromDegrees(45))
    ...
    ref_k = SwerveModuleState(speed=-2, angle=Rotation2d.fromDegrees(45))
    ...
    ref_l = SwerveModuleState(speed=-2, angle=Rotation2d.fromDegrees(45))
...
def test_equality():
    state1 = SwerveModuleState(speed=2, angle=Rotation2d.fromDegrees(90))
    state2 = SwerveModuleState(speed=2, angle=Rotation2d.fromDegrees(90))

    assert state1 == state2


def test_inequality():
    state1 = SwerveModuleState(speed=1, angle=Rotation2d.fromDegrees(90))
    state2 = SwerveModuleState(speed=2, angle=Rotation2d.fromDegrees(90))
    state3 = SwerveModuleState(speed=1, angle=Rotation2d.fromDegrees(89))
