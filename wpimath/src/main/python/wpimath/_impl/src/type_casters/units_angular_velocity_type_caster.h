...
namespace pybind11 {
namespace detail {
template <> struct handle_type_name<wpi::units::radians_per_second_t> {
...
template <> struct handle_type_name<wpi::units::degrees_per_second_t> {
...
template <> struct handle_type_name<wpi::units::turns_per_second_t> {
...
template <> struct handle_type_name<wpi::units::revolutions_per_minute_t> {
...
template <> struct handle_type_name<wpi::units::milliarcseconds_per_year_t> {
