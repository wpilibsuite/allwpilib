...
public class DrivetrainSplineSample extends HolonomicSample {
  /** The curvature of the path at this sample, in rad/m. */
  public final double curvature;

  /**
   * Constructs a DrivetrainSplineSample from path-relative scalars.
   *
  ...
  public DrivetrainSplineSample(
      double time, Pose2d pose, double velocity, double acceleration, double curvature) {
    super(
        time,
        pose,
  ...
  /**
   * Constructs a DrivetrainSplineSample.
   *
   * @param time The time of the sample relative to the trajectory start, in seconds.
   * @param pose The robot pose at this sample (in the field reference frame).
  ...
  /**
   * Constructs a DrivetrainSplineSample from another HolonomicSample, assuming the other sample's
   * linear velocity is not zero. Curvature is computed as omega / forward velocity.
   *
   ...
   */
  @Override
  public DrivetrainSplineSample transform(Transform2d transform) {
   ...
   */
  @Override
  public DrivetrainSplineSample relativeTo(Pose2d other) {
    return new DrivetrainSplineSample(
        time,
  ...
  public boolean equals(Object o) {
    ...
    DrivetrainSplineSample that = (DrivetrainSplineSample) o;
    return Double.compare(curvature, that.curvature) == 0;
  }

  @Override
  public int hashCode() {
    return Objects.hash(time, pose, velocity, acceleration, curvature);
  }
}
