 ...
 */
public class ThreeDeadWheelOdometry extends Odometry<ThreeDeadWheelPositions> {
  ...
  public void resetPosition(
      Rotation2d gyroAngle, ThreeDeadWheelPositions wheelPositions, Pose2d pose) {
  ...
  @Override
  public Pose2d update(Rotation2d gyroAngle, ThreeDeadWheelPositions wheelPositions) {
