 ...
 *
 * <p>This class is meant to be an easy replacement for {@link ThreeDeadWheelOdometry}, only
 ...
 */
public class ThreeDeadWheelOdometry3d extends Odometry3d<ThreeDeadWheelPositions> {
  private final double m_x1WheelYPos;
  private final double m_x2WheelYPos;
  private final double m_yWheelXPos;

  private final ThreeDeadWheelPositions m_previousWheelPositions;

  /**
   * Constructs an TwoDeadWheelOdometry object.
   *
   ...
   */
  public ThreeDeadWheelOdometry3d(
      double x1WheelYPos,
      double x2WheelYPos,
      double yWheelXPos,
      Rotation3d gyroAngle,
      ThreeDeadWheelPositions modulePositions,
      Pose3d initialPose) {
  ...
  public void resetPosition(Rotation3d gyroAngle, double x1, double x2, double y, Pose3d pose) {
    resetPosition(gyroAngle, new ThreeDeadWheelPositions(x1, x2, y), pose);
  }

  @Override
  public void resetPosition(
      Rotation3d gyroAngle, ThreeDeadWheelPositions wheelPositions, Pose3d pose) {
  ...
  public Pose3d update(Rotation3d gyroAngle, double x1, double x2, double y) {
    return update(gyroAngle, new ThreeDeadWheelPositions(x1, x2, y));
  }

  @Override
  public Pose3d update(Rotation3d gyroAngle, ThreeDeadWheelPositions wheelPositions) {
