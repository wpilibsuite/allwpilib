 ...
 *
 * <p>This class is meant to be an easy replacement for {@link TripleFollowerWheelOdometry}, only
...
public class TripleFollowerWheelOdometry3d extends Odometry3d<TripleFollowerWheelPositions> {
  ...
  public ChassisVelocities toChassisVelocities(double vx1, double vx2, double vy) {
    ...
    return new ChassisVelocities((vx1 + vx2) / 2, vy - m_yWheelXPos * omega, omega);
  }
}
