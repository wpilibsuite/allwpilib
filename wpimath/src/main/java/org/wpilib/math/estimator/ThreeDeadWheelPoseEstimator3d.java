...
import org.wpilib.math.kinematics.ThreeDeadWheelOdometry3d;
...
/**
 * This class wraps {@link ThreeDeadWheelOdometry3d Double Follower Wheel Odometry} to fuse
 ...
 * {@link ThreeDeadWheelOdometry3d}. It is also intended to be an easy replacement for {@link
 * ThreeDeadWheelPoseEstimator}, only requiring the addition of a standard deviation for Z and
 ...
 *
 * <p>{@link ThreeDeadWheelPoseEstimator3d#update} should be called every robot loop.
 *
 * <p>{@link ThreeDeadWheelPoseEstimator3d#addVisionMeasurement} can be called as infrequently
 * as you want; if you never call it, then this class will behave mostly like regular encoder
 * odometry.
 */
public class ThreeDeadWheelPoseEstimator3d
    extends PoseEstimator3d<ThreeDeadWheelPositions> {
  /**
   ...
   */
  public ThreeDeadWheelPoseEstimator3d(
      double x1WheelYPos,
      double x2WheelYPos,
      double yWheelXPos,
