 ...
 */
public class TwoDeadWheelPoseEstimator {
  /*
   * This class uses logic cloned from PoseEstimator.java. It does not extend PoseEstimator because
   * the structure of the kinematics and odometry classes assume that the gyro angle is independent
   * from the kinematics, while in a two-dead-wheel configuration, the gyro is required to do the
