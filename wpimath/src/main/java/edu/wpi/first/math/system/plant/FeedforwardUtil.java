...
public class FeedforwardUtil {
  ...
  public static FeedforwardConstants createVelocitySystemFeedforwardConstants(
  ...
  public static FeedforwardConstants createPositionSystemFeedforwardConstants(
  ...
  public static FeedforwardConstants createElevatorFeedforwardConstants(
      LinearSystem<N2, N1, N2> plant) {
  ...
  public static FeedforwardConstants createArmFeedforwardConstants(
      LinearSystem<N2, N1, N2> plant, double armLengthMeters) {
    FeedforwardConstants constants = createPositionSystemFeedforwardConstants(plant);
    return new FeedforwardConstants(
        0.0, constants.kv(), constants.ka(), 3.0 * 9.8 * constants.ka() / 2.0 / armLengthMeters);
  }
}
