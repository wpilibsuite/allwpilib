...
import edu.wpi.first.math.geometry.serde.Twist3dProtoSerde;
import edu.wpi.first.math.geometry.serde.Twist3dStructSerde;
...
public class Twist3d {
  ...
  public static final Twist3dStructSerde struct = new Twist3dStructSerde();
  public static final Twist3dProtoSerde proto = new Twist3dProtoSerde();
}
