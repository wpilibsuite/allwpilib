 ...
 */
public record DCMotorConstants(
  ...
  public double nominalVoltageVolts() {
    return nominalVoltage().in(Volts);
  }

  /**
   * Returns the stall torque in Newton-Meters.
   *
   * @return the stall torque in Newton-Meters.
   */
  public double stallTorqueNewtonMeters() {
    return stallTorque().in(NewtonMeters);
  }

  /**
   * Returns the stall current in amps.
   *
   * @return the stall current in amps.
   */
  public double stallCurrentAmps() {
    return stallCurrent().in(Amps);
  }

  /**
   * Returns the free current in amps.
   *
   * @return the free current in amps.
   */
  public double freeCurrentAmps() {
    return freeCurrent().in(Amps);
  }

  /**
   * Returns the free speed in radians per second.
   *
   * @return the free speed in radians per second.
   */
  public double freeSpeedRadPerSec() {
    return freeSpeed().in(RadiansPerSecond);
  }

  /**
   * Returns the motor torque constant.
   *
   * @return the motor torque constant.
   */
  public Per<TorqueUnit, CurrentUnit> kt() {
    return stallTorque.divide(stallCurrent);
  }

  /**
   * Returns the motor torque constant in Newton-Meters per amp.
   *
   * @return the motor torque constant in Newton-Meters per amp.
   */
  public double ktNMPerAmp() {
    return kt().in(NewtonMeters.per(Amp));
  }

  /**
   * Returns the resistance of the motor.
   *
   * @return the resistance of the motor.
   */
  public Per<VoltageUnit, CurrentUnit> R() {
    return nominalVoltage.divide(stallCurrent);
  }

  /**
   * Returns the resistance of the motor in Ohms.
   *
   * @return the resistance of the motor in Ohms.
   */
  public double rOhms() {
    return R().in(Volts.per(Amp));
  }

  /**
   * Returns the motor velocity constant.
   *
   * <p>Not to be confused with the feedforward constants kv.
   *
   * @return the motor velocity constant.
   */
  ...
  public static final DCMotorConstants Neo550 =
      new DCMotorConstants(
   ...
   */
  public static final DCMotorConstants Falcon500 =
      new DCMotorConstants(
   ...
   * <p>https://store.ctr-electronics.com/falcon-500-powered-by-talon-fx/
   */
  public static final DCMotorConstants Falcon500FOC =
      new DCMotorConstants(
   ...
   */
  public static final DCMotorConstants RomiBuiltIn =
      new DCMotorConstants(
   ...
   */
  public static final DCMotorConstants KrakenX60 =
      new DCMotorConstants(
   ...
   * <p>https://store.ctr-electronics.com/announcing-kraken-x60/
   */
  public static final DCMotorConstants KrakenX60FOC =
      new DCMotorConstants(
   ...
   */
  public static final DCMotorConstants NeoVortex =
      new DCMotorConstants(
