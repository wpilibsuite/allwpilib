 ...
 */
public class TrapezoidPIDController implements Sendable {
  ...
  /**
   * Allocates a TrapezoidPIDController with the given constants for Kp, Ki, and Kd.
   *
  ...
  public TrapezoidPIDController(
    ...
    SendableRegistry.add(this, "TrapezoidPIDController", instances);
    MathSharedStore.reportUsage(MathUsageId.kController_TrapezoidPIDController, instances);
  }
  ...
  /**
   * Sets the goal for the TrapezoidPIDController.
   *
  ...
  /**
   * Gets the goal for the TrapezoidPIDController.
   *
   * @return The goal.
   */
  ...
  /**
   * Returns the current setpoint of the TrapezoidsPIDController.
   *
  ...
  public void initSendable(SendableBuilder builder) {
    builder.setSmartDashboardType("TrapezoidPIDController");
