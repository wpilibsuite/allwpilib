...
public final class ComputerVisionUtil {
  ...
  /**
   * Algorithm from <a
   * href="https://docs.limelightvision.io/en/latest/cs_estimating_distance.html">Limelight</a>
   ...
   * this method requires the camera to have 0 roll (not be skewed clockwise or CCW relative to the
   * floor), and for there to exist a height differential between goal and camera. The larger this
