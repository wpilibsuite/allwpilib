...
/**
 * Represents the speed of a robot chassis. Although this class contains similar
 * members compared to
 * a Twist2d, they do NOT represent the same thing. Whereas a Twist2d represents
 * a change in pose
 * w.r.t to the robot frame of reference, a ChassisSpeeds object represents a
 * robot's velocity.
 *
 * <p>
...
public class ChassisSpeeds implements ProtobufSerializable, StructSerializable {
    ...
    /**
     * Checks if the ChassisSpeeds is equivalent to the other provided
     * ChassisSpeeds.
     *
     * @param other The ChassiSpeeds object to compare to.
     */
    public Boolean equals(ChassisSpeeds other) {
        return vxMetersPerSecond == other.vxMetersPerSecond && vyMetersPerSecond == other.vyMetersPerSecond
                && omegaRadiansPerSecond == other.omegaRadiansPerSecond;
    }
