...
public class ChassisSpeeds implements ProtobufSerializable, StructSerializable {
   ...
   */
  public ChassisSpeeds(
      Measure<LinearVelocity> vx, Measure<LinearVelocity> vy, Measure<AngularVelocity> omega) {
   ...
   */
  public static ChassisSpeeds discretize(
      Measure<LinearVelocity> vx,
      Measure<LinearVelocity> vy,
      Measure<AngularVelocity> omega,
      Measure<Time> dt) {
    return discretize(
