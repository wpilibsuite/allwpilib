...
public record Gearbox(DCMotorType motorType, double reduction, int numMotors) {
   ...
   *
   * @param torqueNm The torque produced by the motor in Newton-Meters.
   * @param speedRadiansPerSec The current angular velocity of the motor in radians per second.
