...
/**
 * Class for odometry. Odometry allows you to track the robot's position on the field over the
 * course of a match using readings from encoders and a gyroscope.
 *
