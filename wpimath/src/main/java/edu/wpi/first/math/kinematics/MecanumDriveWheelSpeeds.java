...
public class MecanumDriveWheelSpeeds implements ProtobufSerializable, StructSerializable {
   ...
   */
  public MecanumDriveWheelSpeeds(
      Measure<LinearVelocity> frontLeft,
      Measure<LinearVelocity> frontRight,
      Measure<LinearVelocity> rearLeft,
      Measure<LinearVelocity> rearRight) {
    this(
   ...
   */
  public void desaturate(Measure<LinearVelocity> attainableMaxSpeed) {
