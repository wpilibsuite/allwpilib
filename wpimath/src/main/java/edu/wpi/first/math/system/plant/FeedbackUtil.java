...
public class FeedbackUtil {
  ...
  public static FeedbackContants createVelocitySystemFeedbackConstants(
    ...
    if (!Double.isFinite(feedforwardConstants.kv())
        || !Double.isFinite(feedforwardConstants.ka())) {
    ...
    LinearSystem<N1, N1, N1> plant =
        LinearSystemId.identifyVelocitySystem(feedforwardConstants.kv(), feedforwardConstants.ka());
    LinearQuadraticRegulator<N1, N1, N1> controller =
        new LinearQuadraticRegulator<>(plant, VecBuilder.fill(1.5), VecBuilder.fill(7.0), 0.020);
  ...
  public static FeedbackContants createPositionSystemFeedbackConstants(
    ...
    LinearSystem<N2, N1, N2> plant =
        LinearSystemId.identifyPositionSystem(feedforwardConstants.kv(), feedforwardConstants.ka());
    LinearQuadraticRegulator<N2, N1, N2> controller =
        new LinearQuadraticRegulator<>(
            plant, VecBuilder.fill(0.1, 1.5), VecBuilder.fill(7.0), 0.020);
