...
public class ExponentialPIDController implements Sendable {
  ...
  /**
   * Allocates a ExponentialPIDController with the given constants for Kp, Ki, and Kd.
   *
   ...
   */
  public ExponentialPIDController(
  ...
  public ExponentialPIDController(
      double Kp, double Ki, double Kd, ExponentialProfile.Constraints constraints, double period) {
    m_controller = new PIDController(Kp, Ki, Kd, period);
    m_constraints = constraints;
    m_profile = new ExponentialProfile(m_constraints);
    instances++;

    SendableRegistry.add(this, "ExponentialPIDController", instances);
    MathSharedStore.reportUsage(MathUsageId.kController_ExponentialPIDController, instances);
  }
  ...
  /**
   * Sets the goal for the ExponentialPIDController.
   *
  ...
  /**
   * Gets the goal for the ExponentialPIDController.
   *
   * @return The goal.
   */
  ...
  /**
   * Returns the current setpoint of the ExponentialPIDController.
   *
   ...
   * @return The controller's next output.
   */
  public double calculate(double measurement, ExponentialProfile.State goal) {
    setGoal(goal);
  ...
  public void initSendable(SendableBuilder builder) {
    builder.setSmartDashboardType("ExponentialPIDController");
