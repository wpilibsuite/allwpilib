...
public class Rotation2d
   ...
   * @see org.wpilib.math.MathUtil#angleModulus(double) to constrain the angle within (-π, π]
   */
  @JsonProperty
   ...
   * @see org.wpilib.math.MathUtil#inputModulus(double, double, double) to constrain the angle
   *     within (-180, 180]
   */
