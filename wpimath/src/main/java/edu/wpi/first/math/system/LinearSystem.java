...
public class LinearSystem<States extends Num, Inputs extends Num, Outputs extends Num> {
   ...
   *
   * @return the trimmed LinearSystem with outputs set to 1.
   */
  public LinearSystem<States, Inputs, N1> getTrimmedLinearSystem() {
    return new LinearSystem<>(m_A, m_B, m_C.extractRowVector(0), m_D.extractRowVector(0));
  }
