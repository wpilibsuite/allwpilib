...
#ifndef FRC_GEOMETRY_DETAIL_ROTATION_VECTOR_TO_MATRIX
#define FRC_GEOMETRY_DETAIL_ROTATION_VECTOR_TO_MATRIX
...
#endif  // FRC_GEOMETRY_DETAIL_ROTATION_VECTOR_TO_MATRIX
