...
namespace detail {
WPILIB_DLLEXPORT
int IncrementAndGetExponentialPIDControllerInstances();
}  // namespace detail
...
class ExponentialPIDController
 ...
 public:
  ...
  /**
   * Set max input, Ka, and Kv constraints for goal.
   *
   * @param constraints Max input, Ka, and Kv constraints for goal.
   */
  ...
  /**
   * Get the max input, Ka, and Kv constraints for this controller.
   * @return Max input, Ka, and Kv constraints.
   */
