...
namespace detail {
WPILIB_DLLEXPORT
int IncrementAndGetTrapezoidPIDControllerInstances();
}  // namespace detail
...
class TrapezoidPIDController
    : public wpi::Sendable,
      public wpi::SendableHelper<TrapezoidPIDController<Distance>> {
 public:
  ...
  /**
   * Allocates a TrapezoidPIDController with the given constants for Kp, Ki, and
  ...
  /**
   * Returns the current setpoint of the TrapezoidPIDController.
   *
