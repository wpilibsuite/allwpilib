...
class ProfiledPIDController
 ...
 public:
  ...
  constexpr double Calculate(Distance_t measurement) {
    if (m_controller.IsContinuousInputEnabled()) {
      ...
      auto goalMinDistance = wpimath::InputModulus<Distance_t>(
          m_goal.position - measurement, -errorBound, errorBound);
      auto setpointMinDistance = wpimath::InputModulus<Distance_t>(
  ...
  constexpr double Calculate(
      ...
      typename wpimath::TrapezoidProfile<Distance>::Constraints constraints) {
 ...
 private:
  ...
  typename wpimath::TrapezoidProfile<Distance>::Constraints m_constraints;
  TrapezoidProfile<Distance> m_profile;
  typename wpimath::TrapezoidProfile<Distance>::State m_goal;
  typename wpimath::TrapezoidProfile<Distance>::State m_setpoint;
};
