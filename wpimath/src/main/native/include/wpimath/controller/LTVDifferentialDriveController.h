 ...
 * shot.
 *
 * See section 8.7 in Controls Engineering in wpimath for a derivation of the
...
class WPILIB_DLLEXPORT LTVDifferentialDriveController {
 public:
   ...
   */
  LTVDifferentialDriveController(const wpimath::LinearSystem<2, 2, 2>& plant,
      ...
      : m_trackwidth{trackwidth},
        m_A{plant.A()},
        m_B{plant.B()},
        m_Q{wpimath::MakeCostMatrix(Qelems)},
        m_R{wpimath::MakeCostMatrix(Relems)},
        m_dt{dt} {}
