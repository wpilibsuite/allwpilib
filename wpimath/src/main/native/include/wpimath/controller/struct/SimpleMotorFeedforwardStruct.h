...
struct wpi::Struct<wpimath::SimpleMotorFeedforward<Distance>> {
  ...
  static wpimath::SimpleMotorFeedforward<Distance> Unpack(
...
static_assert(
    wpi::StructSerializable<wpimath::SimpleMotorFeedforward<units::meters>>);
static_assert(
    wpi::StructSerializable<wpimath::SimpleMotorFeedforward<units::feet>>);
static_assert(
    wpi::StructSerializable<wpimath::SimpleMotorFeedforward<units::radians>>);
