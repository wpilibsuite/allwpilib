...
template <>
struct WPILIB_DLLEXPORT wpi::Struct<wpimath::Pose2d> {
  ...
  static wpimath::Pose2d Unpack(std::span<const uint8_t> data);
  static void Pack(std::span<uint8_t> data, const wpimath::Pose2d& value);
...
static_assert(wpi::StructSerializable<wpimath::Pose2d>);
static_assert(wpi::HasNestedStruct<wpimath::Pose2d>);
