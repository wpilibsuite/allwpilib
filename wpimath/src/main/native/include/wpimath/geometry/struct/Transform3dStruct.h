...
template <>
struct WPILIB_DLLEXPORT wpi::Struct<wpimath::Transform3d> {
  ...
  static wpimath::Transform3d Unpack(std::span<const uint8_t> data);
  static void Pack(std::span<uint8_t> data, const wpimath::Transform3d& value);
...
static_assert(wpi::StructSerializable<wpimath::Transform3d>);
static_assert(wpi::HasNestedStruct<wpimath::Transform3d>);
