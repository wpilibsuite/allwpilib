 ...
 *   this would be wpimath::Transform3d{3_in, 0_in, 0_in,
 * wpimath::Rotation3d{}}.
 * @return The robot's field-relative pose.
 */
WPILIB_DLLEXPORT
constexpr wpimath::Pose3d ObjectToRobotPose(
    const wpimath::Pose3d& objectInField,
    const wpimath::Transform3d& cameraToObject,
    const wpimath::Transform3d& robotToCamera) {
