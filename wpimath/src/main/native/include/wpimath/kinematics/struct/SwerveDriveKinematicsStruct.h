...
struct wpi::Struct<wpimath::SwerveDriveKinematics<NumModules>> {
  ...
  static constexpr size_t GetSize() {
    return NumModules * wpi::Struct<wpimath::Translation2d>::GetSize();
  }
  ...
  static wpimath::SwerveDriveKinematics<NumModules> Unpack(
      std::span<const uint8_t> data) {
    constexpr size_t kModulesOff = 0;
    return wpimath::SwerveDriveKinematics<NumModules>{
        wpi::UnpackStructArray<wpimath::Translation2d, kModulesOff, NumModules>(
            data)};
  }
...
static_assert(wpi::StructSerializable<wpimath::SwerveDriveKinematics<4>>);
static_assert(wpi::HasNestedStruct<wpimath::SwerveDriveKinematics<4>>);
static_assert(wpi::StructSerializable<wpimath::SwerveDriveKinematics<3>>);
static_assert(wpi::HasNestedStruct<wpimath::SwerveDriveKinematics<3>>);
