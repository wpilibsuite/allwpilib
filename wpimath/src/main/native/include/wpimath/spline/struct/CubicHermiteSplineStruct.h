...
template <>
struct WPILIB_DLLEXPORT wpi::Struct<wpimath::CubicHermiteSpline> {
  ...
  static wpimath::CubicHermiteSpline Unpack(std::span<const uint8_t> data);
  static void Pack(std::span<uint8_t> data,
                   const wpimath::CubicHermiteSpline& value);
};

static_assert(wpi::StructSerializable<wpimath::CubicHermiteSpline>);
