...
struct wpi::Protobuf<wpimath::Matrixd<Size, 1, Options, MaxRows, MaxCols>> {
  using MessageStruct = wpi_proto_ProtobufVector;
  using InputStream = wpi::ProtoInputStream<
      wpimath::Matrixd<Size, 1, Options, MaxRows, MaxCols>>;
  using OutputStream = wpi::ProtoOutputStream<
      wpimath::Matrixd<Size, 1, Options, MaxRows, MaxCols>>;

  static std::optional<wpimath::Matrixd<Size, 1, Options, MaxRows, MaxCols>>
  Unpack(InputStream& stream) {
    ...
    wpimath::Matrixd<Size, 1, Options, MaxRows, MaxCols> mat;
