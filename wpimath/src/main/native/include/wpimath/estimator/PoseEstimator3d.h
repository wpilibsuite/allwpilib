...
#include "wpimath/interpolation/TimeInterpolatableBuffer.h"
#include "wpimath/kinematics/Kinematics.h"
#include "wpimath/kinematics/Odometry3d.h"
...
class WPILIB_DLLEXPORT PoseEstimator3d {
 public:
   ...
   *     wpimath::Timer::GetFPGATimestamp(). This means that you should use
   *     wpimath::Timer::GetFPGATimestamp() as your time source in this case.
   */
  void AddVisionMeasurement(const Pose3d& visionRobotPose,
    ...
    wpimath::Vectord<6> k_times_twist =
        m_visionK * wpimath::Vectord<6>{twist.dx.value(), twist.dy.value(),
 ...
 private:
  ...
  wpimath::Matrixd<6, 6> m_visionK = wpimath::Matrixd<6, 6>::Zero();
