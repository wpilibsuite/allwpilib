...
#include "wpimath/kinematics/Odometry.h"
...
class WPILIB_DLLEXPORT PoseEstimator {
 public:
   ...
   *     wpimath::Timer::GetTimestamp(). This means that you should use
   *     wpimath::Timer::GetTimestamp() as your time source in this case.
   */
