 ...
 * https://file.tavsys.net/control/controls-engineering-in-wpimath.pdf.
 *
 ...
 public:
  ...
  LinearSystemLoop(LinearSystem<States, Inputs, Outputs>& plant,
      ...
      : LinearSystemLoop(
            ...
            [=](const InputVector& u) {
              return wpimath::DesaturateInputVector<Inputs>(u,
                                                            maxVoltage.value());
            },
            dt) {}
  ...
  LinearSystemLoop(
      ...
      : LinearSystemLoop(controller, feedforward, observer,
                         [=](const InputVector& u) {
                           return wpimath::DesaturateInputVector<Inputs>(
                               u, maxVoltage.value());
                         }) {}
