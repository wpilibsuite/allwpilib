...
template <>
struct WPILIB_DLLEXPORT wpi::Protobuf<wpi::math::Rotation2d> {
  using MessageStruct = wpi_proto_ProtobufRotation2d;
  using InputStream = wpi::ProtoInputStream<wpi::math::Rotation2d>;
  using OutputStream = wpi::ProtoOutputStream<wpi::math::Rotation2d>;
