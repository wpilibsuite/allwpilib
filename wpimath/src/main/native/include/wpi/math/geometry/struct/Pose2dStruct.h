...
template <>
struct WPILIB_DLLEXPORT wpi::Struct<wpi::math::Pose2d> {
...
static_assert(wpi::StructSerializable<wpi::math::Pose2d>);
static_assert(wpi::HasNestedStruct<wpi::math::Pose2d>);
