...
template <>
struct WPILIB_DLLEXPORT wpi::Protobuf<wpi::math::Rectangle2d> {
  using MessageStruct = wpi_proto_ProtobufRectangle2d;
  using InputStream = wpi::ProtoInputStream<wpi::math::Rectangle2d>;
  using OutputStream = wpi::ProtoOutputStream<wpi::math::Rectangle2d>;
