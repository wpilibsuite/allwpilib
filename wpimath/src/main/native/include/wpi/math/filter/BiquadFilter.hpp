...
class BiquadFilter {
 public:
   ...
   * output='sos') to within ~1e-10 for LowPass/HighPass. BandPass/BandStop
   * outputs are numerically equivalent to scipy but may differ in section
   ...
   * cutoff). @a kind must be LowPass or HighPass.
   *
