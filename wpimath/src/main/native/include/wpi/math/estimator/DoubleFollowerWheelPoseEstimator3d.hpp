...
#include "wpi/math/kinematics/DoubleFollowerWheelOdometry3d.hpp"
 ...
 * be a drop-in replacement for DoubleFollowerWheelOdometry3d. It is also
 * intended to be an easy replacement for DoubleFollowerWheelPoseEstimator,
 ...
 * odometry.
 */
class WPILIB_DLLEXPORT DoubleFollowerWheelPoseEstimator3d
    : public PoseEstimator3d<DoubleFollowerWheelPositions> {
 public:
  /**
   * Constructs a DoubleFollowerWheelPoseEstimator3d with default standard
 ...
 private:
  DoubleFollowerWheelOdometry3d m_odometryImpl;
};
