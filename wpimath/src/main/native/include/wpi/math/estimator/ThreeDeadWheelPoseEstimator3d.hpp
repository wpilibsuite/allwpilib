 ...
 * is intended to be a drop-in replacement for ThreeDeadWheelOdometry3d.
 * It is also intended to be an easy replacement for
 * ThreeDeadWheelPoseEstimator, only requiring the addition of a standard
 ...
 * odometry.
 */
class WPILIB_DLLEXPORT ThreeDeadWheelPoseEstimator3d
    : public PoseEstimator3d<ThreeDeadWheelPositions> {
 public:
  /**
   * Constructs a ThreeDeadWheelPoseEstimator3d with default standard
  ...
  /**
   * Constructs a ThreeDeadWheelPoseEstimator3d.
   *
 ...
 private:
  ThreeDeadWheelOdometry3d m_odometryImpl;
};
