 ...
 * vision measurements with triple follower wheel encoder distance
 * measurements. It will correct for noisy measurements and encoder drift. It
 * is intended to be a drop-in replacement for TripleFollowerWheelOdometry3d.
 * It is also intended to be an easy replacement for
 * TripleFollowerWheelPoseEstimator, only requiring the addition of a standard
 ...
 * odometry.
 */
class WPILIB_DLLEXPORT TripleFollowerWheelPoseEstimator3d
    : public PoseEstimator3d<TripleFollowerWheelPositions> {
 public:
  /**
   * Constructs a TripleFollowerWheelPoseEstimator3d with default standard
  ...
  /**
   * Constructs a TripleFollowerWheelPoseEstimator3d.
   *
 ...
 private:
  TripleFollowerWheelOdometry3d m_odometryImpl;
};
