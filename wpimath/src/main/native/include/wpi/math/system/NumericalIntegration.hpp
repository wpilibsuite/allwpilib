 ...
 */
template <typename F, typename T, typename U>
T Tsit5(F&& f, T x, U u, wpi::units::second_t dt, double maxError = 1e-6) {
  ...
  //                                       2.324710524099774,
  //                                       0.0};
  constexpr std::array<double, kDim> b2{-0.00178001105222577714,
 ...
 */
template <typename F, typename T>
T Tsit5(F&& f, wpi::units::second_t t, T y, wpi::units::second_t dt,
