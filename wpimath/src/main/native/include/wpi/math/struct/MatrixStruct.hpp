...
template <int Rows, int Cols, int Options, int MaxRows, int MaxCols>
  requires(Cols != 1)
struct wpi::Struct<wpi::math::Matrixd<Rows, Cols, Options, MaxRows, MaxCols>> {
...
static_assert(wpi::StructSerializable<wpi::math::Matrixd<1, 2>>);
static_assert(wpi::StructSerializable<wpi::math::Matrixd<3, 3>>);
