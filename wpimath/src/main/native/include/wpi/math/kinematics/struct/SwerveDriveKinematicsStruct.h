...
struct wpi::Struct<wpi::math::SwerveDriveKinematics<NumModules>> {
  ...
  static constexpr size_t GetSize() {
    return NumModules * wpi::Struct<wpi::math::Translation2d>::GetSize();
  }
...
static_assert(wpi::StructSerializable<wpi::math::SwerveDriveKinematics<4>>);
static_assert(wpi::HasNestedStruct<wpi::math::SwerveDriveKinematics<4>>);
static_assert(wpi::StructSerializable<wpi::math::SwerveDriveKinematics<3>>);
static_assert(wpi::HasNestedStruct<wpi::math::SwerveDriveKinematics<3>>);
