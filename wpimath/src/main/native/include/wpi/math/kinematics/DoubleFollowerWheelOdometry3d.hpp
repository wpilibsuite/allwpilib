...
namespace wpi::math {
class WPILIB_DLLEXPORT DoubleFollowerWheelOdometry3d
    : public Odometry3d<DoubleFollowerWheelPositions> {
 public:
 ...
 private:
  ...
  DoubleFollowerWheelPositions m_previousWheelPositions;
};
}  // namespace wpi::math
