...
template <>
struct WPILIB_DLLEXPORT wpi::Struct<wpi::math::MecanumDriveKinematics> {
  static constexpr std::string_view GetTypeName() {
    return "MecanumDriveKinematics";
  }
  static constexpr size_t GetSize() {
    return 4 * wpi::GetStructSize<wpi::math::Translation2d>();
  }
...
static_assert(wpi::StructSerializable<wpi::math::MecanumDriveKinematics>);
static_assert(wpi::HasNestedStruct<wpi::math::MecanumDriveKinematics>);
