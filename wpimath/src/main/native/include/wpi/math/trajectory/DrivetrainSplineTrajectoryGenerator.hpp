...
namespace wpi::math {
/**
 * Helper class used to generate drivetrain spline trajectories with various
 * constraints.
 */
class WPILIB_DLLEXPORT DrivetrainSplineTrajectoryGenerator {
 public:
   ...
   */
  static DrivetrainSplineTrajectory Generate(
