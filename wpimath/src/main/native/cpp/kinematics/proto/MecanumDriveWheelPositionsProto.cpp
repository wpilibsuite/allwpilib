...
#include <wpi/math/kinematics/proto/MecanumDriveWheelPositionsProto.h>

#include "wpimath/protobuf/kinematics.npb.h"

std::optional<wpi::math::MecanumDriveWheelPositions> wpi::Protobuf<
...
bool wpi::Protobuf<wpi::math::MecanumDriveWheelPositions>::Pack(
