...
std::optional<frc::DifferentialDriveWheelAccelerations> wpi::Protobuf<frc::DifferentialDriveWheelAccelerations>::Unpack(
    InputStream& stream) {
...
bool wpi::Protobuf<frc::DifferentialDriveWheelAccelerations>::Pack(OutputStream& stream,
