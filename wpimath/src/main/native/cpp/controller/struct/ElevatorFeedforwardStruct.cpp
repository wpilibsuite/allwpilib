...
#include "wpimath/controller/struct/ElevatorFeedforwardStruct.h"
...
wpimath::ElevatorFeedforward StructType::Unpack(std::span<const uint8_t> data) {
  return wpimath::ElevatorFeedforward{
      ...
      units::unit_t<wpimath::ElevatorFeedforward::kv_unit>{
          wpi::UnpackStruct<double, kKvOff>(data)},
      units::unit_t<wpimath::ElevatorFeedforward::ka_unit>{
