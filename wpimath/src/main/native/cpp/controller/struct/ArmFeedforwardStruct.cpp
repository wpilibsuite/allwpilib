...
#include "wpi/math/controller/struct/ArmFeedforwardStruct.h"
...
using StructType = wpi::Struct<wpi::math::ArmFeedforward>;
...
wpi::math::ArmFeedforward StructType::Unpack(std::span<const uint8_t> data) {
  return wpi::math::ArmFeedforward{
      ...
      units::unit_t<wpi::math::ArmFeedforward::kv_unit>{
          wpi::UnpackStruct<double, kKvOff>(data)},
      units::unit_t<wpi::math::ArmFeedforward::ka_unit>{
