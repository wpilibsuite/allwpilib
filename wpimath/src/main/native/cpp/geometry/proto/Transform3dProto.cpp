...
std::optional<wpimath::Transform3d> wpi::Protobuf<wpimath::Transform3d>::Unpack(
    InputStream& stream) {
...
bool wpi::Protobuf<wpimath::Transform3d>::Pack(
    OutputStream& stream, const wpimath::Transform3d& value) {
