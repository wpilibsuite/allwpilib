...
#include "wpimath/geometry/struct/Twist2dStruct.h"
...
using StructType = wpi::Struct<wpimath::Twist2d>;

wpimath::Twist2d StructType::Unpack(std::span<const uint8_t> data) {
...
void StructType::Pack(std::span<uint8_t> data, const wpimath::Twist2d& value) {
