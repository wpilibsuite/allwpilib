...
U, A, B, t, x0, xf, v0, vf, c1, c2, v, V, kV, kA = symbols('U, A, B t, x0, xf, v0, vf, C1, C2, v, V, kV, kA')
...
equality = Eq(equality.lhs - B*U*log(A*v/(A*vf - B*U) - B*U/(A*vf - B*U))/A**2, equality.rhs - B*U*log(A*v/(A*vf - B*U) - B*U/(A*vf - B*U))/A**2)
equality = Eq(equality.lhs / (-B*U/A/A), equality.rhs / (-B*U/A/A))
equality = Eq(exp(equality.lhs.simplify()), exp(equality.rhs.simplify()))
equality = Eq(equality.lhs * (A*v0 + B*U)*(A*vf - B*U), equality.rhs * (A*v0 + B*U)*(A*vf - B*U))
