...
public abstract class CommandRobot extends OpModeRobot {
   ...
   * @return Registered command opmode descriptor.
   */
  public CommandOpMode createAutoOpMode(String name, String group) {
   ...
   * @return Registered command opmode descriptor.
   */
  public CommandOpMode createAutoOpMode(String name, String group, String description) {
   ...
   * @return Registered command opmode descriptor.
   */
  public CommandOpMode createAutoOpMode(
      String name, String group, String description, Color textColor, Color backgroundColor) {
    var opMode = new CommandOpMode(name);
    addOpModeFactory(
        opMode::bind, RobotMode.AUTONOMOUS, name, group, description, textColor, backgroundColor);
    return opMode;
  }
   ...
   * @return Registered command opmode descriptor.
   */
  public CommandOpMode createTeleopOpMode(String name, String group) {
   ...
   * @return Registered command opmode descriptor.
   */
  public CommandOpMode createTeleopOpMode(String name, String group, String description) {
   ...
   * @return Registered command opmode descriptor.
   */
  public CommandOpMode createTeleopOpMode(
      String name, String group, String description, Color textColor, Color backgroundColor) {
    var opMode = new CommandOpMode(name);
    addOpModeFactory(
        opMode::bind, RobotMode.TELEOPERATED, name, group, description, textColor, backgroundColor);
    return opMode;
  }
   ...
   * @return Registered command opmode descriptor.
   */
  public CommandOpMode createUtilityOpMode(String name, String group) {
   ...
   * @return Registered command opmode descriptor.
   */
  public CommandOpMode createUtilityOpMode(String name, String group, String description) {
   ...
   * @return Registered command opmode descriptor.
   */
  public CommandOpMode createUtilityOpMode(
      String name, String group, String description, Color textColor, Color backgroundColor) {
    var opMode = new CommandOpMode(name);
    addOpModeFactory(
        opMode::bind, RobotMode.UTILITY, name, group, description, textColor, backgroundColor);
    return opMode;
  }
}
