...
public final class ProtobufCommands {
  private static final RepeatedByte descriptorData = ProtoUtil.decodeBase64(2495,
    "CjFjb21tYW5kc3YzL3NyYy9tYWluL3Byb3RvL3Byb3RvYnVmX2NvbW1hbmRzLnByb3RvEgl3cGkucHJv" + 
    "dG8iJwoRUHJvdG9idWZNZWNoYW5pc20SEgoEbmFtZRgBIAEoCVIEbmFtZSK2AgoPUHJvdG9idWZDb21t" + 
    "YW5kEg4KAmlkGAEgASgNUgJpZBIgCglwYXJlbnRfaWQYAiABKA1IAFIIcGFyZW50SWSIAQESEgoEbmFt" + 
    "ZRgDIAEoCVIEbmFtZRIaCghwcmlvcml0eRgEIAEoBVIIcHJpb3JpdHkSQAoMcmVxdWlyZW1lbnRzGAUg" + 
    "AygLMhwud3BpLnByb3RvLlByb3RvYnVmTWVjaGFuaXNtUgxyZXF1aXJlbWVudHMSJQoMbGFzdF90aW1l" + 
    "X21zGAYgASgBSAFSCmxhc3RUaW1lTXOIAQESJwoNdG90YWxfdGltZV9tcxgHIAEoAUgCUgt0b3RhbFRp" + 
    ...
    "DQIICgwKBQQAAgABEgMNCQ0KDAoFBAACAAMSAw0QEQoKCgIEARIEEAApAQoKCgMEAQESAxAIFwpxCgQE" + 
    "AQIAEgMTAhAaZCBBIHVuaXF1ZSBJRCBmb3IgdGhlIGNvbW1hbmQuCiBEaWZmZXJlbnQgaW52b2NhdGlv" + 
    "bnMgb2YgdGhlIHNhbWUgY29tbWFuZCBvYmplY3QgaGF2ZSBkaWZmZXJlbnQgSURzLgoKDAoFBAECAAUS" + 
    ...
    "IGNvbW1hbmRzLgoKDAoFBAECAQQSAxcCCgoMCgUEAQIBBRIDFwsRCgwKBQQBAgEBEgMXEhsKDAoFBAEC" + 
    "AQMSAxceHwonCgQEAQICEgMaAhIaGiBUaGUgbmFtZSBvZiB0aGUgY29tbWFuZC4KCgwKBQQBAgIFEgMa" + 
    "AggKDAoFBAECAgESAxoJDQoMCgUEAQICAxIDGhARCjEKBAQBAgMSAx0CFRokIFRoZSBwcmlvcml0eSBs" + 
    ...
    "IGFjdGl2ZWx5IHJ1bm5pbmcgY29tbWFuZC4KCgwKBQQBAgYEEgMoAgoKDAoFBAECBgUSAygLEQoMCgUE" + 
    "AQIGARIDKBIfCgwKBQQBAgYDEgMoIiMKCgoCBAISBCsANAEKCgoDBAIBEgMrCBkKjQIKBAQCAgASAy8C" + 
    ...
    "bmcgc2NoZWR1bGVyLnJ1bigpCgoMCgUEAgIABBIDLwIKCgwKBQQCAgAGEgMvCxoKDAoFBAICAAESAy8b" + 
    "KgoMCgUEAgIAAxIDLy0uCgsKBAQCAgESAzACMAoMCgUEAgIBBBIDMAIKCgwKBQQCAgEGEgMwCxoKDAoF" + 
    "BAICAQESAzAbKwoMCgUEAgIBAxIDMC4vCk8KBAQCAgISAzMCGhpCIEhvdyBtdWNoIHRpbWUgdGhlIHNj",
    "aGVkdWxlciB0b29rIGluIGl0cyBsYXN0IGBydW4oKWAgaW52b2NhdGlvbi4KCgwKBQQCAgIFEgMzAggK" + 
    "DAoFBAICAgESAzMJFQoMCgUEAgICAxIDMxgZYgZwcm90bzM=");

  static final Descriptors.FileDescriptor descriptor = Descriptors.FileDescriptor.internalBuildGeneratedFileFrom("commandsv3/src/main/proto/protobuf_commands.proto", "wpi.proto", descriptorData);

  static final Descriptors.Descriptor wpi_proto_ProtobufMechanism_descriptor = descriptor.internalContainedType(64, 39, "ProtobufMechanism", "wpi.proto.ProtobufMechanism");

  static final Descriptors.Descriptor wpi_proto_ProtobufCommand_descriptor = descriptor.internalContainedType(106, 310, "ProtobufCommand", "wpi.proto.ProtobufCommand");

  static final Descriptors.Descriptor wpi_proto_ProtobufScheduler_descriptor = descriptor.internalContainedType(419, 193, "ProtobufScheduler", "wpi.proto.ProtobufScheduler");
