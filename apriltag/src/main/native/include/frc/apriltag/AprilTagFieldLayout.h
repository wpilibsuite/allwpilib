 ...
 * origin at the bottom-right corner of the blue alliance wall. SetOrigin(OriginPosition)
 * can be used to change the poses returned from GetTagPose(int) to be from the perspective 
