...
public class ResourceTest {
  ...
  /**
   * Checks that allocating a resource above the range of resources will cause
   * an exception
   *$
  ...
  /**
   * Checks that freeing an resource that has been allocated allows it to be
   * allocated again.
   *$
   * @throws CheckedAllocationException
   */
  ...
  /**
   * Checks that asking for the next valid allocated resource will cause it to
   * skip an already allocated resource.
   *$
   * @throws CheckedAllocationException
   */
  @Test
