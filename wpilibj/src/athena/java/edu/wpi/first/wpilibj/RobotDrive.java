...
public class RobotDrive implements MotorSafety {
   ...
   */
  public void tankDrive(GenericHID leftStick, final byte leftAxis, GenericHID rightStick,
                        final byte rightAxis) {
    if (leftStick == null || rightStick == null) {
      throw new NullPointerException("Null HID provided");
    }
   ...
   */
  public void tankDrive(GenericHID leftStick, final byte leftAxis, GenericHID rightStick,
                        final byte rightAxis, boolean squaredInputs) {
    if (leftStick == null || rightStick == null) {
      throw new NullPointerException("Null HID provided");
    }
   ...
   * @param squaredInputs Setting this parameter to true decreases the sensitivity at lower speeds
   */
  public void arcadeDrive(GenericHID moveStick, final byte moveAxis, GenericHID rotateStick,
                          final byte rotateAxis, boolean squaredInputs) {
