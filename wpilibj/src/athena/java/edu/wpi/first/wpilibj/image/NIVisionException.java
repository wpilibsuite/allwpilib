    ...
    switch (errorCode) {
      ...
      case -1074396133:
        return "Could not execute the function in the separate thread because the thread could "
            + "not initialize.";
      case -1074396132:
        return "The mask must be the same m_size as the template.";
      case -1074396130:
      ...
      case -1074396119:
        return "They custom data key you supplied is invalid. The only valid character values are"
            ...
            + "spaces.";
      case -1074396118:
        return "Step m_size must be greater than zero.";
      case -1074396117:
        return "Invalid matrix m_size in the structuring element.";
      case -1074396116:
      ...
      case -1074396088:
        return "The results of the operation exceeded the m_size limits on the output data arrays.";
      case -1074396087:
      ...
      case -1074396074:
        return "Incompatible image m_size.";
      case -1074396073:
      ...
      case -1074396061:
        return "The m_size of each dimension of the window must be greater than 2 and less than or "
            + "equal to the m_size of the image in the corresponding dimension.";
      case -1074396060:
      ...
      case -1074396048:
        return "Invalid cell sample m_size.";
      case -1074396047:
      ...
      case -1074396034:
        return "The template image does not contain enough edge information for the sample m_size"
            + "(s) requested.";
      case -1074396033:
      ...
      case -1074396021:
        return "Invalid kernel m_size for edge detection. The minimum kernel m_size is 3, the "
            + "maximum kernel m_size is 1073741823 and the kernel m_size must be odd.";
      case -1074396020:
      ...
      case -1074396003:
        return "The data for this frame exceeds the data buffer m_size specified when creating the "
            + "AVI file.";
      case -1074396002:
      ...
      case -1074395972:
        return "DirectX is unable to enumerate the compression filters. This is caused by a "
            ...
            + "try again.";
      case -1074395971:
        return "The offset you specified must be m_size 2.";
      case -1074395960:
      ...
      case -1074395954:
        return "The quantization step m_size must be greater than or equal to 0.";
      case -1074395953:
      ...
      case -1074395840:
        return "Invalid handle table m_index.";
      case -1074395837:
      ...
      case -1074395798:
        return "The m_size of the feature vector in the custom sample must match the m_size of "
            + "those you have already added.";
      case -1074395797:
      ...
      case -1074395778:
        return "The Kernel m_size must be smaller than the image m_size.";
      case -1074395777:
      ...
      case -1074395724:
        return "The m_size you specified is out of the valid range.";
      case -1074395723:
      ...
      case -1074395701:
        return "The maximum Data Matrix barcode m_size must be equal to or greater than the minimum"
            + " Data Matrix barcode m_size.";
      case -1074395700:
      ...
      case -1074395651:
        return "You must specify the same edge filter m_size for all the templates you want to "
            + "match.";
      case -1074395650:
      ...
      case -1074395617:
        return "The minimum number of features must be less than or equal to the maximum number "
            + "of features.";
      case -1074395616:
        return "Invalid edge filter m_size.";
      case -1074395615:
      ...
      case -1074395596:
        return "Invalid character m_size. Character m_size must be >= 1.";
      case -1074395595:
      ...
      case -1074395591:
        return "Invalid character m_index.";
      case -1074395590:
      ...
      case -1074395561:
        return "The number of characters in the character value must match the number of objects "
            + "in the image.";
      case -1074395560:
        return "Invalid object m_index.";
      case -1074395559:
        return "Invalid read option.";
      case -1074395558:
        return "The minimum character m_size must be less than the maximum character m_size.";
      case -1074395557:
      ...
      case -1074395330:
        return "Invalid border m_size. Acceptable values range from 0 to 50.";
      case -1074395329:
      ...
      case -1074395294:
        return "The contour m_index you supplied is larger than the number of contours in the ROI.";
      case -1074395293:
      ...
      case -1074395281:
        return "Your image must be larger than its border m_size for this operation.";
      case -1074395280:
      ...
      case -1074395256:
        return "The window m_size must be odd for the Canny operator. ";
      case -1074395253:
      ...
      case -1074395212:
        return "The m_size of the template string must match the m_size of the string you are "
            + "trying to correct.";
      case -1074395211:
      ...
      case -1074395160:
        return "NI Vision does not support the maximum point m_size you supplied.  Valid values "
            + "range from 4 to 72.";
      case -1074395159:
