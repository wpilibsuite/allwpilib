...
// THIS FILE WAS AUTO-GENERATED BY ./wpilibj/generate_pwm_motor_controlers.py. DO NOT MODIFY
...
public class Victor extends PWMMotorController {
   ...
   * Constructor.
   *
   * @param channel The PWM channel that the Victor 888 is attached to. 0-9 are on-board, 10-19 are on
   *     the MXP port
   */
