 ...
 */
public class LogitechF310Controller implements Sendable {
  ...
  public LogitechF310Controller(final int port) {
    ...
    HAL.reportUsage("HID", port, "LogitechF310Controller");
  }
  ...
  public BooleanEvent logitech(EventLoop loop) {
    return button(Button.kLogitech, loop);
  }
