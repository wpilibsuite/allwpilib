 ...
 *
 * <p>This class handles PS4 input that comes from the Driver Station. Each time a value
 * is requested the most recent value is returned.
 */
public class PS4Controller implements Sendable {
  ...
  public BooleanEvent share(EventLoop loop) {
    return button(Button.kShare, loop);
  }
