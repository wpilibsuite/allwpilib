 ...
 */
public class DualSenseEdgeController implements Sendable {
  ...
  public enum Button {
    ...
    kLeftFunction(21, "LeftFunctionButton"),
    /** Right Function button. */
    kRightFunction(22, "RightFunctionButton");
  ...
  public DualSenseEdgeController(final int port) {
    ...
    HAL.reportUsage("HID", port, "DualSenseEdgeController");
  }
  ...
  public BooleanEvent leftFunction(EventLoop loop) {
    return button(Button.kLeftFunction, loop);
  }
  ...
  public BooleanEvent rightFunction(EventLoop loop) {
    return button(Button.kRightFunction, loop);
  }
