 ...
 *
 * <p>Note that the Talon FX uses the following bounds for PWMOutput values. These values should work
...
public class PWMTalonFX extends PWMMotorController {
   ...
   * Constructor.
   *
   * @param channel The PWMOutput channel that the Talon FX is attached to. 0-9 are on-board, 10-19
   *     are on the MXP port
   */
