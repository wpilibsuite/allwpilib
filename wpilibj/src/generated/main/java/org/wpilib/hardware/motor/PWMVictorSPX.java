 ...
 *
 * <p>Note that the Victor SPX uses the following bounds for PWMOutput values. These values should work
...
public class PWMVictorSPX extends PWMMotorController {
   ...
   * Constructor.
   *
   * @param channel The PWMOutput channel that the Victor SPX is attached to. 0-9 are on-board, 10-19
   *     are on the MXP port
   */
