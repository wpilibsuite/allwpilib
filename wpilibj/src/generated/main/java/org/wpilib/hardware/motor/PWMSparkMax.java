 ...
 *
 * <p>Note that the SPARK MAX uses the following bounds for PWMOutput values. These values should work
...
public class PWMSparkMax extends PWMMotorController {
   ...
   * Constructor.
   *
   * @param channel The PWMOutput channel that the SPARK MAX is attached to. 0-9 are on-board, 10-19
   *     are on the MXP port
   */
