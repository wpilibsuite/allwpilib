 ...
 *
 * <p>Note that the Venom uses the following bounds for PWMOutput values. These values should work
...
public class PWMVenom extends PWMMotorController {
   ...
   * Constructor.
   *
   * @param channel The PWMOutput channel that the Venom is attached to. 0-9 are on-board, 10-19
   *     are on the MXP port
   */
