 ...
 *
 * <p>Note that the SPARK Flex uses the following bounds for PWMOutput values. These values should work
...
public class PWMSparkFlex extends PWMMotorController {
   ...
   * Constructor.
   *
   * @param channel The PWMOutput channel that the SPARK Flex is attached to. 0-9 are on-board, 10-19
   *     are on the MXP port
   */
