 ...
 * and every time autonomous is entered from another mode - TeleopInit()     -- called each and
 * every time teleop is entered from another mode - TestInit()       -- called each and every time
 * test mode is entered from anothermode
 *
  ...
  public void startCompetition() {
    ...
    while (true) {
      ...
      if (isDisabled()) {
        ...
        if (nextPeriodReady()) {
          // TODO: FRC_NetworkCommunicationsLibrary
