 ...
 *
 * <p>For more on filters, I highly recommend the following articles:<br>
 ...
 *
 * <p>Note 1: getOutput() should be called by the user on a known, regular period. You can set up a
 ...
 * to make sure getOutput() gets called at the desired, constant frequency!
 */
public class LinearFilter extends NodeBase {
