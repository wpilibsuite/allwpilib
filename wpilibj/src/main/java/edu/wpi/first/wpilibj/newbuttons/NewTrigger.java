 ...
 * certain sensor input). For this, they only have to write the {@link NewTrigger#get()} method to get
 * the full functionality of the Trigger class.
 */
public abstract class NewTrigger extends SendableBase {
  ...
  /**
   * An internal class of {@link NewTrigger}. The user should ignore this, it is only public to
