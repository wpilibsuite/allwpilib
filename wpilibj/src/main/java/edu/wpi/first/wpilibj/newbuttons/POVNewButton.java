...
/**
 * A {@link NewButton} that gets its state from a POV on a {@link GenericHID}.
 */
public class POVNewButton extends NewButton {
   ...
   */
  public POVNewButton(GenericHID joystick, int angle, int povNumber) {
    m_joystick = joystick;
    m_angle = angle;
   ...
   */
  public POVNewButton(GenericHID joystick, int angle) {
