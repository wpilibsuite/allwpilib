...
import org.wpilib.hal.SimEnum;
import org.wpilib.hal.SimInt;
import org.wpilib.hal.SimLong;
import org.wpilib.hal.SimValue;
import org.wpilib.hal.simulation.SimDeviceCallback;
import org.wpilib.hal.simulation.SimDeviceDataJNI;
import org.wpilib.hal.simulation.SimValueCallback;
...
public class SimDeviceSim {
  ...
  /**
   * Register a callback to be run every time a new {@link org.wpilib.hal.SimDevice} is created.
   *
   * @param prefix the prefix to filter sim devices
   * @param callback the callback
   * @param initialNotify should the callback be run with the initial state
  ...
  /**
   * Register a callback to be run every time a {@link org.wpilib.hal.SimDevice} is
   * freed/destroyed.
   *
   * @param prefix the prefix to filter sim devices
   * @param callback the callback
