...
package org.wpilib.wpilibj.drive;
...
import org.wpilib.wpilibj.motorcontrol.MotorController;
 ...
 * org.wpilib.wpilibj.motorcontrol.PWMMotorController#addFollower(PWMMotorController)}.
 *
 ...
 *
 * <p>Inputs smaller then {@value org.wpilib.wpilibj.drive.RobotDriveBase#kDefaultDeadband} will
 * be set to 0, and larger values will be scaled so that the full range is still used. This deadband
 * value can be changed with {@link #setDeadband}.
 *
 * <p>{@link org.wpilib.wpilibj.MotorSafety} is enabled by default. The tankDrive, arcadeDrive,
...
public class DifferentialDrive extends RobotDriveBase implements Sendable, AutoCloseable {
   ...
   * org.wpilib.wpilibj.motorcontrol.PWMMotorController#addFollower(PWMMotorController)}. If a
