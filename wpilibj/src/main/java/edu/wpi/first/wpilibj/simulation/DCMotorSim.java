...
public abstract class DCMotorSim extends LinearSystemSim<N2, N1, N2> {
   ...
   */
  public DCMotorSim(LinearSystem<N2, N1, N2> plant, DCMotor gearbox, double gearing, MomentOfInertia J,
