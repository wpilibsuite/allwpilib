...
/**
 * Classes in the {@code org.wpilib.vision} package are designed to simplify using OpenCV vision
 ...
 *      private {@link org.wpilib.cscore.VideoSource VideoSource} usbCamera;
 *
 *      // A vision pipeline. This could be handwritten or generated by GRIP.
 *      // This has to implement {@link org.wpilib.vision.VisionPipeline}.
 *      // For this example, assume that it's perfect and will always see the tote.
 *      private MyFindTotePipeline findTotePipeline;
 *      private {@link org.wpilib.vision.VisionThread} findToteThread;
 *
 ...
 *
 *     {@literal @}Override
 *      public void {@link org.wpilib.vision.VisionRunner.Listener#copyPipelineOutputs
