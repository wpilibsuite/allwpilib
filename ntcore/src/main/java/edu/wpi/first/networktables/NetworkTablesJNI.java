...
public final class NetworkTablesJNI {
  ...
  public static native boolean setRaw(int entry, long time, ByteBuffer value, int len, boolean
      force);

  public static native boolean setBooleanArray(int entry, long time, boolean[] value, boolean
      force);
  ...
  public static native EntryInfo[] getEntryInfo(NetworkTableInstance instObject, int inst, String
      prefix, int types);
  ...
  public static native EntryNotification[] pollEntryListener(NetworkTableInstance inst, int
      poller) throws InterruptedException;

  public static native EntryNotification[] pollEntryListenerTimeout(NetworkTableInstance inst,
                                                                    int poller, double timeout)
  ...
  public static native ConnectionNotification[] pollConnectionListener(NetworkTableInstance inst,
                                                                       int poller)
      throws InterruptedException;

  public static native ConnectionNotification[]
  ...
  public static native RpcAnswer[] pollRpcTimeout(NetworkTableInstance inst,
                                                  int poller,
  ...
  public static native void startServer(int inst,
  ...
  public static native void savePersistent(int inst, String filename)
  ...
  public static native LogMessage[] pollLoggerTimeout(NetworkTableInstance inst,
                                                      int poller,
                                                      double timeout) throws InterruptedException;
