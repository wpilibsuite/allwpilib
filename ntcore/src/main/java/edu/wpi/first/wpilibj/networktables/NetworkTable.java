...
public class NetworkTable implements ITable, IRemote {
  ...
  private final ConcurrentMap<String, NetworkTableEntry> entries =
  ...
  private static final HashMap<IRemoteConnectionListener, ConnectionListenerAdapter>
      globalConnectionListenerMap =
          new HashMap<IRemoteConnectionListener, ConnectionListenerAdapter>();
  ...
  private final HashMap<IRemoteConnectionListener, ConnectionListenerAdapter>
  ...
  private final HashMap<ITableListener, List<ListenerBase>> oldListenerMap =
      new HashMap<ITableListener, List<ListenerBase>>();
