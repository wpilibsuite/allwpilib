...
|`hidden`|boolean|Hidden Flag|If true, the topic will not be announced to a client until the client subscribes to it.  Note the topic will still be visible via the `$clientpub` meta-topic.
|===
