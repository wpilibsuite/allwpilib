...
def drivers_extension(srcs = [], header_to_dat_deps = [], extra_hdrs = [], includes = []):
    ...
    DRIVERS_HEADER_GEN = [
        struct(
            ...
            header_root = "$(execpath :robotpy-native-drivers.copy_headers)",
            header_file = "$(execpath :robotpy-native-drivers.copy_headers)/wpi/drivers/motor/Koors40.hpp",
            tmpl_class_names = [],
            trampolines = [
        ...
        struct(
            ...
            header_root = "$(execpath :robotpy-native-drivers.copy_headers)",
            header_file = "$(execpath :robotpy-native-drivers.copy_headers)/wpi/drivers/motor/PWMSparkFlex.hpp",
            tmpl_class_names = [],
            trampolines = [
        ...
        struct(
            ...
            header_root = "$(execpath :robotpy-native-drivers.copy_headers)",
            header_file = "$(execpath :robotpy-native-drivers.copy_headers)/wpi/drivers/motor/PWMSparkMax.hpp",
            tmpl_class_names = [],
            trampolines = [
        ...
        struct(
            ...
            header_root = "$(execpath :robotpy-native-drivers.copy_headers)",
            header_file = "$(execpath :robotpy-native-drivers.copy_headers)/wpi/drivers/motor/PWMTalonFX.hpp",
            tmpl_class_names = [],
            trampolines = [
        ...
        struct(
            ...
            header_root = "$(execpath :robotpy-native-drivers.copy_headers)",
            header_file = "$(execpath :robotpy-native-drivers.copy_headers)/wpi/drivers/motor/PWMTalonSRX.hpp",
            tmpl_class_names = [],
            trampolines = [
        ...
        struct(
            ...
            header_root = "$(execpath :robotpy-native-drivers.copy_headers)",
            header_file = "$(execpath :robotpy-native-drivers.copy_headers)/wpi/drivers/motor/PWMVenom.hpp",
            tmpl_class_names = [],
            trampolines = [
        ...
        struct(
            ...
            header_root = "$(execpath :robotpy-native-drivers.copy_headers)",
            header_file = "$(execpath :robotpy-native-drivers.copy_headers)/wpi/drivers/motor/PWMVictorSPX.hpp",
            tmpl_class_names = [],
            trampolines = [
        ...
        struct(
            ...
            header_root = "$(execpath :robotpy-native-drivers.copy_headers)",
            header_file = "$(execpath :robotpy-native-drivers.copy_headers)/wpi/drivers/motor/Spark.hpp",
            tmpl_class_names = [],
            trampolines = [
        ...
        struct(
            ...
            header_root = "$(execpath :robotpy-native-drivers.copy_headers)",
            header_file = "$(execpath :robotpy-native-drivers.copy_headers)/wpi/drivers/motor/SparkMini.hpp",
            tmpl_class_names = [],
            trampolines = [
        ...
        struct(
            ...
            header_root = "$(execpath :robotpy-native-drivers.copy_headers)",
            header_file = "$(execpath :robotpy-native-drivers.copy_headers)/wpi/drivers/motor/Talon.hpp",
            tmpl_class_names = [],
            trampolines = [
        ...
        struct(
            ...
            header_root = "$(execpath :robotpy-native-drivers.copy_headers)",
            header_file = "$(execpath :robotpy-native-drivers.copy_headers)/wpi/drivers/motor/VictorSP.hpp",
            tmpl_class_names = [],
            trampolines = [
    ...
    gen_libinit(
        ...
        modules = ["native.drivers._init_robotpy_native_drivers", "wpilib._init__wpilib"],
    )
    ...
    run_header_gen(
        ...
        local_native_libraries = [
            ...
            "//drivers:robotpy-native-drivers.copy_headers",
...
def define_pybind_library(name, pkgcfgs = []):
    ...
    robotpy_library(
        ...
        deps = [
            "//drivers:robotpy-native-drivers",
        ...
        requires = ["robotpy-native-drivers==0.0.0", "wpilib==0.0.0"],
