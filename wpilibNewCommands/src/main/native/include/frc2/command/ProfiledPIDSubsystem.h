...
class [[deprecated(
    "Use a ProfiledPIDController inside a Subsystem "
    "instead.")]] ProfiledPIDSubsystem : public SubsystemBase {
 ...
 public:
   ...
   * @deprecated use a ProfiledPIDController inside a Subsystem instead
   */
