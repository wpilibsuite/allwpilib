...
class ProfiledPIDSubsystem : public SubsystemBase {
 ...
 public:
   ...
   */
  explicit ProfiledPIDSubsystem(ProfiledPIDController<Distance> controller,
   ...
   */
  ProfiledPIDController<Distance>& GetController() { return m_controller; }

 protected:
  ProfiledPIDController<Distance> m_controller;
