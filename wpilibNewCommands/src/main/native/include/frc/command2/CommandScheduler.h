...
class CommandScheduler final : public wpi::Sendable,
 ...
 public:
   ...
   *
   * @return a reference to the current {@link EventLoop} object polling
   * buttons.
   */
  EventLoop* GetActiveButtonLoop() const;
   ...
   *
   * @return a reference to the default {@link EventLoop} object polling
   * buttons.
   */
  EventLoop* GetDefaultButtonLoop() const;
