...
class MecanumControllerCommand
 ...
 public:
  ...
  MecanumControllerCommand(
      ...
      SimpleMotorFeedforward<units::meters> feedforward,
      MecanumDriveKinematics kinematics, PIDController xController,
      PIDController yController,
      ProfiledPIDController<units::radians> thetaController,
      std::function<Rotation2d()> desiredRotation,
      units::meters_per_second_t maxWheelVelocity,
      std::function<MecanumDriveWheelSpeeds()> currentWheelSpeeds,
      PIDController frontLeftController, PIDController rearLeftController,
      PIDController frontRightController, PIDController rearRightController,
 ...
 private:
  ...
  std::function<Pose2d()> m_pose;
  SimpleMotorFeedforward<units::meters> m_feedforward;
  MecanumDriveKinematics m_kinematics;
  HolonomicDriveController m_controller;
  std::function<Rotation2d()> m_desiredRotation;
  const units::meters_per_second_t m_maxWheelVelocity;
  std::unique_ptr<PIDController> m_frontLeftController;
  std::unique_ptr<PIDController> m_rearLeftController;
  std::unique_ptr<PIDController> m_frontRightController;
  std::unique_ptr<PIDController> m_rearRightController;
  std::function<MecanumDriveWheelSpeeds()> m_currentWheelSpeeds;
  std::function<void(units::meters_per_second_t, units::meters_per_second_t,
  ...
  bool m_usePID;
  Timer m_timer;
  MecanumDriveWheelSpeeds m_prevSpeeds;
