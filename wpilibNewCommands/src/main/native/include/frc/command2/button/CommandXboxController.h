 ...
 * @see XboxController
 */
class CommandXboxController : public XboxController {
 public:
   ...
   */
  Trigger LeftBumper(EventLoop* loop = CommandScheduler::GetInstance()
                                           .GetDefaultButtonLoop()) const;
   ...
   * attached to the given loop.
   */
  Trigger RightBumper(EventLoop* loop = CommandScheduler::GetInstance()
                                            .GetDefaultButtonLoop()) const;
   ...
   * attached to the given loop.
   */
  Trigger LeftStick(EventLoop* loop = CommandScheduler::GetInstance()
                                          .GetDefaultButtonLoop()) const;
   ...
   * attached to the given loop.
   */
  Trigger RightStick(EventLoop* loop = CommandScheduler::GetInstance()
                                           .GetDefaultButtonLoop()) const;
   ...
   * attached to the given loop.
   */
  Trigger Back(EventLoop* loop = CommandScheduler::GetInstance()
                                     .GetDefaultButtonLoop()) const;
   ...
   * attached to the given loop.
   */
  Trigger Start(EventLoop* loop = CommandScheduler::GetInstance()
                                      .GetDefaultButtonLoop()) const;
