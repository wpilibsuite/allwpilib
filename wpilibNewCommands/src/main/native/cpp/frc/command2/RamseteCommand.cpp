...
RamseteCommand::RamseteCommand(
    ...
    : m_trajectory(std::move(trajectory)),
      ...
      m_leftController(std::make_unique<PIDController>(leftController)),
      m_rightController(std::make_unique<PIDController>(rightController)),
...
void RamseteCommand::Initialize() {
  ...
  m_prevSpeeds = m_kinematics.ToWheelSpeeds(
      ChassisSpeeds{initialState.velocity, 0_mps,
