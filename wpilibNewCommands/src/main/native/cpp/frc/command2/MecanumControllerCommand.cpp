...
MecanumControllerCommand::MecanumControllerCommand(
    ...
    : m_trajectory(std::move(trajectory)),
      ...
      m_frontLeftController(
          std::make_unique<PIDController>(frontLeftController)),
      m_rearLeftController(std::make_unique<PIDController>(rearLeftController)),
      m_frontRightController(
          std::make_unique<PIDController>(frontRightController)),
      m_rearRightController(
          std::make_unique<PIDController>(rearRightController)),
...
void MecanumControllerCommand::Initialize() {
  ...
  m_prevSpeeds = m_kinematics.ToWheelSpeeds(
      ChassisSpeeds{initialXVelocity, initialYVelocity, 0_rad_per_s});
