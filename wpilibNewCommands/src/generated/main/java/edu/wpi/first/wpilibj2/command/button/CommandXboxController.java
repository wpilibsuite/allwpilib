...
public class CommandXboxController extends CommandGenericHID {
   ...
   *
   * @return an event instance representing the back's digital signal attached to the
   *     {@link CommandScheduler#getDefaultButtonLoop() default scheduler button loop}.
   * @see #back(EventLoop)
   */
  public Trigger back() {
   ...
   *
   * @return an event instance representing the start's digital signal attached to the
   *     {@link CommandScheduler#getDefaultButtonLoop() default scheduler button loop}.
   * @see #start(EventLoop)
   */
