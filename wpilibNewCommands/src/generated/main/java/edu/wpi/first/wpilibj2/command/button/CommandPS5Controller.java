...
public class CommandPS5Controller extends CommandGenericHID {
  ...
  public Trigger square(EventLoop loop) {
    return button(PS5Controller.Button.SQUARE.value, loop);
  }
  ...
  public Trigger cross(EventLoop loop) {
    return button(PS5Controller.Button.CROSS.value, loop);
  }
  ...
  public Trigger circle(EventLoop loop) {
    return button(PS5Controller.Button.CIRCLE.value, loop);
  }
  ...
  public Trigger triangle(EventLoop loop) {
    return button(PS5Controller.Button.TRIANGLE.value, loop);
  }
  ...
  public Trigger L1(EventLoop loop) {
    return button(PS5Controller.Button.L1.value, loop);
  }
  ...
  public Trigger R1(EventLoop loop) {
    return button(PS5Controller.Button.R1.value, loop);
  }
  ...
  public Trigger L2(EventLoop loop) {
    return button(PS5Controller.Button.L2.value, loop);
  }
  ...
  public Trigger R2(EventLoop loop) {
    return button(PS5Controller.Button.R2.value, loop);
  }
  ...
  public Trigger create(EventLoop loop) {
    return button(PS5Controller.Button.CREATE.value, loop);
  }
  ...
  public Trigger options(EventLoop loop) {
    return button(PS5Controller.Button.OPTIONS.value, loop);
  }
  ...
  public Trigger L3(EventLoop loop) {
    return button(PS5Controller.Button.L3.value, loop);
  }
  ...
  public Trigger R3(EventLoop loop) {
    return button(PS5Controller.Button.R3.value, loop);
  }
  ...
  public Trigger PS(EventLoop loop) {
    return button(PS5Controller.Button.PS.value, loop);
  }
  ...
  public Trigger touchpad(EventLoop loop) {
    return button(PS5Controller.Button.TOUCHPAD.value, loop);
  }
