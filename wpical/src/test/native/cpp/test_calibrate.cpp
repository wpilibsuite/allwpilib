...
//   int ret = cameracalibration::calibrate(
//       projectRootPath + "/field video/long.mp4", 0.709f, 0.551f, 12, 8,
//       false);
//   EXPECT_EQ(ret, 1);
// }
...
//   int ret = cameracalibration::calibrate(
//       projectRootPath + "/field video/short.mp4", 0.709f, 12, 8, 1080,
//       1920, false);
//   EXPECT_EQ(ret, 1);
// }
...
//       projectRootPath + "/field video", projectRootPath + "",
...
//   int ret = fieldcalibration::calibrate(
//       projectRootPath + "/field video", projectRootPath + "",
//       projectRootPath + "/field video/long.mp4",
//       projectRootPath + "/2024-crescendo.json", 3, 15, false);
//   EXPECT_EQ(ret, 1);
// }
