...
class TelemetryBackend {
 public:
   ...
   * failures should be reported through TelemetryRegistry::ReportWarning() and
   * represented with a discard entry.
   *
   ...
   */
  virtual void RemoveEntry(std::string_view path) { (void)path; }
   ...
   *
   * Backend implementations must not throw from this method. Recoverable schema
