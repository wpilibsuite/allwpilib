...
public record Mult<A extends Unit, B extends Unit>(double magnitude, double baseUnitMagnitude, MultUnit<A, B> unit) implements Measure<MultUnit<A, B>> {
   ...
   */
  public static <A extends Unit, B extends Unit> Mult<A, B> ofRelativeUnits(double magnitude, MultUnit<A, B> unit) {
    return new Mult<A, B>(magnitude, unit.toBaseUnits(magnitude), unit);
  }
   ...
   * @return a measurement object
   */
  public static <A extends Unit, B extends Unit> Mult<A, B> ofBaseUnits(double baseUnitMagnitude, MultUnit<A, B> unit) {
    return new Mult<A, B>(unit.fromBaseUnits(baseUnitMagnitude), baseUnitMagnitude, unit);
  }

  @Override
  public MultUnit<A, B> baseUnit() { return (MultUnit<A, B>) unit().getBaseUnit(); }

  @Override
  public double in(MultUnit<A, B> unit) {
  ...
  public boolean equals(Object object) {
    return object instanceof Mult m && isEquivalent(m);
  }

  @Override
  public Mult<A, B> unaryMinus() {
  ...
  */
  ...
  @Override
  public Mult<A, B> minus(Measure<? extends MultUnit<A, B>> other) {
    return (Mult<A, B>) unit().ofBaseUnits(baseUnitMagnitude() - other.baseUnitMagnitude());
  }

  @Override
  public Mult<A, B> times(double multiplier) {
    return (Mult<A, B>) unit().ofBaseUnits(baseUnitMagnitude() * multiplier);
  }

  @Override
  public Mult<A, B> div(double divisor) {
  ...
  */
  ...
  @Override
  public Per<MultUnit<A, B>, AccelerationUnit<?>> div(Acceleration<?> divisor) {
  ...
  */
  ...
  @Override
  public Mult<MultUnit<A, B>, AngleUnit> times(Angle multiplier) {
    return (Mult<MultUnit<A, B>, AngleUnit>) Measure.super.times(multiplier);
  }

  @Override
  public Per<MultUnit<A, B>, AngleUnit> div(Angle divisor) {
  ...
  */
  ...
  @Override
  public Mult<MultUnit<A, B>, AngularAccelerationUnit> times(AngularAcceleration multiplier) {
    return (Mult<MultUnit<A, B>, AngularAccelerationUnit>) Measure.super.times(multiplier);
  }

  @Override
  public Per<MultUnit<A, B>, AngularAccelerationUnit> div(AngularAcceleration divisor) {
  ...
  */
  ...
  @Override
  public Mult<MultUnit<A, B>, AngularMomentumUnit> times(AngularMomentum multiplier) {
    return (Mult<MultUnit<A, B>, AngularMomentumUnit>) Measure.super.times(multiplier);
  }

  @Override
  public Per<MultUnit<A, B>, AngularMomentumUnit> div(AngularMomentum divisor) {
  ...
  */
  ...
  @Override
  public Mult<MultUnit<A, B>, AngularVelocityUnit> times(AngularVelocity multiplier) {
    return (Mult<MultUnit<A, B>, AngularVelocityUnit>) Measure.super.times(multiplier);
  }

  @Override
  public Per<MultUnit<A, B>, AngularVelocityUnit> div(AngularVelocity divisor) {
  ...
  */
  ...
  @Override
  public Mult<MultUnit<A, B>, CurrentUnit> times(Current multiplier) {
    return (Mult<MultUnit<A, B>, CurrentUnit>) Measure.super.times(multiplier);
  }

  @Override
  public Per<MultUnit<A, B>, CurrentUnit> div(Current divisor) {
  ...
  */
  ...
  @Override
  public Mult<A, B> div(Dimensionless divisor) {
  ...
  */
  ...
  @Override
  public Mult<MultUnit<A, B>, DistanceUnit> times(Distance multiplier) {
    return (Mult<MultUnit<A, B>, DistanceUnit>) Measure.super.times(multiplier);
  }

  @Override
  public Per<MultUnit<A, B>, DistanceUnit> div(Distance divisor) {
  ...
  */
  ...
  @Override
  public Mult<MultUnit<A, B>, EnergyUnit> times(Energy multiplier) {
    return (Mult<MultUnit<A, B>, EnergyUnit>) Measure.super.times(multiplier);
  }

  @Override
  public Per<MultUnit<A, B>, EnergyUnit> div(Energy divisor) {
  ...
  */
  ...
  @Override
  public Mult<MultUnit<A, B>, ForceUnit> times(Force multiplier) {
    return (Mult<MultUnit<A, B>, ForceUnit>) Measure.super.times(multiplier);
  }

  @Override
  public Per<MultUnit<A, B>, ForceUnit> div(Force divisor) {
  ...
  */
  ...
  @Override
  public Mult<MultUnit<A, B>, FrequencyUnit> times(Frequency multiplier) {
    return (Mult<MultUnit<A, B>, FrequencyUnit>) Measure.super.times(multiplier);
  }

  @Override
  public Per<MultUnit<A, B>, FrequencyUnit> div(Frequency divisor) {
  ...
  */
  ...
  @Override
  public Mult<MultUnit<A, B>, LinearAccelerationUnit> times(LinearAcceleration multiplier) {
    return (Mult<MultUnit<A, B>, LinearAccelerationUnit>) Measure.super.times(multiplier);
  }

  @Override
  public Per<MultUnit<A, B>, LinearAccelerationUnit> div(LinearAcceleration divisor) {
  ...
  */
  ...
  @Override
  public Mult<MultUnit<A, B>, LinearMomentumUnit> times(LinearMomentum multiplier) {
    return (Mult<MultUnit<A, B>, LinearMomentumUnit>) Measure.super.times(multiplier);
  }

  @Override
  public Per<MultUnit<A, B>, LinearMomentumUnit> div(LinearMomentum divisor) {
  ...
  */
  ...
  @Override
  public Mult<MultUnit<A, B>, LinearVelocityUnit> times(LinearVelocity multiplier) {
    return (Mult<MultUnit<A, B>, LinearVelocityUnit>) Measure.super.times(multiplier);
  }

  @Override
  public Per<MultUnit<A, B>, LinearVelocityUnit> div(LinearVelocity divisor) {
  ...
  */
  ...
  @Override
  public Mult<MultUnit<A, B>, MassUnit> times(Mass multiplier) {
    return (Mult<MultUnit<A, B>, MassUnit>) Measure.super.times(multiplier);
  }

  @Override
  public Per<MultUnit<A, B>, MassUnit> div(Mass divisor) {
  ...
  */
  ...
  @Override
  public Mult<MultUnit<A, B>, MomentOfInertiaUnit> times(MomentOfInertia multiplier) {
    return (Mult<MultUnit<A, B>, MomentOfInertiaUnit>) Measure.super.times(multiplier);
  }

  @Override
  public Per<MultUnit<A, B>, MomentOfInertiaUnit> div(MomentOfInertia divisor) {
  ...
  */
  ...
  @Override
  public Mult<MultUnit<A, B>, MultUnit<?, ?>> times(Mult<?, ?> multiplier) {
    return (Mult<MultUnit<A, B>, MultUnit<?, ?>>) Measure.super.times(multiplier);
  }

  @Override
  public Per<MultUnit<A, B>, MultUnit<?, ?>> div(Mult<?, ?> divisor) {
  ...
  */
  ...
  @Override
  public Mult<MultUnit<A, B>, PerUnit<?, ?>> times(Per<?, ?> multiplier) {
    return (Mult<MultUnit<A, B>, PerUnit<?, ?>>) Measure.super.times(multiplier);
  }

  @Override
  public Per<MultUnit<A, B>, PerUnit<?, ?>> div(Per<?, ?> divisor) {
  ...
  */
  ...
  @Override
  public Mult<MultUnit<A, B>, PowerUnit> times(Power multiplier) {
    return (Mult<MultUnit<A, B>, PowerUnit>) Measure.super.times(multiplier);
  }

  @Override
  public Per<MultUnit<A, B>, PowerUnit> div(Power divisor) {
  ...
  */
  ...
  @Override
  public Mult<MultUnit<A, B>, ResistanceUnit> times(Resistance multiplier) {
    return (Mult<MultUnit<A, B>, ResistanceUnit>) Measure.super.times(multiplier);
  }

  @Override
  public Per<MultUnit<A, B>, ResistanceUnit> div(Resistance divisor) {
  ...
  */
  ...
  @Override
  public Mult<MultUnit<A, B>, TemperatureUnit> times(Temperature multiplier) {
    return (Mult<MultUnit<A, B>, TemperatureUnit>) Measure.super.times(multiplier);
  }

  @Override
  public Per<MultUnit<A, B>, TemperatureUnit> div(Temperature divisor) {
  ...
  */
  ...
  @Override
  public Mult<MultUnit<A, B>, TimeUnit> times(Time multiplier) {
    return (Mult<MultUnit<A, B>, TimeUnit>) Measure.super.times(multiplier);
  }

  @Override
  public Velocity<MultUnit<A, B>> div(Time divisor) {
  ...
  */
  ...
  @Override
  public Mult<MultUnit<A, B>, TorqueUnit> times(Torque multiplier) {
    return (Mult<MultUnit<A, B>, TorqueUnit>) Measure.super.times(multiplier);
  }

  @Override
  public Per<MultUnit<A, B>, TorqueUnit> div(Torque divisor) {
  ...
  */
  ...
  @Override
  public Mult<MultUnit<A, B>, VelocityUnit<?>> times(Velocity<?> multiplier) {
    return (Mult<MultUnit<A, B>, VelocityUnit<?>>) Measure.super.times(multiplier);
  }

  @Override
  public Per<MultUnit<A, B>, VelocityUnit<?>> div(Velocity<?> divisor) {
  ...
  */
  ...
  @Override
  public Mult<MultUnit<A, B>, VoltageUnit> times(Voltage multiplier) {
    return (Mult<MultUnit<A, B>, VoltageUnit>) Measure.super.times(multiplier);
  }

  @Override
  public Per<MultUnit<A, B>, VoltageUnit> div(Voltage divisor) {
