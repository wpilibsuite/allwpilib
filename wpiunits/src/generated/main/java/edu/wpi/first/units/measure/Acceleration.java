...
public interface Acceleration<D extends Unit> extends Measure<AccelerationUnit<D>> {
  ...
  @Override
  default Mult<AccelerationUnit<D>, VoltagePerAnglePerTimeUnit> times(VoltagePerAnglePerTime multiplier) {
    return (Mult<AccelerationUnit<D>, VoltagePerAnglePerTimeUnit>) Measure.super.times(multiplier);
  }

  @Override
  default Per<AccelerationUnit<D>, VoltagePerAnglePerTimeUnit> divide(VoltagePerAnglePerTime divisor) {
    return (Per<AccelerationUnit<D>, VoltagePerAnglePerTimeUnit>) Measure.super.divide(divisor);
  }


  @Override
  default Mult<AccelerationUnit<D>, VoltagePerAnglePerTimeSquaredUnit> times(VoltagePerAnglePerTimeSquared multiplier) {
    return (Mult<AccelerationUnit<D>, VoltagePerAnglePerTimeSquaredUnit>) Measure.super.times(multiplier);
  }

  @Override
  default Per<AccelerationUnit<D>, VoltagePerAnglePerTimeSquaredUnit> divide(VoltagePerAnglePerTimeSquared divisor) {
    return (Per<AccelerationUnit<D>, VoltagePerAnglePerTimeSquaredUnit>) Measure.super.divide(divisor);
  }
  ...
  @Override
  default Mult<AccelerationUnit<D>, VoltagePerDistancePerTimeSquaredUnit> times(VoltagePerDistancePerTimeSquared multiplier) {
    return (Mult<AccelerationUnit<D>, VoltagePerDistancePerTimeSquaredUnit>) Measure.super.times(multiplier);
  }

  @Override
  default Per<AccelerationUnit<D>, VoltagePerDistancePerTimeSquaredUnit> divide(VoltagePerDistancePerTimeSquared divisor) {
    return (Per<AccelerationUnit<D>, VoltagePerDistancePerTimeSquaredUnit>) Measure.super.divide(divisor);
  }
