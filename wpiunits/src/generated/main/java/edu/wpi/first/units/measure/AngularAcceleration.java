...
public interface AngularAcceleration extends Measure<AngularAccelerationUnit> {
  ...
  @Override
  default Mult<AngularAccelerationUnit, VoltagePerAnglePerTimeUnit> times(VoltagePerAnglePerTime multiplier) {
    return (Mult<AngularAccelerationUnit, VoltagePerAnglePerTimeUnit>) Measure.super.times(multiplier);
  }

  @Override
  default Per<AngularAccelerationUnit, VoltagePerAnglePerTimeUnit> divide(VoltagePerAnglePerTime divisor) {
    return (Per<AngularAccelerationUnit, VoltagePerAnglePerTimeUnit>) Measure.super.divide(divisor);
  }
  ...
  @Override
  default Per<AngularAccelerationUnit, VoltagePerDistancePerTimeUnit> divide(VoltagePerDistancePerTime divisor) {
    return (Per<AngularAccelerationUnit, VoltagePerDistancePerTimeUnit>) Measure.super.divide(divisor);
  }


  @Override
  default Mult<AngularAccelerationUnit, VoltagePerDistancePerTimeSquaredUnit> times(VoltagePerDistancePerTimeSquared multiplier) {
    return (Mult<AngularAccelerationUnit, VoltagePerDistancePerTimeSquaredUnit>) Measure.super.times(multiplier);
  }

  @Override
  default Per<AngularAccelerationUnit, VoltagePerDistancePerTimeSquaredUnit> divide(VoltagePerDistancePerTimeSquared divisor) {
    return (Per<AngularAccelerationUnit, VoltagePerDistancePerTimeSquaredUnit>) Measure.super.divide(divisor);
  }
