...
public interface Dimensionless extends Measure<DimensionlessUnit> {
  ...
  @Override
  default VoltagePerAnglePerTime times(VoltagePerAnglePerTime multiplier) {
    return VoltsPerRadianPerSecond.of(baseUnitMagnitude() * multiplier.baseUnitMagnitude());
  }

  @Override
  default Per<DimensionlessUnit, VoltagePerAnglePerTimeUnit> divide(VoltagePerAnglePerTime divisor) {
    return (Per<DimensionlessUnit, VoltagePerAnglePerTimeUnit>) Measure.super.divide(divisor);
  }
  ...
  @Override
  default Per<DimensionlessUnit, VoltagePerDistancePerTimeUnit> divide(VoltagePerDistancePerTime divisor) {
