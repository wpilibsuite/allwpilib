...
public interface Mult<A extends Unit, B extends Unit> extends Measure<MultUnit<A, B>> {
  ...
  @Override
  default Mult<MultUnit<A, B>, VoltagePerAnglePerTimeUnit> times(VoltagePerAnglePerTime multiplier) {
    return (Mult<MultUnit<A, B>, VoltagePerAnglePerTimeUnit>) Measure.super.times(multiplier);
  }

  @Override
  default Per<MultUnit<A, B>, VoltagePerAnglePerTimeUnit> divide(VoltagePerAnglePerTime divisor) {
    return (Per<MultUnit<A, B>, VoltagePerAnglePerTimeUnit>) Measure.super.divide(divisor);
  }


  @Override
  default Mult<MultUnit<A, B>, VoltagePerAnglePerTimeSquaredUnit> times(VoltagePerAnglePerTimeSquared multiplier) {
    return (Mult<MultUnit<A, B>, VoltagePerAnglePerTimeSquaredUnit>) Measure.super.times(multiplier);
  }

  @Override
  default Per<MultUnit<A, B>, VoltagePerAnglePerTimeSquaredUnit> divide(VoltagePerAnglePerTimeSquared divisor) {
    return (Per<MultUnit<A, B>, VoltagePerAnglePerTimeSquaredUnit>) Measure.super.divide(divisor);
  }
  ...
  @Override
  default Mult<MultUnit<A, B>, VoltagePerDistancePerTimeSquaredUnit> times(VoltagePerDistancePerTimeSquared multiplier) {
    return (Mult<MultUnit<A, B>, VoltagePerDistancePerTimeSquaredUnit>) Measure.super.times(multiplier);
  }

  @Override
  default Per<MultUnit<A, B>, VoltagePerDistancePerTimeSquaredUnit> divide(VoltagePerDistancePerTimeSquared divisor) {
    return (Per<MultUnit<A, B>, VoltagePerDistancePerTimeSquaredUnit>) Measure.super.divide(divisor);
  }
