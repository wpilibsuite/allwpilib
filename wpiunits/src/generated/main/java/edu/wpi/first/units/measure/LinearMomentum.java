...
public interface LinearMomentum extends Measure<LinearMomentumUnit> {
  ...
  @Override
  default Mult<LinearMomentumUnit, VoltagePerAnglePerTimeUnit> times(VoltagePerAnglePerTime multiplier) {
    return (Mult<LinearMomentumUnit, VoltagePerAnglePerTimeUnit>) Measure.super.times(multiplier);
  }

  @Override
  default Per<LinearMomentumUnit, VoltagePerAnglePerTimeUnit> divide(VoltagePerAnglePerTime divisor) {
    return (Per<LinearMomentumUnit, VoltagePerAnglePerTimeUnit>) Measure.super.divide(divisor);
  }
  ...
  @Override
  default Per<LinearMomentumUnit, VoltagePerDistancePerTimeUnit> divide(VoltagePerDistancePerTime divisor) {
    return (Per<LinearMomentumUnit, VoltagePerDistancePerTimeUnit>) Measure.super.divide(divisor);
  }


  @Override
  default Mult<LinearMomentumUnit, VoltagePerDistancePerTimeSquaredUnit> times(VoltagePerDistancePerTimeSquared multiplier) {
    return (Mult<LinearMomentumUnit, VoltagePerDistancePerTimeSquaredUnit>) Measure.super.times(multiplier);
  }

  @Override
  default Per<LinearMomentumUnit, VoltagePerDistancePerTimeSquaredUnit> divide(VoltagePerDistancePerTimeSquared divisor) {
    return (Per<LinearMomentumUnit, VoltagePerDistancePerTimeSquaredUnit>) Measure.super.divide(divisor);
  }
