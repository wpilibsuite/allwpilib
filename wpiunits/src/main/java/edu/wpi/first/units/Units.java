...
public final class Units {
    ...
    public static final Velocity<Velocity<Distance>> Gs = derive(MetersPerSecondPerSecond).aggregate(9.80665).named("G")
            .symbol("G").make();
    ...
    public static final Mult<Mass, Mult<Distance, Distance>> KilogramsMetersSquared = Kilograms
            .mult(Meters.mult(Meters));
    ...
    public static final Per<Voltage, Velocity<Velocity<Distance>>> VoltsPerMeterPerSecondSquared = Volts
            .per(MetersPerSecondPerSecond);

    public static final Per<Voltage, Velocity<Angle>> VoltsPerRadianPerSecond = Volts.per(RadiansPerSecond);
    public static final Per<Voltage, Velocity<Velocity<Angle>>> VoltsPerRadianPerSecondSquared = Volts
            .per(RadiansPerSecond.per(Second));

    /**
     * Creates a unit equal to a thousandth of the base unit, eg Milliseconds =
     * Milli(Units.Seconds).
     *
     * @param <U>      the type of the unit
     * @param baseUnit the unit being derived from. This does not have to be the
    ...
    /**
     * Creates a unit equal to a millionth of the base unit, eg Microseconds =
     * Micro(Units.Seconds).
     *
     * @param <U>      the type of the unit
     * @param baseUnit the unit being derived from. This does not have to be the
    ...
    /**
     * Creates a unit equal to a thousand of the base unit, eg Kilograms =
     * Kilo(Units.Grams).
     *
     * @param <U>      the type of the unit
     * @param baseUnit the unit being derived from. This does not have to be the
