...
// /**
//  * Unit of velocity dimension that is a combination of a distance unit (numerator) and a time
// unit
//  * (denominator).
//  *
//  * <p>This is the base type for units of velocity dimension. It is also used in combination with
// a
//  * distance dimension to specify the dimension for {@link Measure}. For example: <code>
//  * Measure&lt;Velocity&lt;Distance&gt;&gt;</code>.
//  *
//  * <p>Actual units (such as {@link Units#MetersPerSecond} and {@link Units#RPM}) can be found in
// the
//  * {@link Units} class.
//  *
...
//     return ((long) numerator.hashCode()) << 32L | (((long) denominator.hashCode()) &
// 0xFFFFFFFFL);
//   }
...
//    * </pre>
//    *
//    * <p>It's recommended to use the convenience function {@link Unit#per(Time)} instead of
// calling
