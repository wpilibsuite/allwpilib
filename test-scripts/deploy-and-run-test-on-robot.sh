...
ssh ${ROBOT_ADDRESS} "rm -rf ${DEFAULT_DESTINATION_TEST_RESULTS_DIR}; mkdir -p ${DEFAULT_DESTINATION_TEST_RESULTS_DIR}"
...
ssh ${ROBOT_ADDRESS} "chmod a+x ${DEFAULT_DESTINATION_RUN_TEST_SCRIPT}; mkdir -p ${DEFAULT_TEST_SCP_DIR}; touch ${DESTINATION_TEST_FILE}"
...
mkdir -p ${DEFAULT_LOCAL_TEST_RESULTS_DIR}; scp ${ROBOT_ADDRESS}:${DESTINATION_TEST_RESULTS} ${LOCAL_TEST_RESULTS}
