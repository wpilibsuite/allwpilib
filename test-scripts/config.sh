...
DEFAULT_LOCAL_CPP_TEST_FILE=../wpilibcIntegrationTests/build/exe/fRCUserProgram/athena/FRCUserProgram
...
DEFAULT_LIBRARY_NATIVE_FILES=../wpilibjIntegrationTests/build/testFiles/libs
