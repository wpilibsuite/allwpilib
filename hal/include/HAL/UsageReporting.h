 ...
 * @param context an optional additional context number for some cases (such a
 *        module number). Set to 0 to omit.
 * @param feature a string to be included describing features in use on a
 *        specfic resource.  Setting the same resource more than once allows you
 *        to change the feature string.
 */
