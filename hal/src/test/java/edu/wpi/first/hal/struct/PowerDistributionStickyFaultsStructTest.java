...
public class PowerDistributionStickyFaultsStructTest extends StructTestBase<PowerDistributionStickyFaults> {
    ...
    @Override
    public void checkEquals(PowerDistributionStickyFaults testData, PowerDistributionStickyFaults data) {
