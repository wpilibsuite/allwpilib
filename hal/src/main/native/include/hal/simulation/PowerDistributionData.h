...
int32_t HALSIM_RegisterPowerDistributionCurrentCallback(int32_t index, int32_t channel,
                                          HAL_NotifyCallback callback,
                                          void* param, HAL_Bool initialNotify);
void HALSIM_CancelPowerDistributionCurrentCallback(int32_t index, int32_t channel,
                                     int32_t uid);
