...
Java_edu_wpi_first_wpilibj_hal_AnalogGyroJNI_initializeAnalogGyro(JNIEnv* env,
                                                                  jclass,
                                                                  jint id) {
...
Java_edu_wpi_first_wpilibj_hal_AnalogGyroJNI_setupAnalogGyro(JNIEnv* env,
                                                             jclass, jint id) {
 ...
 */
JNIEXPORT void JNICALL
Java_edu_wpi_first_wpilibj_hal_AnalogGyroJNI_freeAnalogGyro(JNIEnv* env, jclass,
                                                            jint id) {
 ...
 */
JNIEXPORT void JNICALL
Java_edu_wpi_first_wpilibj_hal_AnalogGyroJNI_resetAnalogGyro(JNIEnv* env,
                                                             jclass, jint id) {
 ...
 */
JNIEXPORT void JNICALL
Java_edu_wpi_first_wpilibj_hal_AnalogGyroJNI_calibrateAnalogGyro(JNIEnv* env,
                                                                 jclass,
                                                                 jint id) {
...
Java_edu_wpi_first_wpilibj_hal_AnalogGyroJNI_getAnalogGyroAngle(JNIEnv* env,
                                                                jclass,
                                                                jint id) {
 ...
 */
JNIEXPORT jdouble JNICALL
Java_edu_wpi_first_wpilibj_hal_AnalogGyroJNI_getAnalogGyroRate(JNIEnv* env,
                                                               jclass,
                                                               jint id) {
 ...
 */
JNIEXPORT jdouble JNICALL
Java_edu_wpi_first_wpilibj_hal_AnalogGyroJNI_getAnalogGyroOffset(JNIEnv* env,
                                                                 jclass,
                                                                 jint id) {
 ...
 */
JNIEXPORT jint JNICALL
Java_edu_wpi_first_wpilibj_hal_AnalogGyroJNI_getAnalogGyroCenter(JNIEnv* env,
                                                                 jclass,
                                                                 jint id) {
