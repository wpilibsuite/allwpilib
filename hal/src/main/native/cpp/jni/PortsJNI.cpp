...
Java_edu_wpi_first_wpilibj_hal_PortsJNI_getNumAccumulators(JNIEnv* env,
                                                           jclass) {
 ...
 */
JNIEXPORT jint JNICALL
Java_edu_wpi_first_wpilibj_hal_PortsJNI_getNumAnalogTriggers(JNIEnv* env,
                                                             jclass) {
 ...
 */
JNIEXPORT jint JNICALL
Java_edu_wpi_first_wpilibj_hal_PortsJNI_getNumAnalogInputs(JNIEnv* env,
                                                           jclass) {
 ...
 */
JNIEXPORT jint JNICALL
Java_edu_wpi_first_wpilibj_hal_PortsJNI_getNumAnalogOutputs(JNIEnv* env,
                                                            jclass) {
 ...
 */
JNIEXPORT jint JNICALL
Java_edu_wpi_first_wpilibj_hal_PortsJNI_getNumCounters(JNIEnv* env, jclass) {
 ...
 */
JNIEXPORT jint JNICALL
Java_edu_wpi_first_wpilibj_hal_PortsJNI_getNumDigitalHeaders(JNIEnv* env,
                                                             jclass) {
 ...
 */
JNIEXPORT jint JNICALL
Java_edu_wpi_first_wpilibj_hal_PortsJNI_getNumPWMHeaders(JNIEnv* env, jclass) {
 ...
 */
JNIEXPORT jint JNICALL
Java_edu_wpi_first_wpilibj_hal_PortsJNI_getNumDigitalChannels(JNIEnv* env,
                                                              jclass) {
 ...
 */
JNIEXPORT jint JNICALL
Java_edu_wpi_first_wpilibj_hal_PortsJNI_getNumPWMChannels(JNIEnv* env, jclass) {
 ...
 */
JNIEXPORT jint JNICALL
Java_edu_wpi_first_wpilibj_hal_PortsJNI_getNumDigitalPWMOutputs(JNIEnv* env,
                                                                jclass) {
 ...
 */
JNIEXPORT jint JNICALL
Java_edu_wpi_first_wpilibj_hal_PortsJNI_getNumEncoders(JNIEnv* env, jclass) {
 ...
 */
JNIEXPORT jint JNICALL
Java_edu_wpi_first_wpilibj_hal_PortsJNI_getNumInterrupts(JNIEnv* env, jclass) {
 ...
 */
JNIEXPORT jint JNICALL
Java_edu_wpi_first_wpilibj_hal_PortsJNI_getNumRelayChannels(JNIEnv* env,
                                                            jclass) {
 ...
 */
JNIEXPORT jint JNICALL
Java_edu_wpi_first_wpilibj_hal_PortsJNI_getNumRelayHeaders(JNIEnv* env,
                                                           jclass) {
 ...
 */
JNIEXPORT jint JNICALL
Java_edu_wpi_first_wpilibj_hal_PortsJNI_getNumPCMModules(JNIEnv* env, jclass) {
 ...
 */
JNIEXPORT jint JNICALL
Java_edu_wpi_first_wpilibj_hal_PortsJNI_getNumSolenoidChannels(JNIEnv* env,
                                                               jclass) {
 ...
 */
JNIEXPORT jint JNICALL
Java_edu_wpi_first_wpilibj_hal_PortsJNI_getNumPDPModules(JNIEnv* env, jclass) {
 ...
 */
JNIEXPORT jint JNICALL
Java_edu_wpi_first_wpilibj_hal_PortsJNI_getNumPDPChannels(JNIEnv* env, jclass) {
