...
#ifndef ALLWPILIB_HAL_SRC_MAIN_NATIVE_CPP_JNI_HALUTIL_H_
#define ALLWPILIB_HAL_SRC_MAIN_NATIVE_CPP_JNI_HALUTIL_H_
...
#endif  // ALLWPILIB_HAL_SRC_MAIN_NATIVE_CPP_JNI_HALUTIL_H_
