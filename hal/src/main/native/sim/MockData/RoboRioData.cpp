...
void HALSIM_RegisterRoboRioAllCallbacks(int32_t index,
                                                    ...
                                                    HAL_Bool initialNotify)
{
	SimRoboRioData[index].RegisterFPGAButtonCallback(callback, param, initialNotify);
	SimRoboRioData[index].RegisterVInVoltageCallback(callback, param, initialNotify);
	SimRoboRioData[index].RegisterVInCurrentCallback(callback, param, initialNotify);
	SimRoboRioData[index].RegisterUserVoltage6VCallback(callback, param, initialNotify);
	SimRoboRioData[index].RegisterUserCurrent6VCallback(callback, param, initialNotify);
	SimRoboRioData[index].RegisterUserActive6VCallback(callback, param, initialNotify);
	SimRoboRioData[index].RegisterUserVoltage5VCallback(callback, param, initialNotify);
	SimRoboRioData[index].RegisterUserCurrent5VCallback(callback, param, initialNotify);
	SimRoboRioData[index].RegisterUserActive5VCallback(callback, param, initialNotify);
	SimRoboRioData[index].RegisterUserVoltage3V3Callback(callback, param, initialNotify);
	SimRoboRioData[index].RegisterUserCurrent3V3Callback(callback, param, initialNotify);
	SimRoboRioData[index].RegisterUserActive3V3Callback(callback, param, initialNotify);
	SimRoboRioData[index].RegisterUserFaults6VCallback(callback, param, initialNotify);
	SimRoboRioData[index].RegisterUserFaults5VCallback(callback, param, initialNotify);
	SimRoboRioData[index].RegisterUserFaults3V3Callback(callback, param, initialNotify);
}
}
