...
class ParallelTcpConnector
 ...
 public:
   ...
   *                  before returning
   * @param ipv4 true if only IPv4 addresses should be returned; otherwise both
   *             IPv4 and IPv6 addresses are returned
