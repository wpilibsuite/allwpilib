...
public final class Constants {
  ...
  public static final class ShooterConstants {
    ...
    public static final double kV = 12.0 / SHOOTER_FREE_RPS; // V/(rot/s)

    public static final double FEEDER_VELOCITY = 0.5;
  }
  ...
  public static final class AutoConstants {
    ...
    public static final double DRIVE_VELOCITY = 0.5;
  }
