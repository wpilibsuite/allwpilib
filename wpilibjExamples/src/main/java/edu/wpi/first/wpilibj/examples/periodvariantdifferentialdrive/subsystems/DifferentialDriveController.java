...
public class DifferentialDriveController {
  ...
  private final PeriodVariantLoop<N4, N2, N2> m_loop =
      DifferentialDriveCoeffs.makeDifferentialDriveLoop();
  ...
  public void setReferences(double leftPosition, double leftVelocity,
    ...
    Matrix<N4, N1> nextR = MatrixUtils.vec(Nat.N4()).fill(leftPosition, leftVelocity,
