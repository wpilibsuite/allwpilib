...
public class Robot extends TimedRobot {
  private final DifferentialDrive m_tankDrive = new DifferentialDrive(new VictorSPX(0), new VictorSPX(1));
  private final Encoder m_leftEncoder = new Encoder(0, 1);
  private final Encoder m_rightEncoder = new Encoder(2, 3);

  private final VictorSPX m_elevatorMotor = new VictorSPX(2);
