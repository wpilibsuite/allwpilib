...
TEST_F(PCMTest, Solenoid) {
  Reset();
  frc::Solenoid solenoid1{frc::PneumaticsModuleType::CTREPCM, TestBench::kSolenoidChannel1};
  frc::Solenoid solenoid2{frc::PneumaticsModuleType::CTREPCM, TestBench::kSolenoidChannel2};
