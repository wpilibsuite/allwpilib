...
public abstract class Command implements TelemetryLoggable, ComplexTunable {
  ...
  public void logTo(TelemetryTable table) {
    ...
    table.log("isParented", CommandScheduler.getInstance().isComposed(this));
    table.log("interruptBehavior", getInterruptionBehavior().toString());
  ...
  public void publishTunable(TunableTable table) {
    table.publishValue(
        ...
        this::setName,
        String.class,
        TunableConfig.of(TunableOption.IMMUTABLE, TunableOption.GET_ON_CHANGE));
    table.publishBoolean(
        ...
        TunableConfig.of(TunableOption.ALWAYS_GET));
  }
