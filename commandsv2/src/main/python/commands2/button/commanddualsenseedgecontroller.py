...
class CommandDualSenseEdgeController:
    ...
    def cross(self, loop: Optional[EventLoop] = None) -> Trigger:
        ...
        return self._hid.button(
            _enum_value(DualSenseEdgeController.Button.CROSS), loop
        )
    ...
    def circle(self, loop: Optional[EventLoop] = None) -> Trigger:
        ...
        """
        return self._hid.button(
            _enum_value(DualSenseEdgeController.Button.CIRCLE), loop
        )
    ...
    def square(self, loop: Optional[EventLoop] = None) -> Trigger:
        ...
        """
        return self._hid.button(
            _enum_value(DualSenseEdgeController.Button.SQUARE), loop
        )
    ...
    def triangle(self, loop: Optional[EventLoop] = None) -> Trigger:
        ...
        """
        return self._hid.button(
            _enum_value(DualSenseEdgeController.Button.TRIANGLE), loop
        )
    ...
    def create(self, loop: Optional[EventLoop] = None) -> Trigger:
        ...
        """
        return self._hid.button(
            _enum_value(DualSenseEdgeController.Button.CREATE), loop
        )
    ...
    def PS(self, loop: Optional[EventLoop] = None) -> Trigger:
        ...
        """
        return self._hid.button(
            _enum_value(DualSenseEdgeController.Button.PS), loop
        )
    ...
    def options(self, loop: Optional[EventLoop] = None) -> Trigger:
        ...
        """
        return self._hid.button(
            _enum_value(DualSenseEdgeController.Button.OPTIONS), loop
        )
    ...
    def L3(self, loop: Optional[EventLoop] = None) -> Trigger:
        ...
        """
        return self._hid.button(
            _enum_value(DualSenseEdgeController.Button.L3), loop
        )
    ...
    def R3(self, loop: Optional[EventLoop] = None) -> Trigger:
        ...
        """
        return self._hid.button(
            _enum_value(DualSenseEdgeController.Button.R3), loop
        )
    ...
    def L1(self, loop: Optional[EventLoop] = None) -> Trigger:
        ...
        """
        return self._hid.button(
            _enum_value(DualSenseEdgeController.Button.L1), loop
        )
    ...
    def R1(self, loop: Optional[EventLoop] = None) -> Trigger:
        ...
        """
        return self._hid.button(
            _enum_value(DualSenseEdgeController.Button.R1), loop
        )
    ...
    def dpadUp(self, loop: Optional[EventLoop] = None) -> Trigger:
        ...
        """
        return self._hid.button(
            _enum_value(DualSenseEdgeController.Button.DPAD_UP), loop
        )
    ...
    def dpadDown(self, loop: Optional[EventLoop] = None) -> Trigger:
        ...
        """
        return self._hid.button(
            _enum_value(DualSenseEdgeController.Button.DPAD_DOWN), loop
        )
    ...
    def dpadLeft(self, loop: Optional[EventLoop] = None) -> Trigger:
        ...
        """
        return self._hid.button(
            _enum_value(DualSenseEdgeController.Button.DPAD_LEFT), loop
        )
    ...
    def dpadRight(self, loop: Optional[EventLoop] = None) -> Trigger:
        ...
        """
        return self._hid.button(
            _enum_value(DualSenseEdgeController.Button.DPAD_RIGHT), loop
        )
    ...
    def microphone(self, loop: Optional[EventLoop] = None) -> Trigger:
        ...
        """
        return self._hid.button(
            _enum_value(DualSenseEdgeController.Button.MICROPHONE), loop
        )
    ...
    def rightPaddle1(self, loop: Optional[EventLoop] = None) -> Trigger:
        ...
        """
        return self._hid.button(
            _enum_value(DualSenseEdgeController.Button.RIGHT_PADDLE_1), loop
        )
    ...
    def leftPaddle1(self, loop: Optional[EventLoop] = None) -> Trigger:
        ...
        """
        return self._hid.button(
            _enum_value(DualSenseEdgeController.Button.LEFT_PADDLE_1), loop
        )
    ...
    def touchpad(self, loop: Optional[EventLoop] = None) -> Trigger:
        ...
        """
        return self._hid.button(
            _enum_value(DualSenseEdgeController.Button.TOUCHPAD), loop
        )
    ...
    def leftFunction(self, loop: Optional[EventLoop] = None) -> Trigger:
        ...
        """
        return self._hid.button(
            _enum_value(DualSenseEdgeController.Button.LEFT_FUNCTION), loop
        )
    ...
    def rightFunction(self, loop: Optional[EventLoop] = None) -> Trigger:
        ...
        """
        return self._hid.button(
            _enum_value(DualSenseEdgeController.Button.RIGHT_FUNCTION), loop
        )
    ...
    def L2(
        ...
        return self._hid.axisGreaterThan(
            _enum_value(DualSenseEdgeController.Axis.L2),
            threshold,
            loop,
        )
    ...
    def R2(
        ...
        """
        return self._hid.axisGreaterThan(
            _enum_value(DualSenseEdgeController.Axis.R2),
            threshold,
            loop,
        )
