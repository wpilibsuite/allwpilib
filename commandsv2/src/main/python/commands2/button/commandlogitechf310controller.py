...
class CommandLogitechF310Controller:
    ...
    def a(self, loop: Optional[EventLoop] = None) -> Trigger:
        ...
        return self._hid.button(
            _enum_value(LogitechF310Controller.Button.A), loop
        )
    ...
    def b(self, loop: Optional[EventLoop] = None) -> Trigger:
        ...
        """
        return self._hid.button(
            _enum_value(LogitechF310Controller.Button.B), loop
        )
    ...
    def x(self, loop: Optional[EventLoop] = None) -> Trigger:
        ...
        """
        return self._hid.button(
            _enum_value(LogitechF310Controller.Button.X), loop
        )
    ...
    def y(self, loop: Optional[EventLoop] = None) -> Trigger:
        ...
        """
        return self._hid.button(
            _enum_value(LogitechF310Controller.Button.Y), loop
        )
    ...
    def back(self, loop: Optional[EventLoop] = None) -> Trigger:
        ...
        """
        return self._hid.button(
            _enum_value(LogitechF310Controller.Button.BACK), loop
        )
    ...
    def logitech(self, loop: Optional[EventLoop] = None) -> Trigger:
        ...
        """
        return self._hid.button(
            _enum_value(LogitechF310Controller.Button.LOGITECH), loop
        )
    ...
    def start(self, loop: Optional[EventLoop] = None) -> Trigger:
        ...
        """
        return self._hid.button(
            _enum_value(LogitechF310Controller.Button.START), loop
        )
    ...
    def leftStick(self, loop: Optional[EventLoop] = None) -> Trigger:
        ...
        """
        return self._hid.button(
            _enum_value(LogitechF310Controller.Button.LEFT_STICK), loop
        )
    ...
    def rightStick(self, loop: Optional[EventLoop] = None) -> Trigger:
        ...
        """
        return self._hid.button(
            _enum_value(LogitechF310Controller.Button.RIGHT_STICK), loop
        )
    ...
    def leftBumper(self, loop: Optional[EventLoop] = None) -> Trigger:
        ...
        """
        return self._hid.button(
            _enum_value(LogitechF310Controller.Button.LEFT_BUMPER), loop
        )
    ...
    def rightBumper(self, loop: Optional[EventLoop] = None) -> Trigger:
        ...
        """
        return self._hid.button(
            _enum_value(LogitechF310Controller.Button.RIGHT_BUMPER), loop
        )
    ...
    def dpadUp(self, loop: Optional[EventLoop] = None) -> Trigger:
        ...
        """
        return self._hid.button(
            _enum_value(LogitechF310Controller.Button.DPAD_UP), loop
        )
    ...
    def dpadDown(self, loop: Optional[EventLoop] = None) -> Trigger:
        ...
        """
        return self._hid.button(
            _enum_value(LogitechF310Controller.Button.DPAD_DOWN), loop
        )
    ...
    def dpadLeft(self, loop: Optional[EventLoop] = None) -> Trigger:
        ...
        """
        return self._hid.button(
            _enum_value(LogitechF310Controller.Button.DPAD_LEFT), loop
        )
    ...
    def dpadRight(self, loop: Optional[EventLoop] = None) -> Trigger:
        ...
        """
        return self._hid.button(
            _enum_value(LogitechF310Controller.Button.DPAD_RIGHT), loop
        )
    ...
    def leftTrigger(
        ...
        return self._hid.axisGreaterThan(
            _enum_value(LogitechF310Controller.Axis.LEFT_TRIGGER),
            threshold,
            loop,
        )
    ...
    def rightTrigger(
        ...
        """
        return self._hid.axisGreaterThan(
            _enum_value(LogitechF310Controller.Axis.RIGHT_TRIGGER),
            threshold,
            loop,
        )
