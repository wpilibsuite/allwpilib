...
class CommandGameCubeController:
    ...
    def a(self, loop: Optional[EventLoop] = None) -> Trigger:
        ...
        return self._hid.button(
            _enum_value(GameCubeController.Button.A), loop
        )
    ...
    def x(self, loop: Optional[EventLoop] = None) -> Trigger:
        ...
        """
        return self._hid.button(
            _enum_value(GameCubeController.Button.X), loop
        )
    ...
    def b(self, loop: Optional[EventLoop] = None) -> Trigger:
        ...
        """
        return self._hid.button(
            _enum_value(GameCubeController.Button.B), loop
        )
    ...
    def y(self, loop: Optional[EventLoop] = None) -> Trigger:
        ...
        """
        return self._hid.button(
            _enum_value(GameCubeController.Button.Y), loop
        )
    ...
    def start(self, loop: Optional[EventLoop] = None) -> Trigger:
        ...
        """
        return self._hid.button(
            _enum_value(GameCubeController.Button.START), loop
        )
    ...
    def Z(self, loop: Optional[EventLoop] = None) -> Trigger:
        ...
        """
        return self._hid.button(
            _enum_value(GameCubeController.Button.Z), loop
        )
    ...
    def dpadUp(self, loop: Optional[EventLoop] = None) -> Trigger:
        ...
        """
        return self._hid.button(
            _enum_value(GameCubeController.Button.DPAD_UP), loop
        )
    ...
    def dpadDown(self, loop: Optional[EventLoop] = None) -> Trigger:
        ...
        """
        return self._hid.button(
            _enum_value(GameCubeController.Button.DPAD_DOWN), loop
        )
    ...
    def dpadLeft(self, loop: Optional[EventLoop] = None) -> Trigger:
        ...
        """
        return self._hid.button(
            _enum_value(GameCubeController.Button.DPAD_LEFT), loop
        )
    ...
    def dpadRight(self, loop: Optional[EventLoop] = None) -> Trigger:
        ...
        """
        return self._hid.button(
            _enum_value(GameCubeController.Button.DPAD_RIGHT), loop
        )
    ...
    def L(self, loop: Optional[EventLoop] = None) -> Trigger:
        ...
        """
        return self._hid.button(
            _enum_value(GameCubeController.Button.L), loop
        )
    ...
    def R(self, loop: Optional[EventLoop] = None) -> Trigger:
        ...
        """
        return self._hid.button(
            _enum_value(GameCubeController.Button.R), loop
        )
    ...
    def LTrigger(
        ...
        return self._hid.axisGreaterThan(
            _enum_value(GameCubeController.Axis.L_TRIGGER),
            threshold,
            loop,
        )
    ...
    def RTrigger(
        ...
        """
        return self._hid.axisGreaterThan(
            _enum_value(GameCubeController.Axis.R_TRIGGER),
            threshold,
            loop,
        )
