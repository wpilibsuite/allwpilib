...
class CommandSwitchProController:
    ...
    def b(self, loop: Optional[EventLoop] = None) -> Trigger:
        ...
        return self._hid.button(
            _enum_value(SwitchProController.Button.B), loop
        )
    ...
    def a(self, loop: Optional[EventLoop] = None) -> Trigger:
        ...
        """
        return self._hid.button(
            _enum_value(SwitchProController.Button.A), loop
        )
    ...
    def y(self, loop: Optional[EventLoop] = None) -> Trigger:
        ...
        """
        return self._hid.button(
            _enum_value(SwitchProController.Button.Y), loop
        )
    ...
    def x(self, loop: Optional[EventLoop] = None) -> Trigger:
        ...
        """
        return self._hid.button(
            _enum_value(SwitchProController.Button.X), loop
        )
    ...
    def minus(self, loop: Optional[EventLoop] = None) -> Trigger:
        ...
        """
        return self._hid.button(
            _enum_value(SwitchProController.Button.MINUS), loop
        )
    ...
    def home(self, loop: Optional[EventLoop] = None) -> Trigger:
        ...
        """
        return self._hid.button(
            _enum_value(SwitchProController.Button.HOME), loop
        )
    ...
    def plus(self, loop: Optional[EventLoop] = None) -> Trigger:
        ...
        """
        return self._hid.button(
            _enum_value(SwitchProController.Button.PLUS), loop
        )
    ...
    def leftStick(self, loop: Optional[EventLoop] = None) -> Trigger:
        ...
        """
        return self._hid.button(
            _enum_value(SwitchProController.Button.LEFT_STICK), loop
        )
    ...
    def rightStick(self, loop: Optional[EventLoop] = None) -> Trigger:
        ...
        """
        return self._hid.button(
            _enum_value(SwitchProController.Button.RIGHT_STICK), loop
        )
    ...
    def L(self, loop: Optional[EventLoop] = None) -> Trigger:
        ...
        """
        return self._hid.button(
            _enum_value(SwitchProController.Button.L), loop
        )
    ...
    def R(self, loop: Optional[EventLoop] = None) -> Trigger:
        ...
        """
        return self._hid.button(
            _enum_value(SwitchProController.Button.R), loop
        )
    ...
    def dpadUp(self, loop: Optional[EventLoop] = None) -> Trigger:
        ...
        """
        return self._hid.button(
            _enum_value(SwitchProController.Button.DPAD_UP), loop
        )
    ...
    def dpadDown(self, loop: Optional[EventLoop] = None) -> Trigger:
        ...
        """
        return self._hid.button(
            _enum_value(SwitchProController.Button.DPAD_DOWN), loop
        )
    ...
    def dpadLeft(self, loop: Optional[EventLoop] = None) -> Trigger:
        ...
        """
        return self._hid.button(
            _enum_value(SwitchProController.Button.DPAD_LEFT), loop
        )
    ...
    def dpadRight(self, loop: Optional[EventLoop] = None) -> Trigger:
        ...
        """
        return self._hid.button(
            _enum_value(SwitchProController.Button.DPAD_RIGHT), loop
        )
    ...
    def capture(self, loop: Optional[EventLoop] = None) -> Trigger:
        ...
        """
        return self._hid.button(
            _enum_value(SwitchProController.Button.CAPTURE), loop
        )
    ...
    def ZL(
        ...
        return self._hid.axisGreaterThan(
            _enum_value(SwitchProController.Axis.ZL),
            threshold,
            loop,
        )
    ...
    def ZR(
        ...
        """
        return self._hid.axisGreaterThan(
            _enum_value(SwitchProController.Axis.ZR),
            threshold,
            loop,
        )
