...
def main():
    ...
    parser.add_argument('--lib_name', required=True, help='Name of the library for the version script')
    parser.add_argument('--format', required=True, choices=['linux', 'windows', 'osx'], help='Output format')
