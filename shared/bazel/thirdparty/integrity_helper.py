...
def download_integrities(module_file: str, has_headers: bool, platforms: list[str], url_base: str, use_base64: bool):
...
def update_ceres():
    ...
    download_integrities("shared/bazel/thirdparty/ceres/ceres.MODULE.bazel", has_headers, platforms, url_base, True)
...
def update_mrclib():
    ...
    download_integrities("shared/bazel/thirdparty/mrclib/mrclib.MODULE.bazel", has_headers, platforms, url_base, False)
