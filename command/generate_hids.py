...
def generate_hids(output_directory: Path, template_directory: Path, schema_file: Path):
    ...
    # Java files
    java_subdirectory = "main/java/org/wpilib/command/button"
    env = Environment(
    ...
    # C++ headers
    hdr_subdirectory = "main/native/include/wpi/command/button"
    env = Environment(
    ...
    # C++ files
    cpp_subdirectory = "main/native/cpp/wpi/command/button"
    env = Environment(
