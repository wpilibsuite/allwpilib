...
#include "glass/other/TrapezoidPIDController.h"

namespace glass {
class NTTrapezoidPIDControllerModel : public TrapezoidPIDControllerModel {
 public:
  static constexpr const char* kType = "TrapezoidPIDController";
