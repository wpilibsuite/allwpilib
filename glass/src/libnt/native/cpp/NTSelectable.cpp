...
NTSelectableModel::NTSelectableModel(wpi::nt::NetworkTableInstance inst,
    ...
    : m_inst{inst},
      ...
      m_selected{m_inst.GetStringTopic(std::format("{}/selected/tune", path))
                     .Subscribe("")},
      m_selectedPub{m_inst.GetStringTopic(std::format("{}/selected/tune", path))
                        .PublishEx(wpi::nt::StringTopic::TYPE_STRING,
                                   wpi::util::json::object("retained", true))},
      m_active{m_inst.GetStringTopic(std::format("{}/selected/value", path))
                   .Subscribe("")},
