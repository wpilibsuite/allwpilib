...
void SysIdRoutineBot::ConfigureBindings() {
  ...
  (m_driverController.A() && m_driverController.RightBumper())
      .WhileTrue(m_drive.SysIdQuasistatic(frc2::sysid::Direction::FORWARD));
  (m_driverController.B() && m_driverController.RightBumper())
      .WhileTrue(m_drive.SysIdQuasistatic(frc2::sysid::Direction::REVERSE));
  (m_driverController.X() && m_driverController.RightBumper())
      .WhileTrue(m_drive.SysIdDynamic(frc2::sysid::Direction::FORWARD));
  (m_driverController.Y() && m_driverController.RightBumper())
      .WhileTrue(m_drive.SysIdDynamic(frc2::sysid::Direction::REVERSE));
  ...
  (m_driverController.A() && m_driverController.LeftBumper())
      .WhileTrue(m_shooter.SysIdQuasistatic(frc2::sysid::Direction::FORWARD));
  (m_driverController.B() && m_driverController.LeftBumper())
      .WhileTrue(m_shooter.SysIdQuasistatic(frc2::sysid::Direction::REVERSE));
  (m_driverController.X() && m_driverController.LeftBumper())
      .WhileTrue(m_shooter.SysIdDynamic(frc2::sysid::Direction::FORWARD));
  (m_driverController.Y() && m_driverController.LeftBumper())
      .WhileTrue(m_shooter.SysIdDynamic(frc2::sysid::Direction::REVERSE));
}
