...
class Elevator {
 ...
 private:
  ...
  frc::sim::ElevatorSim m_elevatorSim{frc::sim::ElevatorSim::Create(
      m_elevatorGearbox, Constants::kElevatorGearing, Constants::kCarriageMass,
      Constants::kElevatorDrumRadius, Constants::kMinElevatorHeight,
      Constants::kMaxElevatorHeight, true, 0_m, 9.8_mps_sq, {0.005})};
