...
class Robot : public wpi::TimedRobot {
 ...
 private:
  ...
  // ID.
  wpi::Solenoid solenoid{wpi::CANBusMap::CAN_S0,
                         wpi::PneumaticsModuleType::REV_PH, 0};

  // DoubleSolenoid corresponds to a double solenoid.
  // In this case, it's connected to channels 1 and 2 of a PH with the default
  // CAN ID.
  wpi::DoubleSolenoid doubleSolenoid{wpi::CANBusMap::CAN_S0,
                                     wpi::PneumaticsModuleType::REV_PH, 1, 2};

  // Compressor connected to a PH with a default CAN ID
  wpi::Compressor compressor{wpi::CANBusMap::CAN_S0,
